# Nyx Performance Benchmarks — v0.13.0

> **Note (2026-04-20)**: These benchmarks were run on 2026-03-26 and
> reflect the v0.12.0 state before the v0.13 refactor. Actual numbers
> may have improved slightly due to compiler changes (M-01, M-03
> semantic checks don't affect runtime performance). A re-run is
> scheduled for v0.13.0 release.
