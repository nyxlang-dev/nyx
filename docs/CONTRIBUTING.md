...
make test        # Must pass 225/225 regression tests (ARM64) / 226/226 (x86_64)
bash tests/advanced/run_advanced_tests.sh  # Must pass 30/30 advanced tests
# Compiler total: 341 tests (regression + advanced + error + types + stdlib)
# See docs/TESTS.md for canonical counts
```
