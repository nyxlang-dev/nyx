...
|-------|---------|--------|------|
| Regression | `make test` | **440 archivos / 439 ARM64** | `test-123-full-asm` se salta en ARM64 (arquitectura). Altas del 2026-09-08 al 13: +27 (detalle por test en `CHANGELOG.md`) |
