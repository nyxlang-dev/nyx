...
|-------|---------|--------|------|
| Regression | `make test` | **442 archivos / 441 ARM64** | `test-123-full-asm` se salta en ARM64 (arquitectura). Altas del 2026-09-08 al 14: +29 (detalle por test en `CHANGELOG.md`) |
