...
| WASM (wasm32-wasi) | `make test-wasm` | **40** | SKIP sin toolchain (salvo guards); +1 el 2026-09-23 (`test-wasm-35-idb`, arco `browser-indexeddb`); +2 el 09-20 (`include_bytes`); +4 el 09-17 (async-real-wasm). Detalle en `CHANGELOG.md` |
