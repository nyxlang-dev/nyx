...
|-------|---------|--------|------|
| Regression | `make test` | **427 archivos / 426 ARM64** | `test-123-full-asm` se salta en ARM64 (arquitectura). Altas recientes: +3 el 2026-09-08 y +14 el 2026-09-09 (detalle en `CHANGELOG.md`) |
