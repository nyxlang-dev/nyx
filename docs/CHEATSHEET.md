...
```nyx
let output: String = exec("echo hello")     // captura stdout, strip \n final; stderr pasa a la terminal
let code: int = exec_code("some_cmd")        // exit code del comando (no captura stdout)
setenv("MY_VAR", "value")
