...
install-local:
	...
	mkdir -p "$$NYX_HOME_DIR/runtime/wasi" && cp runtime/wasi/* "$$NYX_HOME_DIR/runtime/wasi/"; \
	...
	echo "✓ Toolchain sincronizado en $$NYX_HOME_DIR (bin + runtime + std + wrapper)"
