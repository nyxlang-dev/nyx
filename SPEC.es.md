# Especificación del Lenguaje Nyx v0.13.0
...
- **Versión**: v0.13.0 (pre-release)
- **Cobertura**: Features verificadas hasta v0.13.0. 8 productos + 2 CLI apps, package manager, integrated test runner, semantic type checker activo end-to-end (M-08 S1–S23a).
