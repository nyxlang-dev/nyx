...
@.str42 = private unnamed_addr constant [27 x i8] c"derive-fields-pg-bool-text\00"
...
@.str49 = private unnamed_addr constant [11 x i8] c"desde_fila\00"
...
@.str51 = private unnamed_addr constant [79 x i8] c"tests/postgres/03-params.nx,tests/compiler/ecosystem/test-405-derive-fields.nx\00"
@.str51.c = internal global %nyx_string* null
@.str52 = private unnamed_addr constant [218 x i8] c"A row from `std/postgres` cannot be handed straight to `<Struct>_desde_fila()` if it has a `bool` column — PostgreSQL's text format for boolean is `t`/`f`, and `desde_fila` only recognizes the exact string `\22true\22`.\00"
@.str52.c = internal global %nyx_string* null
@.str53 = private unnamed_addr constant [225 x i8] c"Una fila de `std/postgres` no se le puede pasar directo a `<Struct>_desde_fila()` si tiene una columna `bool` — el formato text de PostgreSQL para boolean es `t`/`f`, y `desde_fila` solo reconoce la cadena exacta `\22true\22`.\00"
...
@.str68 = private unnamed_addr constant [4 x i8] c"n/a\00"
@.str68.c = internal global %nyx_string* null
@.str69 = private unnamed_addr constant [7 x i8] c"0.17.1\00"
...
@.str73 = private unnamed_addr constant [9 x i8] c"Fn(Type)\00"
...
@.str75 = private unnamed_addr constant [39 x i8] c"tests/ai-first/25-fn-callback-typed.nx\00"
@.str75.c = internal global %nyx_string* null
@.str76 = private unnamed_addr constant [36 x i8] c"Callbacks: prefer `Fn(Type) -> Ret`\00"
@.str76.c = internal global %nyx_string* null
@.str77 = private unnamed_addr constant [47 x i8] c"Callbacks: conviene preferir `Fn(Type) -> Ret`\00"
@.str77.c = internal global %nyx_string* null
@.str78 = private unnamed_addr constant [18 x i8] c"await-float-gated\00"
...
@.str81 = private unnamed_addr constant [7 x i8] c"0.18.2\00"
...
@.str85 = private unnamed_addr constant [8 x i8] c"NYX1021\00"
...
@.str87 = private unnamed_addr constant [49 x i8] c"tests/compiler/errors/test-async-float-return.nx\00"
@.str87.c = internal global %nyx_string* null
@.str88 = private unnamed_addr constant [59 x i8] c"`await` of a `float`-returning function is gated (NYX1021)\00"
@.str88.c = internal global %nyx_string* null
@.str89 = private unnamed_addr constant [73 x i8] c"El `await` de una función que retorna `float` está bloqueado (NYX1021)\00"
@.str89.c = internal global %nyx_string* null
@.str90 = private unnamed_addr constant [15 x i8] c"channel-is-map\00"
...
@.str95 = private unnamed_addr constant [25 x i8] c": *int *= *channel_new\5c(\00"
@.str95.c = internal global %nyx_string* null
@.str96 = private unnamed_addr constant [5 x i8] c"W104\00"
@.str96.c = internal global %nyx_string* null
@.str97 = private unnamed_addr constant [12 x i8] c"channel_new\00"
...
@.str100 = private unnamed_addr constant [85 x i8] c"Channels must be Map, not int: `let ch: Map = channel_new(10)`, never `let ch: int`.\00"
@.str100.c = internal global %nyx_string* null
@.str101 = private unnamed_addr constant [90 x i8] c"Los channels deben ser Map, no int: `let ch: Map = channel_new(10)`, nunca `let ch: int`.\00"
@.str101.c = internal global %nyx_string* null
@.str102 = private unnamed_addr constant [19 x i8] c"charat-returns-int\00"
...
@.str107 = private unnamed_addr constant [23 x i8] c"charAt\5c([^)]*\5c) *== *\22\00"
@.str107.c = internal global %nyx_string* null
@.str108 = private unnamed_addr constant [5 x i8] c"W103\00"
@.str108.c = internal global %nyx_string* null
@.str109 = private unnamed_addr constant [7 x i8] c"charAt\00"
...
@.str112 = private unnamed_addr constant [93 x i8] c"`charAt()` returns int (ASCII/codepoint), NOT String — compare with numbers: `if c == 65`.\00"
@.str112.c = internal global %nyx_string* null
@.str113 = private unnamed_addr constant [104 x i8] c"`charAt()` retorna int (ASCII/codepoint), NO String — hay que comparar contra números: `if c == 65`.\00"
@.str113.c = internal global %nyx_string* null
@.str114 = private unnamed_addr constant [20 x i8] c"enum-dot-not-colons\00"
...
@.str119 = private unnamed_addr constant [26 x i8] c"[A-Z][A-Za-z0-9_]*::[A-Z]\00"
@.str119.c = internal global %nyx_string* null
@.str120 = private unnamed_addr constant [5 x i8] c"W101\00"
@.str120.c = internal global %nyx_string* null
@.str121 = private unnamed_addr constant [13 x i8] c"Shape.Circle\00"
...
@.str124 = private unnamed_addr constant [78 x i8] c"Enum variants use `.`, not `::`: `Shape.Circle(5)`, never `Shape::Circle(5)`.\00"
@.str124.c = internal global %nyx_string* null
@.str125 = private unnamed_addr constant [86 x i8] c"Las variantes de enum usan `.`, no `::`: `Shape.Circle(5)`, nunca `Shape::Circle(5)`.\00"
@.str125.c = internal global %nyx_string* null
@.str126 = private unnamed_addr constant [24 x i8] c"map-literal-string-keys\00"
...
@.str131 = private unnamed_addr constant [27 x i8] c"= *\5c{ *[a-z_][a-z0-9_]* *:\00"
@.str131.c = internal global %nyx_string* null
@.str132 = private unnamed_addr constant [5 x i8] c"W102\00"
@.str132.c = internal global %nyx_string* null
@.str133 = private unnamed_addr constant [8 x i8] c"NYX0106\00"
@.str133.c = internal global %nyx_string* null
@.str134 = private unnamed_addr constant [32 x i8] c"map literal {} is NOT supported\00"
@.str134.c = internal global %nyx_string* null
@.str135 = private unnamed_addr constant [38 x i8] c"tests/ai-first/13-map-literal-keys.nx\00"
@.str135.c = internal global %nyx_string* null
@.str136 = private unnamed_addr constant [139 x i8] c"Map literal keys must be STRINGS: `{\22k\22: 1}` and `{}` work (v0.16), but `{ident: 1}` is NOT a map literal and fails loudly with `NYX0106`.\00"
@.str136.c = internal global %nyx_string* null
@.str137 = private unnamed_addr constant [159 x i8] c"Las claves de un map literal deben ser STRINGS: `{\22k\22: 1}` y `{}` funcionan (v0.16), pero `{ident: 1}` NO es un map literal y falla en voz alta con `NYX0106`.\00"
@.str137.c = internal global %nyx_string* null
@.str138 = private unnamed_addr constant [18 x i8] c"strings-are-bytes\00"
...
@.str145 = private unnamed_addr constant [6 x i8] c"BYTES\00"
...
@.str147 = private unnamed_addr constant [36 x i8] c"tests/ai-first/14-language-rules.nx\00"
@.str147.c = internal global %nyx_string* null
@.str148 = private unnamed_addr constant [176 x i8] c"String API is byte-based (v0.14): `length()`, `substring()`, `indexOf()` and `charAt()` all operate on BYTES — for *character* counts use `char_length()` (UTF-8 codepoints).\00"
@.str148.c = internal global %nyx_string* null
@.str149 = private unnamed_addr constant [197 x i8] c"La API de String opera sobre BYTES (v0.14): `length()`, `substring()`, `indexOf()` y `charAt()` operan todas sobre BYTES — para conteos de *caracteres* se usa `char_length()` (codepoints UTF-8).\00"
@.str149.c = internal global %nyx_string* null
@.str150 = private unnamed_addr constant [18 x i8] c"check-bind-return\00"
...
@.str153 = private unnamed_addr constant [7 x i8] c"0.24.3\00"
...
@.str155 = private unnamed_addr constant [38 x i8] c"^ *(http_serve|tcp_listen|udp_bind)\5c(\00"
@.str155.c = internal global %nyx_string* null
@.str156 = private unnamed_addr constant [5 x i8] c"W107\00"
@.str156.c = internal global %nyx_string* null
@.str157 = private unnamed_addr constant [11 x i8] c"tcp_listen\00"
...
@.str159 = private unnamed_addr constant [39 x i8] c"tests/ai-first/21-bind-failure-loud.nx\00"
@.str159.c = internal global %nyx_string* null
@.str160 = private unnamed_addr constant [151 x i8] c"Check the return of `http_serve`/`tcp_listen`/`udp_bind`: a failed bind (port taken) returns `-1` — `if http_serve(8080, handler) < 0 { return 1 }`.\00"
@.str160.c = internal global %nyx_string* null
@.str161 = private unnamed_addr constant [170 x i8] c"Hay que chequear el retorno de `http_serve`/`tcp_listen`/`udp_bind`: un bind que falla (puerto ocupado) retorna `-1` — `if http_serve(8080, handler) < 0 { return 1 }`.\00"
@.str161.c = internal global %nyx_string* null
@.str162 = private unnamed_addr constant [22 x i8] c"assert-aborts-process\00"
...
@.str169 = private unnamed_addr constant [8 x i8] c"exit(1)\00"
...
@.str172 = private unnamed_addr constant [63 x i8] c"`assert()` aborts the process (`exit(1)`) on the first failure\00"
@.str172.c = internal global %nyx_string* null
@.str173 = private unnamed_addr constant [61 x i8] c"`assert()` aborta el proceso (`exit(1)`) en la primera falla\00"
@.str173.c = internal global %nyx_string* null
@.str174 = private unnamed_addr constant [17 x i8] c"bare-return-void\00"
...
@.str181 = private unnamed_addr constant [7 x i8] c"`void`\00"
...
@.str184 = private unnamed_addr constant [64 x i8] c"A bare `return` (no value) works in a `void`-returning function\00"
@.str184.c = internal global %nyx_string* null
@.str185 = private unnamed_addr constant [66 x i8] c"Un `return` sin valor funciona en una función que retorna `void`\00"
@.str185.c = internal global %nyx_string* null
@.str186 = private unnamed_addr constant [27 x i8] c"dyn-trait-needs-annotation\00"
...
@.str188 = private unnamed_addr constant [6 x i8] c"crash\00"
...
@.str193 = private unnamed_addr constant [10 x i8] c"Array<dyn\00"
...
@.str195 = private unnamed_addr constant [52 x i8] c"tests/compiler/language/test-391-dyn-trait-array.nx\00"
@.str195.c = internal global %nyx_string* null
@.str196 = private unnamed_addr constant [80 x i8] c"To store trait objects in a collection, type the collection: `Array<dyn Trait>`\00"
@.str196.c = internal global %nyx_string* null
@.str197 = private unnamed_addr constant [89 x i8] c"Para guardar objetos de trait en una colección, tipá la colección: `Array<dyn Trait>`\00"
@.str197.c = internal global %nyx_string* null
@.str198 = private unnamed_addr constant [17 x i8] c"pg-null-sentinel\00"
...
@.str205 = private unnamed_addr constant [11 x i8] c"pg_is_null\00"
...
@.str207 = private unnamed_addr constant [27 x i8] c"tests/postgres/02-query.nx\00"
@.str207.c = internal global %nyx_string* null
@.str208 = private unnamed_addr constant [86 x i8] c"A NULL column from `std/postgres` is NOT an empty string — ask with `pg_is_null(v)`\00"
@.str208.c = internal global %nyx_string* null
@.str209 = private unnamed_addr constant [94 x i8] c"Una columna NULL de `std/postgres` NO es un string vacío — se pregunta con `pg_is_null(v)`\00"
@.str209.c = internal global %nyx_string* null
@.str210 = private unnamed_addr constant [24 x i8] c"random-bytes-not-crypto\00"
...
@.str217 = private unnamed_addr constant [13 x i8] c"csprng_bytes\00"
...
@.str219 = private unnamed_addr constant [100 x i8] c"tests/compiler/ecosystem/test-170-random-uuid.nx,tests/compiler/ecosystem/test-248-webpushcrypto.nx\00"
@.str219.c = internal global %nyx_string* null
@.str220 = private unnamed_addr constant [169 x i8] c"`random_bytes` (`std/random`) is a PRNG, not a CSPRNG — never use it for salts, tokens, keys, nonces, or any other cryptographic material; use `csprng_bytes` instead.\00"
@.str220.c = internal global %nyx_string* null
@.str221 = private unnamed_addr constant [179 x i8] c"`random_bytes` (`std/random`) es un PRNG, no un CSPRNG — nunca lo uses para salts, tokens, claves, nonces, ni ningún otro material criptográfico; para eso usa `csprng_bytes`.\00"
@.str221.c = internal global %nyx_string* null
@.str222 = private unnamed_addr constant [21 x i8] c"sqlite-null-sentinel\00"
...
@.str229 = private unnamed_addr constant [15 x i8] c"sqlite_is_null\00"
...
@.str231 = private unnamed_addr constant [58 x i8] c"tests/compiler/stdlib-suite/test-406-sqlite-tipos-null.nx\00"
@.str231.c = internal global %nyx_string* null
@.str232 = private unnamed_addr constant [88 x i8] c"A NULL column from `std/sqlite` is NOT an empty string — ask with `sqlite_is_null(v)`\00"
@.str232.c = internal global %nyx_string* null
@.str233 = private unnamed_addr constant [96 x i8] c"Una columna NULL de `std/sqlite` NO es un string vacío — se pregunta con `sqlite_is_null(v)`\00"
@.str233.c = internal global %nyx_string* null
@.str234 = private unnamed_addr constant [25 x i8] c"string-order-is-bytewise\00"
...
@.str241 = private unnamed_addr constant [6 x i8] c"BYTES\00"
...
@.str243 = private unnamed_addr constant [97 x i8] c"tests/ai-first/26-string-order-dates.nx,tests/compiler/language/test-389-string-order-compare.nx\00"
@.str243.c = internal global %nyx_string* null
@.str244 = private unnamed_addr constant [74 x i8] c"`<` `<=` `>` `>=` between Strings compare BYTES, not codepoints or locale\00"
@.str244.c = internal global %nyx_string* null
@.str245 = private unnamed_addr constant [72 x i8] c"`<` `<=` `>` `>=` entre Strings comparan BYTES, no codepoints ni locale\00"
@.str245.c = internal global %nyx_string* null
@.str246 = private unnamed_addr constant [17 x i8] c"throw-deprecated\00"
...
@.str251 = private unnamed_addr constant [10 x i8] c"\5cbthrow\5c(\00"
@.str251.c = internal global %nyx_string* null
@.str252 = private unnamed_addr constant [5 x i8] c"W108\00"
@.str252.c = internal global %nyx_string* null
@.str253 = private unnamed_addr constant [7 x i8] c"panic(\00"
...
@.str255 = private unnamed_addr constant [57 x i8] c"tests/compiler/language/test-382-throw-is-panic-alias.nx\00"
@.str255.c = internal global %nyx_string* null
@.str256 = private unnamed_addr constant [89 x i8] c"`throw(x)` is a deprecated alias of `panic(x)`: same channel, same `catch`, same limits.\00"
@.str256.c = internal global %nyx_string* null
@.str257 = private unnamed_addr constant [97 x i8] c"`throw(x)` es un alias deprecado de `panic(x)`: mismo canal, mismo `catch`, los mismos límites.\00"
@.str257.c = internal global %nyx_string* null
@.str258 = private unnamed_addr constant [19 x i8] c"fork-gc-child-exec\00"
@.str258.c = internal global %nyx_string* null
@.str259 = private unnamed_addr constant [6 x i8] c"limit\00"
@.str259.c = internal global %nyx_string* null
@.str260 = private unnamed_addr constant [6 x i8] c"crash\00"
@.str260.c = internal global %nyx_string* null
@.str261 = private unnamed_addr constant [7 x i8] c"0.17.0\00"
...
@.str265 = private unnamed_addr constant [7 x i8] c"execvp\00"
...
@.str268 = private unnamed_addr constant [14 x i8] c"`fork() + GC`\00"
@.str268.c = internal global %nyx_string* null
@.str269 = private unnamed_addr constant [14 x i8] c"`fork() + GC`\00"
@.str269.c = internal global %nyx_string* null
@.str270 = private unnamed_addr constant [30 x i8] c"global-struct-zeroinitializer\00"
@.str270.c = internal global %nyx_string* null
@.str271 = private unnamed_addr constant [6 x i8] c"limit\00"
...
@.str273 = private unnamed_addr constant [7 x i8] c"0.17.0\00"
...
@.str280 = private unnamed_addr constant [47 x i8] c"Global structs need `zeroinitializer`, not `0`\00"
@.str280.c = internal global %nyx_string* null
@.str281 = private unnamed_addr constant [57 x i8] c"Los structs globales necesitan `zeroinitializer`, no `0`\00"
@.str281.c = internal global %nyx_string* null
@.str282 = private unnamed_addr constant [24 x i8] c"prelude-frozen-snapshot\00"
@.str282.c = internal global %nyx_string* null
@.str283 = private unnamed_addr constant [6 x i8] c"limit\00"
...
@.str285 = private unnamed_addr constant [7 x i8] c"0.27.0\00"
...
@.str289 = private unnamed_addr constant [8 x i8] c"prelude\00"
...
@.str292 = private unnamed_addr constant [128 x i8] c"`std/prelude.nx` is a frozen copy of `std/file`/`math`/`io`/`array`/`map` (since v0.12.0), pre-registered as \22already imported\22\00"
@.str292.c = internal global %nyx_string* null
@.str293 = private unnamed_addr constant [132 x i8] c"`std/prelude.nx` es una copia congelada de `std/file`/`math`/`io`/`array`/`map` (desde v0.12.0), pre-registrada como \22ya importada\22\00"
@.str293.c = internal global %nyx_string* null
@.str294 = private unnamed_addr constant [30 x i8] c"derive-fields-solo-primitivos\00"
@.str294.c = internal global %nyx_string* null
@.str295 = private unnamed_addr constant [6 x i8] c"limit\00"
...
@.str301 = private unnamed_addr constant [8 x i8] c"NYX2013\00"
...
@.str303 = private unnamed_addr constant [51 x i8] c"tests/compiler/ecosystem/test-405-derive-fields.nx\00"
@.str303.c = internal global %nyx_string* null
@.str304 = private unnamed_addr constant [151 x i8] c"`#[derive(Fields)]` only converts `int`, `bool`, `float` and `String` — an `Array`, `Map`, or nested struct field aborts compilation with `NYX2013`.\00"
@.str304.c = internal global %nyx_string* null
@.str305 = private unnamed_addr constant [155 x i8] c"`#[derive(Fields)]` solo convierte `int`, `bool`, `float` y `String` — un campo `Array`, `Map` o un struct anidado aborta la compilación con `NYX2013`.\00"
@.str305.c = internal global %nyx_string* null
@.str306 = private unnamed_addr constant [20 x i8] c"hkt-gats-parse-only\00"
@.str306.c = internal global %nyx_string* null
@.str307 = private unnamed_addr constant [6 x i8] c"limit\00"
...
@.str313 = private unnamed_addr constant [4 x i8] c"HKT\00"
...
@.str316 = private unnamed_addr constant [91 x i8] c"HKT (higher-kinded types) and GATs (generic associated types) parse but do not instantiate\00"
@.str316.c = internal global %nyx_string* null
@.str317 = private unnamed_addr constant [97 x i8] c"Los HKT (tipos de orden superior) y GATs (tipos asociados genéricos) parsean pero no instancian\00"
@.str317.c = internal global %nyx_string* null
@.str318 = private unnamed_addr constant [33 x i8] c"implicit-monomorphization-nested\00"
...
@.str321 = private unnamed_addr constant [7 x i8] c"0.16.1\00"
@.str321.c = internal global %nyx_string* null
@.str322 = private unnamed_addr constant [7 x i8] c"0.16.1\00"
...
@.str325 = private unnamed_addr constant [17 x i8] c"monomorphization\00"
...
@.str328 = private unnamed_addr constant [49 x i8] c"Implicit monomorphization works nested (v0.16.1)\00"
@.str328.c = internal global %nyx_string* null
@.str329 = private unnamed_addr constant [58 x i8] c"La monomorfización implícita funciona anidada (v0.16.1)\00"
@.str329.c = internal global %nyx_string* null
@.str330 = private unnamed_addr constant [21 x i8] c"and-or-short-circuit\00"
...
@.str334 = private unnamed_addr constant [7 x i8] c"0.17.0\00"
...
@.str337 = private unnamed_addr constant [14 x i8] c"short-circuit\00"
...
@.str340 = private unnamed_addr constant [28 x i8] c"`and`/`or` DO short-circuit\00"
@.str340.c = internal global %nyx_string* null
@.str341 = private unnamed_addr constant [35 x i8] c"`and`/`or` SÍ hacen cortocircuito\00"
@.str341.c = internal global %nyx_string* null
@.str342 = private unnamed_addr constant [19 x i8] c"nested-arrays-work\00"
...
@.str346 = private unnamed_addr constant [7 x i8] c"0.17.0\00"
...
@.str349 = private unnamed_addr constant [14 x i8] c"nested arrays\00"
...
@.str352 = private unnamed_addr constant [37 x i8] c"Nested arrays `Array<Array<T>>` work\00"
@.str352.c = internal global %nyx_string* null
@.str353 = private unnamed_addr constant [48 x i8] c"Los arrays anidados `Array<Array<T>>` funcionan\00"
@.str353.c = internal global %nyx_string* null
@.str354 = private unnamed_addr constant [20 x i8] c"map-remove-on-field\00"
...
@.str357 = private unnamed_addr constant [7 x i8] c"0.22.0\00"
@.str357.c = internal global %nyx_string* null
@.str358 = private unnamed_addr constant [7 x i8] c"0.22.0\00"
...
@.str361 = private unnamed_addr constant [7 x i8] c"remove\00"
@.str361.c = internal global %nyx_string* null
@.str362 = private unnamed_addr constant [50 x i8] c"map.remove(k) on a struct field is a silent no-op\00"
@.str362.c = internal global %nyx_string* null
@.str363 = private unnamed_addr constant [60 x i8] c"tests/compiler/language/test-274-map-remove-field-access.nx\00"
@.str363.c = internal global %nyx_string* null
@.str364 = private unnamed_addr constant [95 x i8] c"`obj.field.remove(k)` on a Map struct field DOES mutate the field (fixed 2026-07-21, test-274)\00"
@.str364.c = internal global %nyx_string* null
@.str365 = private unnamed_addr constant [105 x i8] c"`obj.campo.remove(k)` sobre un campo Map de un struct SÍ muta el campo (arreglado 2026-07-21, test-274)\00"
@.str365.c = internal global %nyx_string* null
@.str366 = private unnamed_addr constant [28 x i8] c"gc-exhaustion-ordered-error\00"
...
@.str369 = private unnamed_addr constant [7 x i8] c"0.22.4\00"
@.str369.c = internal global %nyx_string* null
@.str370 = private unnamed_addr constant [7 x i8] c"0.22.4\00"
...
@.str373 = private unnamed_addr constant [18 x i8] c"GC heap exhausted\00"
...
@.str376 = private unnamed_addr constant [73 x i8] c"GC exhaustion is now an ORDERED error, not a raw SEGV (fixed 2026-07-24)\00"
@.str376.c = internal global %nyx_string* null
@.str377 = private unnamed_addr constant [90 x i8] c"El agotamiento del GC ahora es un error ORDENADO, no un SEGV crudo (arreglado 2026-07-24)\00"
@.str377.c = internal global %nyx_string* null
@.str378 = private unnamed_addr constant [18 x i8] c"chr-zero-nul-byte\00"
...
@.str381 = private unnamed_addr constant [8 x i8] c"0.22.12\00"
@.str381.c = internal global %nyx_string* null
@.str382 = private unnamed_addr constant [8 x i8] c"0.22.12\00"
...
@.str385 = private unnamed_addr constant [7 x i8] c"chr(0)\00"
...
@.str387 = private unnamed_addr constant [34 x i8] c"tests/ai-first/11-chr-nul-safe.nx\00"
@.str387.c = internal global %nyx_string* null
@.str388 = private unnamed_addr constant [63 x i8] c"`chr(0)` builds the real NUL byte (v0.22.x+, fixed 2026-07-25)\00"
@.str388.c = internal global %nyx_string* null
@.str389 = private unnamed_addr constant [69 x i8] c"`chr(0)` construye el byte NUL real (v0.22.x+, arreglado 2026-07-25)\00"
@.str389.c = internal global %nyx_string* null
@.str390 = private unnamed_addr constant [27 x i8] c"array-elem-method-chaining\00"
...
@.str393 = private unnamed_addr constant [8 x i8] c"0.22.18\00"
@.str393.c = internal global %nyx_string* null
@.str394 = private unnamed_addr constant [8 x i8] c"0.22.18\00"
...
@.str397 = private unnamed_addr constant [8 x i8] c"chained\00"
@.str397.c = internal global %nyx_string* null
@.str398 = private unnamed_addr constant [28 x i8] c"arr[i].method() causes SEGV\00"
...
@.str400 = private unnamed_addr constant [81 x i8] c"Methods chained on a user function's `Array` return (FIXED v0.22.x+, 2026-07-26)\00"
@.str400.c = internal global %nyx_string* null
@.str401 = private unnamed_addr constant [120 x i8] c"Los métodos encadenados sobre el retorno `Array` de una función de usuario FUNCIONAN (arreglado v0.22.x+, 2026-07-26)\00"
@.str401.c = internal global %nyx_string* null
@.str402 = private unnamed_addr constant [22 x i8] c"closure-capture-works\00"
...
@.str405 = private unnamed_addr constant [8 x i8] c"0.22.19\00"
@.str405.c = internal global %nyx_string* null
@.str406 = private unnamed_addr constant [8 x i8] c"0.22.19\00"
...
@.str409 = private unnamed_addr constant [9 x i8] c"closures\00"
@.str409.c = internal global %nyx_string* null
@.str410 = private unnamed_addr constant [54 x i8] c"closure capture of locals is broken|capture is BROKEN\00"
@.str410.c = internal global %nyx_string* null
@.str411 = private unnamed_addr constant [43 x i8] c"tests/ai-first/12-closure-capture-paths.nx\00"
@.str411.c = internal global %nyx_string* null
@.str412 = private unnamed_addr constant [92 x i8] c"Closure capture of locals WORKS — including a lambda and a nested fn in the same function\00"
@.str412.c = internal global %nyx_string* null
@.str413 = private unnamed_addr constant [105 x i8] c"La captura de locals en closures FUNCIONA — incluyendo un lambda y una fn anidada en la misma función\00"
@.str413.c = internal global %nyx_string* null
@.str414 = private unnamed_addr constant [27 x i8] c"tcp-write-loops-until-sent\00"
...
@.str417 = private unnamed_addr constant [8 x i8] c"0.22.19\00"
@.str417.c = internal global %nyx_string* null
@.str418 = private unnamed_addr constant [8 x i8] c"0.22.19\00"
...
@.str421 = private unnamed_addr constant [10 x i8] c"tcp_write\00"
...
@.str424 = private unnamed_addr constant [62 x i8] c"`tcp_write`/`tls_write` already loop until everything is sent\00"
@.str424.c = internal global %nyx_string* null
@.str425 = private unnamed_addr constant [58 x i8] c"`tcp_write`/`tls_write` ya hacen loop hasta enviarlo todo\00"
@.str425.c = internal global %nyx_string* null
@.str426 = private unnamed_addr constant [30 x i8] c"option-struct-multifield-link\00"
...
@.str429 = private unnamed_addr constant [8 x i8] c"0.22.21\00"
@.str429.c = internal global %nyx_string* null
@.str430 = private unnamed_addr constant [7 x i8] c"0.31.0\00"
...
@.str433 = private unnamed_addr constant [7 x i8] c"boxing\00"
@.str433.c = internal global %nyx_string* null
@.str434 = private unnamed_addr constant [96 x i8] c"as the payload fails to LINK|rompe el LINK|clang refuses it every time|clang lo rechaza siempre\00"
@.str434.c = internal global %nyx_string* null
@.str435 = private unnamed_addr constant [97 x i8] c"tests/compiler/language/test-386-option-struct-multifield.nx,tests/ai-first/15-http-items-api.nx\00"
@.str435.c = internal global %nyx_string* null
@.str436 = private unnamed_addr constant [138 x i8] c"`Option<Struct>`/`Result<Struct, E>` with a 2+-field struct as the payload WORKS — return the struct directly, no Array packing needed.\00"
@.str436.c = internal global %nyx_string* null
@.str437 = private unnamed_addr constant [152 x i8] c"`Option<Struct>`/`Result<Struct, E>` con un struct de 2+ campos como payload FUNCIONA — retorna el struct directamente, sin empaquetarlo en un Array.\00"
@.str437.c = internal global %nyx_string* null
@.str438 = private unnamed_addr constant [26 x i8] c"udp-binary-payload-intact\00"
...
@.str441 = private unnamed_addr constant [7 x i8] c"0.23.0\00"
@.str441.c = internal global %nyx_string* null
@.str442 = private unnamed_addr constant [7 x i8] c"0.23.0\00"
...
@.str445 = private unnamed_addr constant [11 x i8] c"udp_sendto\00"
...
@.str447 = private unnamed_addr constant [40 x i8] c"tests/ai-first/20-udp-binary-payload.nx\00"
@.str447.c = internal global %nyx_string* null
@.str448 = private unnamed_addr constant [76 x i8] c"`udp_sendto`/`udp_recvfrom` carry binary payloads intact (fixed 2026-07-30)\00"
@.str448.c = internal global %nyx_string* null
@.str449 = private unnamed_addr constant [90 x i8] c"`udp_sendto`/`udp_recvfrom` transportan payloads binarios intactos (arreglado 2026-07-30)\00"
@.str449.c = internal global %nyx_string* null
@.str450 = private unnamed_addr constant [28 x i8] c"tls-peer-cert-introspection\00"
...
@.str453 = private unnamed_addr constant [7 x i8] c"0.23.1\00"
@.str453.c = internal global %nyx_string* null
@.str454 = private unnamed_addr constant [7 x i8] c"0.23.1\00"
...
@.str457 = private unnamed_addr constant [14 x i8] c"tls_peer_cert\00"
...
@.str459 = private unnamed_addr constant [39 x i8] c"tests/ai-first/19-tls-introspection.nx\00"
@.str459.c = internal global %nyx_string* null
@.str460 = private unnamed_addr constant [78 x i8] c"You CAN inspect the peer's TLS certificate — no C bindings needed (v0.23.1)\00"
@.str460.c = internal global %nyx_string* null
@.str461 = private unnamed_addr constant [85 x i8] c"SÍ se puede inspeccionar el certificado TLS del peer — sin bindings a C (v0.23.1)\00"
@.str461.c = internal global %nyx_string* null
@.str462 = private unnamed_addr constant [29 x i8] c"missing-method-compile-error\00"
...
@.str465 = private unnamed_addr constant [7 x i8] c"0.24.0\00"
@.str465.c = internal global %nyx_string* null
@.str466 = private unnamed_addr constant [7 x i8] c"0.24.0\00"
...
@.str469 = private unnamed_addr constant [8 x i8] c"NYX1022\00"
...
@.str472 = private unnamed_addr constant [98 x i8] c"A method that doesn't exist for the receiver's type is now a compile error, not garbage (v0.24.0)\00"
@.str472.c = internal global %nyx_string* null
@.str473 = private unnamed_addr constant [106 x i8] c"Un método que no existe para el tipo del receiver ahora es un error de compilación, no basura (v0.24.0)\00"
@.str473.c = internal global %nyx_string* null
@.str474 = private unnamed_addr constant [21 x i8] c"repl-declared-subset\00"
...
@.str477 = private unnamed_addr constant [7 x i8] c"0.24.3\00"
@.str477.c = internal global %nyx_string* null
@.str478 = private unnamed_addr constant [7 x i8] c"0.24.3\00"
...
@.str481 = private unnamed_addr constant [6 x i8] c"NYX30\00"
...
@.str484 = private unnamed_addr constant [68 x i8] c"The REPL evaluates a declared SUBSET and says so loudly (v0.24.2-3)\00"
@.str484.c = internal global %nyx_string* null
@.str485 = private unnamed_addr constant [75 x i8] c"El REPL evalúa un SUBCONJUNTO declarado y lo dice en voz alta (v0.24.2-3)\00"
@.str485.c = internal global %nyx_string* null
@.str486 = private unnamed_addr constant [18 x i8] c"bind-failure-loud\00"
...
@.str489 = private unnamed_addr constant [7 x i8] c"0.24.4\00"
@.str489.c = internal global %nyx_string* null
@.str490 = private unnamed_addr constant [7 x i8] c"0.24.4\00"
...
@.str493 = private unnamed_addr constant [17 x i8] c"cannot bind port\00"
...
@.str495 = private unnamed_addr constant [39 x i8] c"tests/ai-first/21-bind-failure-loud.nx\00"
@.str495.c = internal global %nyx_string* null
@.str496 = private unnamed_addr constant [36 x i8] c"A failed bind is LOUD now (v0.24.4)\00"
@.str496.c = internal global %nyx_string* null
@.str497 = private unnamed_addr constant [45 x i8] c"Un bind que falla ahora es RUIDOSO (v0.24.4)\00"
@.str497.c = internal global %nyx_string* null
@.str498 = private unnamed_addr constant [15 x i8] c"file-api-names\00"
...
@.str501 = private unnamed_addr constant [7 x i8] c"0.24.4\00"
@.str501.c = internal global %nyx_string* null
@.str502 = private unnamed_addr constant [7 x i8] c"0.24.4\00"
...
@.str505 = private unnamed_addr constant [10 x i8] c"file_open\00"
@.str505.c = internal global %nyx_string* null
@.str506 = private unnamed_addr constant [23 x i8] c"open_file(|close_file(\00"
...
@.str508 = private unnamed_addr constant [138 x i8] c"The real buffered file API is `file_open()`/`file_write_string()`/`file_close()` — not `open_file()` or `close_file()` (invented names)\00"
@.str508.c = internal global %nyx_string* null
@.str509 = private unnamed_addr constant [149 x i8] c"La API real de archivos con buffer es `file_open()`/`file_write_string()`/`file_close()` — no `open_file()` ni `close_file()` (nombres inventados)\00"
@.str509.c = internal global %nyx_string* null
@.str510 = private unnamed_addr constant [24 x i8] c"array-index-float-write\00"
...
@.str513 = private unnamed_addr constant [8 x i8] c"0.24.10\00"
@.str513.c = internal global %nyx_string* null
@.str514 = private unnamed_addr constant [8 x i8] c"0.24.10\00"
...
@.str518 = private unnamed_addr constant [36 x i8] c"corrupts the value on the next read\00"
@.str518.c = internal global %nyx_string* null
@.str519 = private unnamed_addr constant [76 x i8] c"tests/ai-first/17-csv-aggregator.nx,tests/ai-first/18-http-client-filter.nx\00"
@.str519.c = internal global %nyx_string* null
@.str520 = private unnamed_addr constant [46 x i8] c"`arr[i] = <float>` on an existing Array WORKS\00"
@.str520.c = internal global %nyx_string* null
@.str521 = private unnamed_addr constant [53 x i8] c"`arr[i] = <float>` sobre un Array existente FUNCIONA\00"
@.str521.c = internal global %nyx_string* null
@.str522 = private unnamed_addr constant [26 x i8] c"sync-global-init-reliable\00"
...
@.str525 = private unnamed_addr constant [8 x i8] c"0.24.27\00"
@.str525.c = internal global %nyx_string* null
@.str526 = private unnamed_addr constant [8 x i8] c"0.24.27\00"
...
@.str529 = private unnamed_addr constant [10 x i8] c"mutex_new\00"
...
@.str531 = private unnamed_addr constant [50 x i8] c"tests/ai-first/23-sync-global-mutex-wg-timeout.nx\00"
@.str531.c = internal global %nyx_string* null
@.str532 = private unnamed_addr constant [132 x i8] c"Stateful handles (`mutex_new()`, `sem_new()`, `wg_new()`) are RELIABLE as global initializers (since v0.24.27; measured 2026-08-21)\00"
@.str532.c = internal global %nyx_string* null
@.str533 = private unnamed_addr constant [145 x i8] c"Los handles con estado (`mutex_new()`, `sem_new()`, `wg_new()`) son CONFIABLES como inicializadores globales (desde v0.24.27; medido 2026-08-21)\00"
@.str533.c = internal global %nyx_string* null
@.str534 = private unnamed_addr constant [3 x i8] c"id\00"
@.str534.c = internal global %nyx_string* null
@.str535 = private unnamed_addr constant [5 x i8] c"kind\00"
@.str535.c = internal global %nyx_string* null
@.str536 = private unnamed_addr constant [9 x i8] c"severity\00"
@.str536.c = internal global %nyx_string* null
@.str537 = private unnamed_addr constant [6 x i8] c"since\00"
@.str537.c = internal global %nyx_string* null
@.str538 = private unnamed_addr constant [9 x i8] c"fixed_in\00"
@.str538.c = internal global %nyx_string* null
@.str539 = private unnamed_addr constant [8 x i8] c"pattern\00"
@.str539.c = internal global %nyx_string* null
@.str540 = private unnamed_addr constant [9 x i8] c"vet_code\00"
@.str540.c = internal global %nyx_string* null
@.str541 = private unnamed_addr constant [7 x i8] c"anchor\00"
@.str541.c = internal global %nyx_string* null
@.str542 = private unnamed_addr constant [5 x i8] c"lies\00"
@.str542.c = internal global %nyx_string* null
@.str543 = private unnamed_addr constant [5 x i8] c"test\00"
@.str543.c = internal global %nyx_string* null
@.str544 = private unnamed_addr constant [9 x i8] c"title_en\00"
@.str544.c = internal global %nyx_string* null
@.str545 = private unnamed_addr constant [9 x i8] c"title_es\00"
@.str545.c = internal global %nyx_string* null
@.str546 = private unnamed_addr constant [1 x i8] c"\00"
...
define { i64, i8* }* @gotchas_table(
  ...
  %234 = getelementptr [79 x i8], [79 x i8]* @.str51, i32 0, i32 0
  %235 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str51.c, i8* %234, i64 78)
  %236 = ptrtoint %nyx_string* %235 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %206, i64 %236, i64 2)
  %237 = getelementptr [218 x i8], [218 x i8]* @.str52, i32 0, i32 0
  %238 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str52.c, i8* %237, i64 217)
  %239 = ptrtoint %nyx_string* %238 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %206, i64 %239, i64 2)
  %240 = getelementptr [225 x i8], [225 x i8]* @.str53, i32 0, i32 0
  %241 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str53.c, i8* %240, i64 224)
  ...
  %291 = getelementptr [4 x i8], [4 x i8]* @.str68, i32 0, i32 0
  %292 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str68.c, i8* %291, i64 3)
  ...
  %306 = getelementptr [9 x i8], [9 x i8]* @.str73, i32 0, i32 0
  %307 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str73.c, i8* %306, i64 8)
  ...
  %312 = getelementptr [39 x i8], [39 x i8]* @.str75, i32 0, i32 0
  %313 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str75.c, i8* %312, i64 38)
  %314 = ptrtoint %nyx_string* %313 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %284, i64 %314, i64 2)
  %315 = getelementptr [36 x i8], [36 x i8]* @.str76, i32 0, i32 0
  %316 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str76.c, i8* %315, i64 35)
  %317 = ptrtoint %nyx_string* %316 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %284, i64 %317, i64 2)
  %318 = getelementptr [47 x i8], [47 x i8]* @.str77, i32 0, i32 0
  %319 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str77.c, i8* %318, i64 46)
  ...
  %351 = getelementptr [49 x i8], [49 x i8]* @.str87, i32 0, i32 0
  %352 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str87.c, i8* %351, i64 48)
  %353 = ptrtoint %nyx_string* %352 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %323, i64 %353, i64 2)
  %354 = getelementptr [59 x i8], [59 x i8]* @.str88, i32 0, i32 0
  %355 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str88.c, i8* %354, i64 58)
  %356 = ptrtoint %nyx_string* %355 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %323, i64 %356, i64 2)
  %357 = getelementptr [73 x i8], [73 x i8]* @.str89, i32 0, i32 0
  %358 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str89.c, i8* %357, i64 72)
  ...
  %363 = getelementptr [15 x i8], [15 x i8]* @.str90, i32 0, i32 0
  %364 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str90.c, i8* %363, i64 14)
  ...
  %378 = getelementptr [25 x i8], [25 x i8]* @.str95, i32 0, i32 0
  %379 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str95.c, i8* %378, i64 24)
  ...
  %384 = getelementptr [12 x i8], [12 x i8]* @.str97, i32 0, i32 0
  %385 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str97.c, i8* %384, i64 11)
  ...
  %393 = getelementptr [85 x i8], [85 x i8]* @.str100, i32 0, i32 0
  %394 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str100.c, i8* %393, i64 84)
  %395 = ptrtoint %nyx_string* %394 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %362, i64 %395, i64 2)
  %396 = getelementptr [90 x i8], [90 x i8]* @.str101, i32 0, i32 0
  %397 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str101.c, i8* %396, i64 89)
  ...
  %402 = getelementptr [19 x i8], [19 x i8]* @.str102, i32 0, i32 0
  %403 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str102.c, i8* %402, i64 18)
  ...
  %417 = getelementptr [23 x i8], [23 x i8]* @.str107, i32 0, i32 0
  %418 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str107.c, i8* %417, i64 22)
  ...
  %423 = getelementptr [7 x i8], [7 x i8]* @.str109, i32 0, i32 0
  %424 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str109.c, i8* %423, i64 6)
  ...
  %432 = getelementptr [93 x i8], [93 x i8]* @.str112, i32 0, i32 0
  %433 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str112.c, i8* %432, i64 92)
  %434 = ptrtoint %nyx_string* %433 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %401, i64 %434, i64 2)
  %435 = getelementptr [104 x i8], [104 x i8]* @.str113, i32 0, i32 0
  %436 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str113.c, i8* %435, i64 103)
  ...
  %441 = getelementptr [20 x i8], [20 x i8]* @.str114, i32 0, i32 0
  %442 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str114.c, i8* %441, i64 19)
  ...
  %456 = getelementptr [26 x i8], [26 x i8]* @.str119, i32 0, i32 0
  %457 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str119.c, i8* %456, i64 25)
  ...
  %462 = getelementptr [13 x i8], [13 x i8]* @.str121, i32 0, i32 0
  %463 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str121.c, i8* %462, i64 12)
  ...
  %471 = getelementptr [78 x i8], [78 x i8]* @.str124, i32 0, i32 0
  %472 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str124.c, i8* %471, i64 77)
  %473 = ptrtoint %nyx_string* %472 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %440, i64 %473, i64 2)
  %474 = getelementptr [86 x i8], [86 x i8]* @.str125, i32 0, i32 0
  %475 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str125.c, i8* %474, i64 85)
  ...
  %480 = getelementptr [24 x i8], [24 x i8]* @.str126, i32 0, i32 0
  %481 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str126.c, i8* %480, i64 23)
  ...
  %495 = getelementptr [27 x i8], [27 x i8]* @.str131, i32 0, i32 0
  %496 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str131.c, i8* %495, i64 26)
  ...
  %501 = getelementptr [8 x i8], [8 x i8]* @.str133, i32 0, i32 0
  %502 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str133.c, i8* %501, i64 7)
  %503 = ptrtoint %nyx_string* %502 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %479, i64 %503, i64 2)
  %504 = getelementptr [32 x i8], [32 x i8]* @.str134, i32 0, i32 0
  %505 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str134.c, i8* %504, i64 31)
  %506 = ptrtoint %nyx_string* %505 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %479, i64 %506, i64 2)
  %507 = getelementptr [38 x i8], [38 x i8]* @.str135, i32 0, i32 0
  %508 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str135.c, i8* %507, i64 37)
  %509 = ptrtoint %nyx_string* %508 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %479, i64 %509, i64 2)
  %510 = getelementptr [139 x i8], [139 x i8]* @.str136, i32 0, i32 0
  %511 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str136.c, i8* %510, i64 138)
  %512 = ptrtoint %nyx_string* %511 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %479, i64 %512, i64 2)
  %513 = getelementptr [159 x i8], [159 x i8]* @.str137, i32 0, i32 0
  %514 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str137.c, i8* %513, i64 158)
  ...
  %534 = getelementptr [1 x i8], [1 x i8]* @.str143, i32 0, i32 0
  %535 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str143.c, i8* %534, i64 0)
  %536 = ptrtoint %nyx_string* %535 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %518, i64 %536, i64 2)
  %537 = getelementptr [1 x i8], [1 x i8]* @.str144, i32 0, i32 0
  %538 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str144.c, i8* %537, i64 0)
  %539 = ptrtoint %nyx_string* %538 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %518, i64 %539, i64 2)
  %540 = getelementptr [6 x i8], [6 x i8]* @.str145, i32 0, i32 0
  %541 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str145.c, i8* %540, i64 5)
  ...
  %546 = getelementptr [36 x i8], [36 x i8]* @.str147, i32 0, i32 0
  %547 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str147.c, i8* %546, i64 35)
  %548 = ptrtoint %nyx_string* %547 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %518, i64 %548, i64 2)
  %549 = getelementptr [176 x i8], [176 x i8]* @.str148, i32 0, i32 0
  %550 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str148.c, i8* %549, i64 175)
  %551 = ptrtoint %nyx_string* %550 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %518, i64 %551, i64 2)
  %552 = getelementptr [197 x i8], [197 x i8]* @.str149, i32 0, i32 0
  %553 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str149.c, i8* %552, i64 196)
  ...
  %573 = getelementptr [38 x i8], [38 x i8]* @.str155, i32 0, i32 0
  %574 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str155.c, i8* %573, i64 37)
  %575 = ptrtoint %nyx_string* %574 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %557, i64 %575, i64 2)
  %576 = getelementptr [5 x i8], [5 x i8]* @.str156, i32 0, i32 0
  %577 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str156.c, i8* %576, i64 4)
  %578 = ptrtoint %nyx_string* %577 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %557, i64 %578, i64 2)
  %579 = getelementptr [11 x i8], [11 x i8]* @.str157, i32 0, i32 0
  %580 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str157.c, i8* %579, i64 10)
  ...
  %585 = getelementptr [39 x i8], [39 x i8]* @.str159, i32 0, i32 0
  %586 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str159.c, i8* %585, i64 38)
  %587 = ptrtoint %nyx_string* %586 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %557, i64 %587, i64 2)
  %588 = getelementptr [151 x i8], [151 x i8]* @.str160, i32 0, i32 0
  %589 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str160.c, i8* %588, i64 150)
  %590 = ptrtoint %nyx_string* %589 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %557, i64 %590, i64 2)
  %591 = getelementptr [170 x i8], [170 x i8]* @.str161, i32 0, i32 0
  %592 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str161.c, i8* %591, i64 169)
  ...
  %597 = getelementptr [22 x i8], [22 x i8]* @.str162, i32 0, i32 0
  %598 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str162.c, i8* %597, i64 21)
  ...
  %618 = getelementptr [8 x i8], [8 x i8]* @.str169, i32 0, i32 0
  %619 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str169.c, i8* %618, i64 7)
  ...
  %627 = getelementptr [63 x i8], [63 x i8]* @.str172, i32 0, i32 0
  %628 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str172.c, i8* %627, i64 62)
  %629 = ptrtoint %nyx_string* %628 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %596, i64 %629, i64 2)
  %630 = getelementptr [61 x i8], [61 x i8]* @.str173, i32 0, i32 0
  %631 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str173.c, i8* %630, i64 60)
  ...
  %636 = getelementptr [17 x i8], [17 x i8]* @.str174, i32 0, i32 0
  %637 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str174.c, i8* %636, i64 16)
  ...
  %666 = getelementptr [64 x i8], [64 x i8]* @.str184, i32 0, i32 0
  %667 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str184.c, i8* %666, i64 63)
  %668 = ptrtoint %nyx_string* %667 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %635, i64 %668, i64 2)
  %669 = getelementptr [66 x i8], [66 x i8]* @.str185, i32 0, i32 0
  %670 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str185.c, i8* %669, i64 65)
  ...
  %675 = getelementptr [27 x i8], [27 x i8]* @.str186, i32 0, i32 0
  %676 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str186.c, i8* %675, i64 26)
  ...
  %681 = getelementptr [6 x i8], [6 x i8]* @.str188, i32 0, i32 0
  %682 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str188.c, i8* %681, i64 5)
  ...
  %696 = getelementptr [10 x i8], [10 x i8]* @.str193, i32 0, i32 0
  %697 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str193.c, i8* %696, i64 9)
  ...
  %702 = getelementptr [52 x i8], [52 x i8]* @.str195, i32 0, i32 0
  %703 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str195.c, i8* %702, i64 51)
  %704 = ptrtoint %nyx_string* %703 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %674, i64 %704, i64 2)
  %705 = getelementptr [80 x i8], [80 x i8]* @.str196, i32 0, i32 0
  %706 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str196.c, i8* %705, i64 79)
  %707 = ptrtoint %nyx_string* %706 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %674, i64 %707, i64 2)
  %708 = getelementptr [89 x i8], [89 x i8]* @.str197, i32 0, i32 0
  %709 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str197.c, i8* %708, i64 88)
  ...
  %714 = getelementptr [17 x i8], [17 x i8]* @.str198, i32 0, i32 0
  %715 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str198.c, i8* %714, i64 16)
  ...
  %741 = getelementptr [27 x i8], [27 x i8]* @.str207, i32 0, i32 0
  %742 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str207.c, i8* %741, i64 26)
  %743 = ptrtoint %nyx_string* %742 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %713, i64 %743, i64 2)
  %744 = getelementptr [86 x i8], [86 x i8]* @.str208, i32 0, i32 0
  %745 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str208.c, i8* %744, i64 85)
  %746 = ptrtoint %nyx_string* %745 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %713, i64 %746, i64 2)
  %747 = getelementptr [94 x i8], [94 x i8]* @.str209, i32 0, i32 0
  %748 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str209.c, i8* %747, i64 93)
  ...
  %753 = getelementptr [24 x i8], [24 x i8]* @.str210, i32 0, i32 0
  %754 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str210.c, i8* %753, i64 23)
  ...
  %774 = getelementptr [13 x i8], [13 x i8]* @.str217, i32 0, i32 0
  %775 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str217.c, i8* %774, i64 12)
  ...
  %780 = getelementptr [100 x i8], [100 x i8]* @.str219, i32 0, i32 0
  %781 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str219.c, i8* %780, i64 99)
  %782 = ptrtoint %nyx_string* %781 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %752, i64 %782, i64 2)
  %783 = getelementptr [169 x i8], [169 x i8]* @.str220, i32 0, i32 0
  %784 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str220.c, i8* %783, i64 168)
  %785 = ptrtoint %nyx_string* %784 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %752, i64 %785, i64 2)
  %786 = getelementptr [179 x i8], [179 x i8]* @.str221, i32 0, i32 0
  %787 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str221.c, i8* %786, i64 178)
  ...
  %792 = getelementptr [21 x i8], [21 x i8]* @.str222, i32 0, i32 0
  %793 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str222.c, i8* %792, i64 20)
  ...
  %813 = getelementptr [15 x i8], [15 x i8]* @.str229, i32 0, i32 0
  %814 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str229.c, i8* %813, i64 14)
  ...
  %819 = getelementptr [58 x i8], [58 x i8]* @.str231, i32 0, i32 0
  %820 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str231.c, i8* %819, i64 57)
  %821 = ptrtoint %nyx_string* %820 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %791, i64 %821, i64 2)
  %822 = getelementptr [88 x i8], [88 x i8]* @.str232, i32 0, i32 0
  %823 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str232.c, i8* %822, i64 87)
  %824 = ptrtoint %nyx_string* %823 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %791, i64 %824, i64 2)
  %825 = getelementptr [96 x i8], [96 x i8]* @.str233, i32 0, i32 0
  %826 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str233.c, i8* %825, i64 95)
  ...
  %831 = getelementptr [25 x i8], [25 x i8]* @.str234, i32 0, i32 0
  %832 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str234.c, i8* %831, i64 24)
  ...
  %852 = getelementptr [6 x i8], [6 x i8]* @.str241, i32 0, i32 0
  %853 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str241.c, i8* %852, i64 5)
  ...
  %858 = getelementptr [97 x i8], [97 x i8]* @.str243, i32 0, i32 0
  %859 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str243.c, i8* %858, i64 96)
  %860 = ptrtoint %nyx_string* %859 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %830, i64 %860, i64 2)
  %861 = getelementptr [74 x i8], [74 x i8]* @.str244, i32 0, i32 0
  %862 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str244.c, i8* %861, i64 73)
  %863 = ptrtoint %nyx_string* %862 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %830, i64 %863, i64 2)
  %864 = getelementptr [72 x i8], [72 x i8]* @.str245, i32 0, i32 0
  %865 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str245.c, i8* %864, i64 71)
  ...
  %885 = getelementptr [10 x i8], [10 x i8]* @.str251, i32 0, i32 0
  %886 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str251.c, i8* %885, i64 9)
  %887 = ptrtoint %nyx_string* %886 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %869, i64 %887, i64 2)
  %888 = getelementptr [5 x i8], [5 x i8]* @.str252, i32 0, i32 0
  %889 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str252.c, i8* %888, i64 4)
  %890 = ptrtoint %nyx_string* %889 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %869, i64 %890, i64 2)
  %891 = getelementptr [7 x i8], [7 x i8]* @.str253, i32 0, i32 0
  %892 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str253.c, i8* %891, i64 6)
  ...
  %897 = getelementptr [57 x i8], [57 x i8]* @.str255, i32 0, i32 0
  %898 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str255.c, i8* %897, i64 56)
  ...
  %903 = getelementptr [97 x i8], [97 x i8]* @.str257, i32 0, i32 0
  %904 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str257.c, i8* %903, i64 96)
  ...
  %909 = getelementptr [19 x i8], [19 x i8]* @.str258, i32 0, i32 0
  %910 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str258.c, i8* %909, i64 18)
  ...
  %915 = getelementptr [6 x i8], [6 x i8]* @.str260, i32 0, i32 0
  %916 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str260.c, i8* %915, i64 5)
  ...
  %936 = getelementptr [1 x i8], [1 x i8]* @.str267, i32 0, i32 0
  %937 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str267.c, i8* %936, i64 0)
  %938 = ptrtoint %nyx_string* %937 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %908, i64 %938, i64 2)
  %939 = getelementptr [14 x i8], [14 x i8]* @.str268, i32 0, i32 0
  %940 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str268.c, i8* %939, i64 13)
  %941 = ptrtoint %nyx_string* %940 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %908, i64 %941, i64 2)
  %942 = getelementptr [14 x i8], [14 x i8]* @.str269, i32 0, i32 0
  %943 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str269.c, i8* %942, i64 13)
  ...
  %948 = getelementptr [30 x i8], [30 x i8]* @.str270, i32 0, i32 0
  %949 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str270.c, i8* %948, i64 29)
  ...
  %969 = getelementptr [1 x i8], [1 x i8]* @.str277, i32 0, i32 0
  %970 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str277.c, i8* %969, i64 0)
  ...
  %978 = getelementptr [47 x i8], [47 x i8]* @.str280, i32 0, i32 0
  %979 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str280.c, i8* %978, i64 46)
  %980 = ptrtoint %nyx_string* %979 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %947, i64 %980, i64 2)
  %981 = getelementptr [57 x i8], [57 x i8]* @.str281, i32 0, i32 0
  %982 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str281.c, i8* %981, i64 56)
  ...
  %1008 = getelementptr [8 x i8], [8 x i8]* @.str289, i32 0, i32 0
  %1009 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str289.c, i8* %1008, i64 7)
  ...
  %1014 = getelementptr [1 x i8], [1 x i8]* @.str291, i32 0, i32 0
  %1015 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str291.c, i8* %1014, i64 0)
  %1016 = ptrtoint %nyx_string* %1015 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %986, i64 %1016, i64 2)
  %1017 = getelementptr [128 x i8], [128 x i8]* @.str292, i32 0, i32 0
  %1018 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str292.c, i8* %1017, i64 127)
  %1019 = ptrtoint %nyx_string* %1018 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %986, i64 %1019, i64 2)
  %1020 = getelementptr [132 x i8], [132 x i8]* @.str293, i32 0, i32 0
  %1021 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str293.c, i8* %1020, i64 131)
  ...
  %1026 = getelementptr [30 x i8], [30 x i8]* @.str294, i32 0, i32 0
  %1027 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str294.c, i8* %1026, i64 29)
  ...
  %1053 = getelementptr [51 x i8], [51 x i8]* @.str303, i32 0, i32 0
  %1054 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str303.c, i8* %1053, i64 50)
  %1055 = ptrtoint %nyx_string* %1054 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1025, i64 %1055, i64 2)
  %1056 = getelementptr [151 x i8], [151 x i8]* @.str304, i32 0, i32 0
  %1057 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str304.c, i8* %1056, i64 150)
  %1058 = ptrtoint %nyx_string* %1057 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1025, i64 %1058, i64 2)
  %1059 = getelementptr [155 x i8], [155 x i8]* @.str305, i32 0, i32 0
  %1060 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str305.c, i8* %1059, i64 154)
  ...
  %1065 = getelementptr [20 x i8], [20 x i8]* @.str306, i32 0, i32 0
  %1066 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str306.c, i8* %1065, i64 19)
  ...
  %1086 = getelementptr [4 x i8], [4 x i8]* @.str313, i32 0, i32 0
  %1087 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str313.c, i8* %1086, i64 3)
  ...
  %1092 = getelementptr [1 x i8], [1 x i8]* @.str315, i32 0, i32 0
  %1093 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str315.c, i8* %1092, i64 0)
  %1094 = ptrtoint %nyx_string* %1093 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1064, i64 %1094, i64 2)
  %1095 = getelementptr [91 x i8], [91 x i8]* @.str316, i32 0, i32 0
  %1096 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str316.c, i8* %1095, i64 90)
  ...
  %1104 = getelementptr [33 x i8], [33 x i8]* @.str318, i32 0, i32 0
  %1105 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str318.c, i8* %1104, i64 32)
  ...
  %1116 = getelementptr [7 x i8], [7 x i8]* @.str322, i32 0, i32 0
  %1117 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str322.c, i8* %1116, i64 6)
  ...
  %1125 = getelementptr [17 x i8], [17 x i8]* @.str325, i32 0, i32 0
  %1126 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str325.c, i8* %1125, i64 16)
  ...
  %1134 = getelementptr [49 x i8], [49 x i8]* @.str328, i32 0, i32 0
  %1135 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str328.c, i8* %1134, i64 48)
  ...
  %1164 = getelementptr [14 x i8], [14 x i8]* @.str337, i32 0, i32 0
  %1165 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str337.c, i8* %1164, i64 13)
  ...
  %1173 = getelementptr [28 x i8], [28 x i8]* @.str340, i32 0, i32 0
  %1174 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str340.c, i8* %1173, i64 27)
  %1175 = ptrtoint %nyx_string* %1174 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1142, i64 %1175, i64 2)
  %1176 = getelementptr [35 x i8], [35 x i8]* @.str341, i32 0, i32 0
  %1177 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str341.c, i8* %1176, i64 34)
  ...
  %1212 = getelementptr [37 x i8], [37 x i8]* @.str352, i32 0, i32 0
  %1213 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str352.c, i8* %1212, i64 36)
  %1214 = ptrtoint %nyx_string* %1213 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1181, i64 %1214, i64 2)
  %1215 = getelementptr [48 x i8], [48 x i8]* @.str353, i32 0, i32 0
  %1216 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str353.c, i8* %1215, i64 47)
  ...
  %1221 = getelementptr [20 x i8], [20 x i8]* @.str354, i32 0, i32 0
  %1222 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str354.c, i8* %1221, i64 19)
  ...
  %1245 = getelementptr [50 x i8], [50 x i8]* @.str362, i32 0, i32 0
  %1246 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str362.c, i8* %1245, i64 49)
  %1247 = ptrtoint %nyx_string* %1246 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1220, i64 %1247, i64 2)
  %1248 = getelementptr [60 x i8], [60 x i8]* @.str363, i32 0, i32 0
  %1249 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str363.c, i8* %1248, i64 59)
  %1250 = ptrtoint %nyx_string* %1249 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1220, i64 %1250, i64 2)
  %1251 = getelementptr [95 x i8], [95 x i8]* @.str364, i32 0, i32 0
  %1252 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str364.c, i8* %1251, i64 94)
  ...
  %1260 = getelementptr [28 x i8], [28 x i8]* @.str366, i32 0, i32 0
  %1261 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str366.c, i8* %1260, i64 27)
  ...
  %1281 = getelementptr [18 x i8], [18 x i8]* @.str373, i32 0, i32 0
  %1282 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str373.c, i8* %1281, i64 17)
  ...
  %1290 = getelementptr [73 x i8], [73 x i8]* @.str376, i32 0, i32 0
  %1291 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str376.c, i8* %1290, i64 72)
  %1292 = ptrtoint %nyx_string* %1291 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1259, i64 %1292, i64 2)
  %1293 = getelementptr [90 x i8], [90 x i8]* @.str377, i32 0, i32 0
  %1294 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str377.c, i8* %1293, i64 89)
  ...
  %1308 = getelementptr [8 x i8], [8 x i8]* @.str381, i32 0, i32 0
  %1309 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str381.c, i8* %1308, i64 7)
  %1310 = ptrtoint %nyx_string* %1309 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1298, i64 %1310, i64 2)
  %1311 = getelementptr [8 x i8], [8 x i8]* @.str382, i32 0, i32 0
  %1312 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str382.c, i8* %1311, i64 7)
  ...
  %1326 = getelementptr [34 x i8], [34 x i8]* @.str387, i32 0, i32 0
  %1327 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str387.c, i8* %1326, i64 33)
  %1328 = ptrtoint %nyx_string* %1327 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1298, i64 %1328, i64 2)
  %1329 = getelementptr [63 x i8], [63 x i8]* @.str388, i32 0, i32 0
  %1330 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str388.c, i8* %1329, i64 62)
  %1331 = ptrtoint %nyx_string* %1330 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1298, i64 %1331, i64 2)
  %1332 = getelementptr [69 x i8], [69 x i8]* @.str389, i32 0, i32 0
  %1333 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str389.c, i8* %1332, i64 68)
  ...
  %1338 = getelementptr [27 x i8], [27 x i8]* @.str390, i32 0, i32 0
  %1339 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str390.c, i8* %1338, i64 26)
  ...
  %1347 = getelementptr [8 x i8], [8 x i8]* @.str393, i32 0, i32 0
  %1348 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str393.c, i8* %1347, i64 7)
  %1349 = ptrtoint %nyx_string* %1348 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1337, i64 %1349, i64 2)
  %1350 = getelementptr [8 x i8], [8 x i8]* @.str394, i32 0, i32 0
  %1351 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str394.c, i8* %1350, i64 7)
  ...
  %1362 = getelementptr [28 x i8], [28 x i8]* @.str398, i32 0, i32 0
  %1363 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str398.c, i8* %1362, i64 27)
  ...
  %1368 = getelementptr [81 x i8], [81 x i8]* @.str400, i32 0, i32 0
  %1369 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str400.c, i8* %1368, i64 80)
  %1370 = ptrtoint %nyx_string* %1369 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1337, i64 %1370, i64 2)
  %1371 = getelementptr [120 x i8], [120 x i8]* @.str401, i32 0, i32 0
  %1372 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str401.c, i8* %1371, i64 119)
  ...
  %1377 = getelementptr [22 x i8], [22 x i8]* @.str402, i32 0, i32 0
  %1378 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str402.c, i8* %1377, i64 21)
  ...
  %1398 = getelementptr [9 x i8], [9 x i8]* @.str409, i32 0, i32 0
  %1399 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str409.c, i8* %1398, i64 8)
  %1400 = ptrtoint %nyx_string* %1399 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1376, i64 %1400, i64 2)
  %1401 = getelementptr [54 x i8], [54 x i8]* @.str410, i32 0, i32 0
  %1402 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str410.c, i8* %1401, i64 53)
  %1403 = ptrtoint %nyx_string* %1402 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1376, i64 %1403, i64 2)
  %1404 = getelementptr [43 x i8], [43 x i8]* @.str411, i32 0, i32 0
  %1405 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str411.c, i8* %1404, i64 42)
  %1406 = ptrtoint %nyx_string* %1405 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1376, i64 %1406, i64 2)
  %1407 = getelementptr [92 x i8], [92 x i8]* @.str412, i32 0, i32 0
  %1408 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str412.c, i8* %1407, i64 91)
  ...
  %1416 = getelementptr [27 x i8], [27 x i8]* @.str414, i32 0, i32 0
  %1417 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str414.c, i8* %1416, i64 26)
  ...
  %1446 = getelementptr [62 x i8], [62 x i8]* @.str424, i32 0, i32 0
  %1447 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str424.c, i8* %1446, i64 61)
  ...
  %1455 = getelementptr [30 x i8], [30 x i8]* @.str426, i32 0, i32 0
  %1456 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str426.c, i8* %1455, i64 29)
  ...
  %1464 = getelementptr [8 x i8], [8 x i8]* @.str429, i32 0, i32 0
  %1465 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str429.c, i8* %1464, i64 7)
  ...
  %1476 = getelementptr [7 x i8], [7 x i8]* @.str433, i32 0, i32 0
  %1477 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str433.c, i8* %1476, i64 6)
  %1478 = ptrtoint %nyx_string* %1477 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1454, i64 %1478, i64 2)
  %1479 = getelementptr [96 x i8], [96 x i8]* @.str434, i32 0, i32 0
  %1480 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str434.c, i8* %1479, i64 95)
  %1481 = ptrtoint %nyx_string* %1480 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1454, i64 %1481, i64 2)
  %1482 = getelementptr [97 x i8], [97 x i8]* @.str435, i32 0, i32 0
  %1483 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str435.c, i8* %1482, i64 96)
  %1484 = ptrtoint %nyx_string* %1483 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1454, i64 %1484, i64 2)
  %1485 = getelementptr [138 x i8], [138 x i8]* @.str436, i32 0, i32 0
  %1486 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str436.c, i8* %1485, i64 137)
  %1487 = ptrtoint %nyx_string* %1486 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1454, i64 %1487, i64 2)
  %1488 = getelementptr [152 x i8], [152 x i8]* @.str437, i32 0, i32 0
  %1489 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str437.c, i8* %1488, i64 151)
  ...
  %1494 = getelementptr [26 x i8], [26 x i8]* @.str438, i32 0, i32 0
  %1495 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str438.c, i8* %1494, i64 25)
  ...
  %1515 = getelementptr [11 x i8], [11 x i8]* @.str445, i32 0, i32 0
  %1516 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str445.c, i8* %1515, i64 10)
  ...
  %1521 = getelementptr [40 x i8], [40 x i8]* @.str447, i32 0, i32 0
  %1522 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str447.c, i8* %1521, i64 39)
  %1523 = ptrtoint %nyx_string* %1522 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1493, i64 %1523, i64 2)
  %1524 = getelementptr [76 x i8], [76 x i8]* @.str448, i32 0, i32 0
  %1525 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str448.c, i8* %1524, i64 75)
  %1526 = ptrtoint %nyx_string* %1525 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1493, i64 %1526, i64 2)
  %1527 = getelementptr [90 x i8], [90 x i8]* @.str449, i32 0, i32 0
  %1528 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str449.c, i8* %1527, i64 89)
  ...
  %1560 = getelementptr [39 x i8], [39 x i8]* @.str459, i32 0, i32 0
  %1561 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str459.c, i8* %1560, i64 38)
  %1562 = ptrtoint %nyx_string* %1561 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1532, i64 %1562, i64 2)
  %1563 = getelementptr [78 x i8], [78 x i8]* @.str460, i32 0, i32 0
  %1564 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str460.c, i8* %1563, i64 77)
  %1565 = ptrtoint %nyx_string* %1564 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1532, i64 %1565, i64 2)
  %1566 = getelementptr [85 x i8], [85 x i8]* @.str461, i32 0, i32 0
  %1567 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str461.c, i8* %1566, i64 84)
  ...
  %1572 = getelementptr [29 x i8], [29 x i8]* @.str462, i32 0, i32 0
  %1573 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str462.c, i8* %1572, i64 28)
  ...
  %1593 = getelementptr [8 x i8], [8 x i8]* @.str469, i32 0, i32 0
  %1594 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str469.c, i8* %1593, i64 7)
  ...
  %1602 = getelementptr [98 x i8], [98 x i8]* @.str472, i32 0, i32 0
  %1603 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str472.c, i8* %1602, i64 97)
  %1604 = ptrtoint %nyx_string* %1603 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1571, i64 %1604, i64 2)
  %1605 = getelementptr [106 x i8], [106 x i8]* @.str473, i32 0, i32 0
  %1606 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str473.c, i8* %1605, i64 105)
  ...
  %1632 = getelementptr [6 x i8], [6 x i8]* @.str481, i32 0, i32 0
  %1633 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str481.c, i8* %1632, i64 5)
  ...
  %1641 = getelementptr [68 x i8], [68 x i8]* @.str484, i32 0, i32 0
  %1642 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str484.c, i8* %1641, i64 67)
  %1643 = ptrtoint %nyx_string* %1642 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1610, i64 %1643, i64 2)
  %1644 = getelementptr [75 x i8], [75 x i8]* @.str485, i32 0, i32 0
  %1645 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str485.c, i8* %1644, i64 74)
  ...
  %1677 = getelementptr [39 x i8], [39 x i8]* @.str495, i32 0, i32 0
  %1678 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str495.c, i8* %1677, i64 38)
  %1679 = ptrtoint %nyx_string* %1678 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1649, i64 %1679, i64 2)
  %1680 = getelementptr [36 x i8], [36 x i8]* @.str496, i32 0, i32 0
  %1681 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str496.c, i8* %1680, i64 35)
  %1682 = ptrtoint %nyx_string* %1681 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1649, i64 %1682, i64 2)
  %1683 = getelementptr [45 x i8], [45 x i8]* @.str497, i32 0, i32 0
  %1684 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str497.c, i8* %1683, i64 44)
  ...
  %1689 = getelementptr [15 x i8], [15 x i8]* @.str498, i32 0, i32 0
  %1690 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str498.c, i8* %1689, i64 14)
  ...
  %1713 = getelementptr [23 x i8], [23 x i8]* @.str506, i32 0, i32 0
  %1714 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str506.c, i8* %1713, i64 22)
  ...
  %1719 = getelementptr [138 x i8], [138 x i8]* @.str508, i32 0, i32 0
  %1720 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str508.c, i8* %1719, i64 137)
  %1721 = ptrtoint %nyx_string* %1720 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1688, i64 %1721, i64 2)
  %1722 = getelementptr [149 x i8], [149 x i8]* @.str509, i32 0, i32 0
  %1723 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str509.c, i8* %1722, i64 148)
  ...
  %1728 = getelementptr [24 x i8], [24 x i8]* @.str510, i32 0, i32 0
  %1729 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str510.c, i8* %1728, i64 23)
  ...
  %1749 = getelementptr [1 x i8], [1 x i8]* @.str517, i32 0, i32 0
  %1750 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str517.c, i8* %1749, i64 0)
  %1751 = ptrtoint %nyx_string* %1750 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1727, i64 %1751, i64 2)
  %1752 = getelementptr [36 x i8], [36 x i8]* @.str518, i32 0, i32 0
  %1753 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str518.c, i8* %1752, i64 35)
  %1754 = ptrtoint %nyx_string* %1753 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1727, i64 %1754, i64 2)
  %1755 = getelementptr [76 x i8], [76 x i8]* @.str519, i32 0, i32 0
  %1756 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str519.c, i8* %1755, i64 75)
  %1757 = ptrtoint %nyx_string* %1756 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1727, i64 %1757, i64 2)
  %1758 = getelementptr [46 x i8], [46 x i8]* @.str520, i32 0, i32 0
  %1759 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str520.c, i8* %1758, i64 45)
  %1760 = ptrtoint %nyx_string* %1759 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1727, i64 %1760, i64 2)
  %1761 = getelementptr [53 x i8], [53 x i8]* @.str521, i32 0, i32 0
  %1762 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str521.c, i8* %1761, i64 52)
  ...
  %1794 = getelementptr [50 x i8], [50 x i8]* @.str531, i32 0, i32 0
  %1795 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str531.c, i8* %1794, i64 49)
  %1796 = ptrtoint %nyx_string* %1795 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1766, i64 %1796, i64 2)
  %1797 = getelementptr [132 x i8], [132 x i8]* @.str532, i32 0, i32 0
  %1798 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str532.c, i8* %1797, i64 131)
  %1799 = ptrtoint %nyx_string* %1798 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1766, i64 %1799, i64 2)
  %1800 = getelementptr [145 x i8], [145 x i8]* @.str533, i32 0, i32 0
  %1801 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str533.c, i8* %1800, i64 144)
...
{ i64, i8* }* %row.param, %nyx_string* %name.param) {
  ...
  %1805 = sub i64 0, 1
  %1806 = alloca i64
  store i64 %1805, i64* %1806
  %1807 = load %nyx_string*, %nyx_string** %name.ptr
  %1808 = getelementptr [3 x i8], [3 x i8]* @.str534, i32 0, i32 0
  %1809 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str534.c, i8* %1808, i64 2)
  %1810 = call i1 @nyx_string_equals(%nyx_string* %1807, %nyx_string* %1809)
  br i1 %1810, label %then24, label %else25
then24:
...
else25:
  br label %merge26
merge26:
  %1811 = load %nyx_string*, %nyx_string** %name.ptr
  %1812 = getelementptr [5 x i8], [5 x i8]* @.str535, i32 0, i32 0
  %1813 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str535.c, i8* %1812, i64 4)
  %1814 = call i1 @nyx_string_equals(%nyx_string* %1811, %nyx_string* %1813)
  br i1 %1814, label %then27, label %else28
then27:
  store i64 1, i64* %1806
  br label %merge29
else28:
  br label %merge29
merge29:
  %1815 = load %nyx_string*, %nyx_string** %name.ptr
  %1816 = getelementptr [9 x i8], [9 x i8]* @.str536, i32 0, i32 0
  %1817 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str536.c, i8* %1816, i64 8)
  %1818 = call i1 @nyx_string_equals(%nyx_string* %1815, %nyx_string* %1817)
  br i1 %1818, label %then30, label %else31
then30:
  store i64 2, i64* %1806
  br label %merge32
else31:
  br label %merge32
merge32:
  %1819 = load %nyx_string*, %nyx_string** %name.ptr
  %1820 = getelementptr [6 x i8], [6 x i8]* @.str537, i32 0, i32 0
  %1821 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str537.c, i8* %1820, i64 5)
  %1822 = call i1 @nyx_string_equals(%nyx_string* %1819, %nyx_string* %1821)
  br i1 %1822, label %then33, label %else34
then33:
  store i64 3, i64* %1806
  br label %merge35
else34:
  br label %merge35
merge35:
  %1823 = load %nyx_string*, %nyx_string** %name.ptr
  %1824 = getelementptr [9 x i8], [9 x i8]* @.str538, i32 0, i32 0
  %1825 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str538.c, i8* %1824, i64 8)
  %1826 = call i1 @nyx_string_equals(%nyx_string* %1823, %nyx_string* %1825)
  br i1 %1826, label %then36, label %else37
then36:
  store i64 4, i64* %1806
  br label %merge38
else37:
  br label %merge38
merge38:
  %1827 = load %nyx_string*, %nyx_string** %name.ptr
  %1828 = getelementptr [8 x i8], [8 x i8]* @.str539, i32 0, i32 0
  %1829 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str539.c, i8* %1828, i64 7)
  %1830 = call i1 @nyx_string_equals(%nyx_string* %1827, %nyx_string* %1829)
  br i1 %1830, label %then39, label %else40
then39:
  store i64 5, i64* %1806
  br label %merge41
else40:
  br label %merge41
merge41:
  %1831 = load %nyx_string*, %nyx_string** %name.ptr
  %1832 = getelementptr [9 x i8], [9 x i8]* @.str540, i32 0, i32 0
  %1833 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str540.c, i8* %1832, i64 8)
  %1834 = call i1 @nyx_string_equals(%nyx_string* %1831, %nyx_string* %1833)
  br i1 %1834, label %then42, label %else43
then42:
  store i64 6, i64* %1806
  br label %merge44
else43:
  br label %merge44
merge44:
  %1835 = load %nyx_string*, %nyx_string** %name.ptr
  %1836 = getelementptr [7 x i8], [7 x i8]* @.str541, i32 0, i32 0
  %1837 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str541.c, i8* %1836, i64 6)
  %1838 = call i1 @nyx_string_equals(%nyx_string* %1835, %nyx_string* %1837)
  br i1 %1838, label %then45, label %else46
then45:
  store i64 7, i64* %1806
  br label %merge47
else46:
  br label %merge47
merge47:
  %1839 = load %nyx_string*, %nyx_string** %name.ptr
  %1840 = getelementptr [5 x i8], [5 x i8]* @.str542, i32 0, i32 0
  %1841 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str542.c, i8* %1840, i64 4)
  %1842 = call i1 @nyx_string_equals(%nyx_string* %1839, %nyx_string* %1841)
  br i1 %1842, label %then48, label %else49
then48:
...
else49:
  br label %merge50
merge50:
  %1843 = load %nyx_string*, %nyx_string** %name.ptr
  %1844 = getelementptr [5 x i8], [5 x i8]* @.str543, i32 0, i32 0
  %1845 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str543.c, i8* %1844, i64 4)
  %1846 = call i1 @nyx_string_equals(%nyx_string* %1843, %nyx_string* %1845)
  br i1 %1846, label %then51, label %else52
then51:
  store i64 9, i64* %1806
  br label %merge53
else52:
  br label %merge53
merge53:
  %1847 = load %nyx_string*, %nyx_string** %name.ptr
  %1848 = getelementptr [9 x i8], [9 x i8]* @.str544, i32 0, i32 0
  %1849 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str544.c, i8* %1848, i64 8)
  %1850 = call i1 @nyx_string_equals(%nyx_string* %1847, %nyx_string* %1849)
  br i1 %1850, label %then54, label %else55
then54:
  store i64 10, i64* %1806
  br label %merge56
else55:
  br label %merge56
merge56:
  %1851 = load %nyx_string*, %nyx_string** %name.ptr
  %1852 = getelementptr [9 x i8], [9 x i8]* @.str545, i32 0, i32 0
  %1853 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str545.c, i8* %1852, i64 8)
  %1854 = call i1 @nyx_string_equals(%nyx_string* %1851, %nyx_string* %1853)
  br i1 %1854, label %then57, label %else58
then57:
  store i64 11, i64* %1806
  br label %merge59
else58:
  br label %merge59
merge59:
  %1855 = load i64, i64* %1806
  %1856 = icmp slt i64 %1855, 0
  br i1 %1856, label %then60, label %else61
then60:
  %1857 = getelementptr [1 x i8], [1 x i8]* @.str546, i32 0, i32 0
  %1858 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str546.c, i8* %1857, i64 0)
  ret %nyx_string* %1858
else61:
  br label %merge62
merge62:
  %1859 = load { i64, i8* }*, { i64, i8* }** %row.ptr
  %1860 = load i64, i64* %1806
  %1861 = call i64 @nyx_array_get_checked({ i64, i8* }* %1859, i64 %1860, i64 2)
