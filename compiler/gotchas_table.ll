...
@.str42 = private unnamed_addr constant [19 x i8] c"int-wraps-silently\00"
...
@.str49 = private unnamed_addr constant [11 x i8] c"wraparound\00"
...
@.str174 = private unnamed_addr constant [27 x i8] c"dyn-trait-needs-annotation\00"
...
@.str181 = private unnamed_addr constant [10 x i8] c"Array<dyn\00"
...
@.str183 = private unnamed_addr constant [52 x i8] c"tests/compiler/language/test-391-dyn-trait-array.nx\00"
@.str183.c = internal global %nyx_string* null
@.str184 = private unnamed_addr constant [80 x i8] c"To store trait objects in a collection, type the collection: `Array<dyn Trait>`\00"
@.str184.c = internal global %nyx_string* null
@.str185 = private unnamed_addr constant [89 x i8] c"Para guardar objetos de trait en una colección, tipá la colección: `Array<dyn Trait>`\00"
@.str185.c = internal global %nyx_string* null
@.str186 = private unnamed_addr constant [17 x i8] c"pg-null-sentinel\00"
...
@.str188 = private unnamed_addr constant [13 x i8] c"silent-wrong\00"
...
@.str193 = private unnamed_addr constant [11 x i8] c"pg_is_null\00"
...
@.str195 = private unnamed_addr constant [27 x i8] c"tests/postgres/02-query.nx\00"
@.str195.c = internal global %nyx_string* null
@.str196 = private unnamed_addr constant [86 x i8] c"A NULL column from `std/postgres` is NOT an empty string — ask with `pg_is_null(v)`\00"
@.str196.c = internal global %nyx_string* null
@.str197 = private unnamed_addr constant [94 x i8] c"Una columna NULL de `std/postgres` NO es un string vacío — se pregunta con `pg_is_null(v)`\00"
@.str197.c = internal global %nyx_string* null
@.str198 = private unnamed_addr constant [25 x i8] c"string-order-is-bytewise\00"
...
@.str205 = private unnamed_addr constant [6 x i8] c"BYTES\00"
...
@.str207 = private unnamed_addr constant [97 x i8] c"tests/ai-first/26-string-order-dates.nx,tests/compiler/language/test-389-string-order-compare.nx\00"
@.str207.c = internal global %nyx_string* null
@.str208 = private unnamed_addr constant [74 x i8] c"`<` `<=` `>` `>=` between Strings compare BYTES, not codepoints or locale\00"
@.str208.c = internal global %nyx_string* null
@.str209 = private unnamed_addr constant [72 x i8] c"`<` `<=` `>` `>=` entre Strings comparan BYTES, no codepoints ni locale\00"
@.str209.c = internal global %nyx_string* null
@.str210 = private unnamed_addr constant [17 x i8] c"throw-deprecated\00"
...
@.str212 = private unnamed_addr constant [5 x i8] c"loud\00"
...
@.str215 = private unnamed_addr constant [10 x i8] c"\5cbthrow\5c(\00"
@.str215.c = internal global %nyx_string* null
@.str216 = private unnamed_addr constant [5 x i8] c"W108\00"
@.str216.c = internal global %nyx_string* null
@.str217 = private unnamed_addr constant [7 x i8] c"panic(\00"
...
@.str219 = private unnamed_addr constant [57 x i8] c"tests/compiler/language/test-382-throw-is-panic-alias.nx\00"
@.str219.c = internal global %nyx_string* null
@.str220 = private unnamed_addr constant [89 x i8] c"`throw(x)` is a deprecated alias of `panic(x)`: same channel, same `catch`, same limits.\00"
@.str220.c = internal global %nyx_string* null
@.str221 = private unnamed_addr constant [97 x i8] c"`throw(x)` es un alias deprecado de `panic(x)`: mismo canal, mismo `catch`, los mismos límites.\00"
@.str221.c = internal global %nyx_string* null
@.str222 = private unnamed_addr constant [19 x i8] c"fork-gc-child-exec\00"
@.str222.c = internal global %nyx_string* null
@.str223 = private unnamed_addr constant [6 x i8] c"limit\00"
...
@.str225 = private unnamed_addr constant [7 x i8] c"0.17.0\00"
...
@.str229 = private unnamed_addr constant [7 x i8] c"execvp\00"
...
@.str232 = private unnamed_addr constant [14 x i8] c"`fork() + GC`\00"
@.str232.c = internal global %nyx_string* null
@.str233 = private unnamed_addr constant [14 x i8] c"`fork() + GC`\00"
@.str233.c = internal global %nyx_string* null
@.str234 = private unnamed_addr constant [30 x i8] c"global-struct-zeroinitializer\00"
@.str234.c = internal global %nyx_string* null
@.str235 = private unnamed_addr constant [6 x i8] c"limit\00"
...
@.str244 = private unnamed_addr constant [47 x i8] c"Global structs need `zeroinitializer`, not `0`\00"
@.str244.c = internal global %nyx_string* null
@.str245 = private unnamed_addr constant [57 x i8] c"Los structs globales necesitan `zeroinitializer`, no `0`\00"
@.str245.c = internal global %nyx_string* null
@.str246 = private unnamed_addr constant [24 x i8] c"prelude-frozen-snapshot\00"
@.str246.c = internal global %nyx_string* null
@.str247 = private unnamed_addr constant [6 x i8] c"limit\00"
...
@.str249 = private unnamed_addr constant [7 x i8] c"0.27.0\00"
...
@.str253 = private unnamed_addr constant [8 x i8] c"prelude\00"
...
@.str256 = private unnamed_addr constant [128 x i8] c"`std/prelude.nx` is a frozen copy of `std/file`/`math`/`io`/`array`/`map` (since v0.12.0), pre-registered as \22already imported\22\00"
@.str256.c = internal global %nyx_string* null
@.str257 = private unnamed_addr constant [132 x i8] c"`std/prelude.nx` es una copia congelada de `std/file`/`math`/`io`/`array`/`map` (desde v0.12.0), pre-registrada como \22ya importada\22\00"
@.str257.c = internal global %nyx_string* null
@.str258 = private unnamed_addr constant [20 x i8] c"hkt-gats-parse-only\00"
...
@.str265 = private unnamed_addr constant [4 x i8] c"HKT\00"
...
@.str268 = private unnamed_addr constant [91 x i8] c"HKT (higher-kinded types) and GATs (generic associated types) parse but do not instantiate\00"
@.str268.c = internal global %nyx_string* null
@.str269 = private unnamed_addr constant [97 x i8] c"Los HKT (tipos de orden superior) y GATs (tipos asociados genéricos) parsean pero no instancian\00"
@.str269.c = internal global %nyx_string* null
@.str270 = private unnamed_addr constant [33 x i8] c"implicit-monomorphization-nested\00"
...
@.str273 = private unnamed_addr constant [7 x i8] c"0.16.1\00"
@.str273.c = internal global %nyx_string* null
@.str274 = private unnamed_addr constant [7 x i8] c"0.16.1\00"
...
@.str277 = private unnamed_addr constant [17 x i8] c"monomorphization\00"
...
@.str280 = private unnamed_addr constant [49 x i8] c"Implicit monomorphization works nested (v0.16.1)\00"
@.str280.c = internal global %nyx_string* null
@.str281 = private unnamed_addr constant [58 x i8] c"La monomorfización implícita funciona anidada (v0.16.1)\00"
@.str281.c = internal global %nyx_string* null
@.str282 = private unnamed_addr constant [21 x i8] c"and-or-short-circuit\00"
...
@.str285 = private unnamed_addr constant [7 x i8] c"0.17.0\00"
@.str285.c = internal global %nyx_string* null
@.str286 = private unnamed_addr constant [7 x i8] c"0.17.0\00"
...
@.str289 = private unnamed_addr constant [14 x i8] c"short-circuit\00"
...
@.str292 = private unnamed_addr constant [28 x i8] c"`and`/`or` DO short-circuit\00"
@.str292.c = internal global %nyx_string* null
@.str293 = private unnamed_addr constant [35 x i8] c"`and`/`or` SÍ hacen cortocircuito\00"
@.str293.c = internal global %nyx_string* null
@.str294 = private unnamed_addr constant [19 x i8] c"nested-arrays-work\00"
...
@.str298 = private unnamed_addr constant [7 x i8] c"0.17.0\00"
...
@.str301 = private unnamed_addr constant [14 x i8] c"nested arrays\00"
...
@.str304 = private unnamed_addr constant [37 x i8] c"Nested arrays `Array<Array<T>>` work\00"
@.str304.c = internal global %nyx_string* null
@.str305 = private unnamed_addr constant [48 x i8] c"Los arrays anidados `Array<Array<T>>` funcionan\00"
@.str305.c = internal global %nyx_string* null
@.str306 = private unnamed_addr constant [20 x i8] c"map-remove-on-field\00"
...
@.str309 = private unnamed_addr constant [7 x i8] c"0.22.0\00"
@.str309.c = internal global %nyx_string* null
@.str310 = private unnamed_addr constant [7 x i8] c"0.22.0\00"
...
@.str313 = private unnamed_addr constant [7 x i8] c"remove\00"
@.str313.c = internal global %nyx_string* null
@.str314 = private unnamed_addr constant [50 x i8] c"map.remove(k) on a struct field is a silent no-op\00"
@.str314.c = internal global %nyx_string* null
@.str315 = private unnamed_addr constant [60 x i8] c"tests/compiler/language/test-274-map-remove-field-access.nx\00"
@.str315.c = internal global %nyx_string* null
@.str316 = private unnamed_addr constant [95 x i8] c"`obj.field.remove(k)` on a Map struct field DOES mutate the field (fixed 2026-07-21, test-274)\00"
@.str316.c = internal global %nyx_string* null
@.str317 = private unnamed_addr constant [105 x i8] c"`obj.campo.remove(k)` sobre un campo Map de un struct SÍ muta el campo (arreglado 2026-07-21, test-274)\00"
@.str317.c = internal global %nyx_string* null
@.str318 = private unnamed_addr constant [28 x i8] c"gc-exhaustion-ordered-error\00"
...
@.str321 = private unnamed_addr constant [7 x i8] c"0.22.4\00"
@.str321.c = internal global %nyx_string* null
@.str322 = private unnamed_addr constant [7 x i8] c"0.22.4\00"
...
@.str325 = private unnamed_addr constant [18 x i8] c"GC heap exhausted\00"
...
@.str328 = private unnamed_addr constant [73 x i8] c"GC exhaustion is now an ORDERED error, not a raw SEGV (fixed 2026-07-24)\00"
@.str328.c = internal global %nyx_string* null
@.str329 = private unnamed_addr constant [90 x i8] c"El agotamiento del GC ahora es un error ORDENADO, no un SEGV crudo (arreglado 2026-07-24)\00"
@.str329.c = internal global %nyx_string* null
@.str330 = private unnamed_addr constant [18 x i8] c"chr-zero-nul-byte\00"
...
@.str333 = private unnamed_addr constant [8 x i8] c"0.22.12\00"
@.str333.c = internal global %nyx_string* null
@.str334 = private unnamed_addr constant [8 x i8] c"0.22.12\00"
...
@.str337 = private unnamed_addr constant [7 x i8] c"chr(0)\00"
...
@.str339 = private unnamed_addr constant [34 x i8] c"tests/ai-first/11-chr-nul-safe.nx\00"
@.str339.c = internal global %nyx_string* null
@.str340 = private unnamed_addr constant [63 x i8] c"`chr(0)` builds the real NUL byte (v0.22.x+, fixed 2026-07-25)\00"
@.str340.c = internal global %nyx_string* null
@.str341 = private unnamed_addr constant [69 x i8] c"`chr(0)` construye el byte NUL real (v0.22.x+, arreglado 2026-07-25)\00"
@.str341.c = internal global %nyx_string* null
@.str342 = private unnamed_addr constant [27 x i8] c"array-elem-method-chaining\00"
...
@.str345 = private unnamed_addr constant [8 x i8] c"0.22.18\00"
@.str345.c = internal global %nyx_string* null
@.str346 = private unnamed_addr constant [8 x i8] c"0.22.18\00"
...
@.str349 = private unnamed_addr constant [8 x i8] c"chained\00"
@.str349.c = internal global %nyx_string* null
@.str350 = private unnamed_addr constant [28 x i8] c"arr[i].method() causes SEGV\00"
...
@.str352 = private unnamed_addr constant [81 x i8] c"Methods chained on a user function's `Array` return (FIXED v0.22.x+, 2026-07-26)\00"
@.str352.c = internal global %nyx_string* null
@.str353 = private unnamed_addr constant [120 x i8] c"Los métodos encadenados sobre el retorno `Array` de una función de usuario FUNCIONAN (arreglado v0.22.x+, 2026-07-26)\00"
@.str353.c = internal global %nyx_string* null
@.str354 = private unnamed_addr constant [22 x i8] c"closure-capture-works\00"
...
@.str357 = private unnamed_addr constant [8 x i8] c"0.22.19\00"
@.str357.c = internal global %nyx_string* null
@.str358 = private unnamed_addr constant [8 x i8] c"0.22.19\00"
...
@.str361 = private unnamed_addr constant [9 x i8] c"closures\00"
@.str361.c = internal global %nyx_string* null
@.str362 = private unnamed_addr constant [54 x i8] c"closure capture of locals is broken|capture is BROKEN\00"
@.str362.c = internal global %nyx_string* null
@.str363 = private unnamed_addr constant [43 x i8] c"tests/ai-first/12-closure-capture-paths.nx\00"
@.str363.c = internal global %nyx_string* null
@.str364 = private unnamed_addr constant [92 x i8] c"Closure capture of locals WORKS — including a lambda and a nested fn in the same function\00"
@.str364.c = internal global %nyx_string* null
@.str365 = private unnamed_addr constant [105 x i8] c"La captura de locals en closures FUNCIONA — incluyendo un lambda y una fn anidada en la misma función\00"
@.str365.c = internal global %nyx_string* null
@.str366 = private unnamed_addr constant [27 x i8] c"tcp-write-loops-until-sent\00"
...
@.str369 = private unnamed_addr constant [8 x i8] c"0.22.19\00"
@.str369.c = internal global %nyx_string* null
@.str370 = private unnamed_addr constant [8 x i8] c"0.22.19\00"
...
@.str373 = private unnamed_addr constant [10 x i8] c"tcp_write\00"
...
@.str376 = private unnamed_addr constant [62 x i8] c"`tcp_write`/`tls_write` already loop until everything is sent\00"
@.str376.c = internal global %nyx_string* null
@.str377 = private unnamed_addr constant [58 x i8] c"`tcp_write`/`tls_write` ya hacen loop hasta enviarlo todo\00"
@.str377.c = internal global %nyx_string* null
@.str378 = private unnamed_addr constant [30 x i8] c"option-struct-multifield-link\00"
...
@.str381 = private unnamed_addr constant [8 x i8] c"0.22.21\00"
@.str381.c = internal global %nyx_string* null
@.str382 = private unnamed_addr constant [7 x i8] c"0.31.0\00"
...
@.str385 = private unnamed_addr constant [7 x i8] c"boxing\00"
@.str385.c = internal global %nyx_string* null
@.str386 = private unnamed_addr constant [96 x i8] c"as the payload fails to LINK|rompe el LINK|clang refuses it every time|clang lo rechaza siempre\00"
@.str386.c = internal global %nyx_string* null
@.str387 = private unnamed_addr constant [97 x i8] c"tests/compiler/language/test-386-option-struct-multifield.nx,tests/ai-first/15-http-items-api.nx\00"
@.str387.c = internal global %nyx_string* null
@.str388 = private unnamed_addr constant [138 x i8] c"`Option<Struct>`/`Result<Struct, E>` with a 2+-field struct as the payload WORKS — return the struct directly, no Array packing needed.\00"
@.str388.c = internal global %nyx_string* null
@.str389 = private unnamed_addr constant [152 x i8] c"`Option<Struct>`/`Result<Struct, E>` con un struct de 2+ campos como payload FUNCIONA — retorna el struct directamente, sin empaquetarlo en un Array.\00"
@.str389.c = internal global %nyx_string* null
@.str390 = private unnamed_addr constant [26 x i8] c"udp-binary-payload-intact\00"
...
@.str393 = private unnamed_addr constant [7 x i8] c"0.23.0\00"
@.str393.c = internal global %nyx_string* null
@.str394 = private unnamed_addr constant [7 x i8] c"0.23.0\00"
...
@.str397 = private unnamed_addr constant [11 x i8] c"udp_sendto\00"
...
@.str399 = private unnamed_addr constant [40 x i8] c"tests/ai-first/20-udp-binary-payload.nx\00"
@.str399.c = internal global %nyx_string* null
@.str400 = private unnamed_addr constant [76 x i8] c"`udp_sendto`/`udp_recvfrom` carry binary payloads intact (fixed 2026-07-30)\00"
@.str400.c = internal global %nyx_string* null
@.str401 = private unnamed_addr constant [90 x i8] c"`udp_sendto`/`udp_recvfrom` transportan payloads binarios intactos (arreglado 2026-07-30)\00"
@.str401.c = internal global %nyx_string* null
@.str402 = private unnamed_addr constant [28 x i8] c"tls-peer-cert-introspection\00"
...
@.str405 = private unnamed_addr constant [7 x i8] c"0.23.1\00"
@.str405.c = internal global %nyx_string* null
@.str406 = private unnamed_addr constant [7 x i8] c"0.23.1\00"
...
@.str409 = private unnamed_addr constant [14 x i8] c"tls_peer_cert\00"
...
@.str411 = private unnamed_addr constant [39 x i8] c"tests/ai-first/19-tls-introspection.nx\00"
@.str411.c = internal global %nyx_string* null
@.str412 = private unnamed_addr constant [78 x i8] c"You CAN inspect the peer's TLS certificate — no C bindings needed (v0.23.1)\00"
@.str412.c = internal global %nyx_string* null
@.str413 = private unnamed_addr constant [85 x i8] c"SÍ se puede inspeccionar el certificado TLS del peer — sin bindings a C (v0.23.1)\00"
@.str413.c = internal global %nyx_string* null
@.str414 = private unnamed_addr constant [29 x i8] c"missing-method-compile-error\00"
...
@.str417 = private unnamed_addr constant [7 x i8] c"0.24.0\00"
@.str417.c = internal global %nyx_string* null
@.str418 = private unnamed_addr constant [7 x i8] c"0.24.0\00"
...
@.str421 = private unnamed_addr constant [8 x i8] c"NYX1022\00"
...
@.str424 = private unnamed_addr constant [98 x i8] c"A method that doesn't exist for the receiver's type is now a compile error, not garbage (v0.24.0)\00"
@.str424.c = internal global %nyx_string* null
@.str425 = private unnamed_addr constant [106 x i8] c"Un método que no existe para el tipo del receiver ahora es un error de compilación, no basura (v0.24.0)\00"
@.str425.c = internal global %nyx_string* null
@.str426 = private unnamed_addr constant [21 x i8] c"repl-declared-subset\00"
...
@.str429 = private unnamed_addr constant [7 x i8] c"0.24.3\00"
@.str429.c = internal global %nyx_string* null
@.str430 = private unnamed_addr constant [7 x i8] c"0.24.3\00"
...
@.str433 = private unnamed_addr constant [6 x i8] c"NYX30\00"
...
@.str436 = private unnamed_addr constant [68 x i8] c"The REPL evaluates a declared SUBSET and says so loudly (v0.24.2-3)\00"
@.str436.c = internal global %nyx_string* null
@.str437 = private unnamed_addr constant [75 x i8] c"El REPL evalúa un SUBCONJUNTO declarado y lo dice en voz alta (v0.24.2-3)\00"
@.str437.c = internal global %nyx_string* null
@.str438 = private unnamed_addr constant [18 x i8] c"bind-failure-loud\00"
...
@.str441 = private unnamed_addr constant [7 x i8] c"0.24.4\00"
@.str441.c = internal global %nyx_string* null
@.str442 = private unnamed_addr constant [7 x i8] c"0.24.4\00"
...
@.str445 = private unnamed_addr constant [17 x i8] c"cannot bind port\00"
...
@.str447 = private unnamed_addr constant [39 x i8] c"tests/ai-first/21-bind-failure-loud.nx\00"
@.str447.c = internal global %nyx_string* null
@.str448 = private unnamed_addr constant [36 x i8] c"A failed bind is LOUD now (v0.24.4)\00"
@.str448.c = internal global %nyx_string* null
@.str449 = private unnamed_addr constant [45 x i8] c"Un bind que falla ahora es RUIDOSO (v0.24.4)\00"
@.str449.c = internal global %nyx_string* null
@.str450 = private unnamed_addr constant [15 x i8] c"file-api-names\00"
...
@.str453 = private unnamed_addr constant [7 x i8] c"0.24.4\00"
@.str453.c = internal global %nyx_string* null
@.str454 = private unnamed_addr constant [7 x i8] c"0.24.4\00"
...
@.str457 = private unnamed_addr constant [10 x i8] c"file_open\00"
@.str457.c = internal global %nyx_string* null
@.str458 = private unnamed_addr constant [23 x i8] c"open_file(|close_file(\00"
...
@.str460 = private unnamed_addr constant [138 x i8] c"The real buffered file API is `file_open()`/`file_write_string()`/`file_close()` — not `open_file()` or `close_file()` (invented names)\00"
@.str460.c = internal global %nyx_string* null
@.str461 = private unnamed_addr constant [149 x i8] c"La API real de archivos con buffer es `file_open()`/`file_write_string()`/`file_close()` — no `open_file()` ni `close_file()` (nombres inventados)\00"
@.str461.c = internal global %nyx_string* null
@.str462 = private unnamed_addr constant [24 x i8] c"array-index-float-write\00"
...
@.str465 = private unnamed_addr constant [8 x i8] c"0.24.10\00"
@.str465.c = internal global %nyx_string* null
@.str466 = private unnamed_addr constant [8 x i8] c"0.24.10\00"
...
@.str470 = private unnamed_addr constant [36 x i8] c"corrupts the value on the next read\00"
@.str470.c = internal global %nyx_string* null
@.str471 = private unnamed_addr constant [76 x i8] c"tests/ai-first/17-csv-aggregator.nx,tests/ai-first/18-http-client-filter.nx\00"
@.str471.c = internal global %nyx_string* null
@.str472 = private unnamed_addr constant [46 x i8] c"`arr[i] = <float>` on an existing Array WORKS\00"
@.str472.c = internal global %nyx_string* null
@.str473 = private unnamed_addr constant [53 x i8] c"`arr[i] = <float>` sobre un Array existente FUNCIONA\00"
@.str473.c = internal global %nyx_string* null
@.str474 = private unnamed_addr constant [26 x i8] c"sync-global-init-reliable\00"
...
@.str477 = private unnamed_addr constant [8 x i8] c"0.24.27\00"
@.str477.c = internal global %nyx_string* null
@.str478 = private unnamed_addr constant [8 x i8] c"0.24.27\00"
...
@.str481 = private unnamed_addr constant [10 x i8] c"mutex_new\00"
...
@.str483 = private unnamed_addr constant [50 x i8] c"tests/ai-first/23-sync-global-mutex-wg-timeout.nx\00"
@.str483.c = internal global %nyx_string* null
@.str484 = private unnamed_addr constant [132 x i8] c"Stateful handles (`mutex_new()`, `sem_new()`, `wg_new()`) are RELIABLE as global initializers (since v0.24.27; measured 2026-08-21)\00"
@.str484.c = internal global %nyx_string* null
@.str485 = private unnamed_addr constant [145 x i8] c"Los handles con estado (`mutex_new()`, `sem_new()`, `wg_new()`) son CONFIABLES como inicializadores globales (desde v0.24.27; medido 2026-08-21)\00"
@.str485.c = internal global %nyx_string* null
@.str486 = private unnamed_addr constant [3 x i8] c"id\00"
@.str486.c = internal global %nyx_string* null
@.str487 = private unnamed_addr constant [5 x i8] c"kind\00"
@.str487.c = internal global %nyx_string* null
@.str488 = private unnamed_addr constant [9 x i8] c"severity\00"
@.str488.c = internal global %nyx_string* null
@.str489 = private unnamed_addr constant [6 x i8] c"since\00"
@.str489.c = internal global %nyx_string* null
@.str490 = private unnamed_addr constant [9 x i8] c"fixed_in\00"
@.str490.c = internal global %nyx_string* null
@.str491 = private unnamed_addr constant [8 x i8] c"pattern\00"
@.str491.c = internal global %nyx_string* null
@.str492 = private unnamed_addr constant [9 x i8] c"vet_code\00"
@.str492.c = internal global %nyx_string* null
@.str493 = private unnamed_addr constant [7 x i8] c"anchor\00"
@.str493.c = internal global %nyx_string* null
@.str494 = private unnamed_addr constant [5 x i8] c"lies\00"
@.str494.c = internal global %nyx_string* null
@.str495 = private unnamed_addr constant [5 x i8] c"test\00"
@.str495.c = internal global %nyx_string* null
@.str496 = private unnamed_addr constant [9 x i8] c"title_en\00"
@.str496.c = internal global %nyx_string* null
@.str497 = private unnamed_addr constant [9 x i8] c"title_es\00"
...
define { i64, i8* }* @gotchas_table(
  ...
  %207 = getelementptr [19 x i8], [19 x i8]* @.str42, i32 0, i32 0
  %208 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str42.c, i8* %207, i64 18)
  ...
  %234 = getelementptr [51 x i8], [51 x i8]* @.str51, i32 0, i32 0
  ...
  %636 = getelementptr [27 x i8], [27 x i8]* @.str174, i32 0, i32 0
  %637 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str174.c, i8* %636, i64 26)
  ...
  %657 = getelementptr [10 x i8], [10 x i8]* @.str181, i32 0, i32 0
  %658 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str181.c, i8* %657, i64 9)
  ...
  %663 = getelementptr [52 x i8], [52 x i8]* @.str183, i32 0, i32 0
  %664 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str183.c, i8* %663, i64 51)
  %665 = ptrtoint %nyx_string* %664 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %635, i64 %665, i64 2)
  %666 = getelementptr [80 x i8], [80 x i8]* @.str184, i32 0, i32 0
  %667 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str184.c, i8* %666, i64 79)
  %668 = ptrtoint %nyx_string* %667 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %635, i64 %668, i64 2)
  %669 = getelementptr [89 x i8], [89 x i8]* @.str185, i32 0, i32 0
  %670 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str185.c, i8* %669, i64 88)
  ...
  %681 = getelementptr [13 x i8], [13 x i8]* @.str188, i32 0, i32 0
  %682 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str188.c, i8* %681, i64 12)
  ...
  %696 = getelementptr [11 x i8], [11 x i8]* @.str193, i32 0, i32 0
  %697 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str193.c, i8* %696, i64 10)
  ...
  %702 = getelementptr [27 x i8], [27 x i8]* @.str195, i32 0, i32 0
  %703 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str195.c, i8* %702, i64 26)
  %704 = ptrtoint %nyx_string* %703 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %674, i64 %704, i64 2)
  %705 = getelementptr [86 x i8], [86 x i8]* @.str196, i32 0, i32 0
  %706 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str196.c, i8* %705, i64 85)
  %707 = ptrtoint %nyx_string* %706 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %674, i64 %707, i64 2)
  %708 = getelementptr [94 x i8], [94 x i8]* @.str197, i32 0, i32 0
  %709 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str197.c, i8* %708, i64 93)
  ...
  %714 = getelementptr [25 x i8], [25 x i8]* @.str198, i32 0, i32 0
  %715 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str198.c, i8* %714, i64 24)
  ...
  %735 = getelementptr [6 x i8], [6 x i8]* @.str205, i32 0, i32 0
  %736 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str205.c, i8* %735, i64 5)
  ...
  %741 = getelementptr [97 x i8], [97 x i8]* @.str207, i32 0, i32 0
  %742 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str207.c, i8* %741, i64 96)
  %743 = ptrtoint %nyx_string* %742 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %713, i64 %743, i64 2)
  %744 = getelementptr [74 x i8], [74 x i8]* @.str208, i32 0, i32 0
  %745 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str208.c, i8* %744, i64 73)
  %746 = ptrtoint %nyx_string* %745 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %713, i64 %746, i64 2)
  %747 = getelementptr [72 x i8], [72 x i8]* @.str209, i32 0, i32 0
  %748 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str209.c, i8* %747, i64 71)
  ...
  %753 = getelementptr [17 x i8], [17 x i8]* @.str210, i32 0, i32 0
  %754 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str210.c, i8* %753, i64 16)
  ...
  %759 = getelementptr [5 x i8], [5 x i8]* @.str212, i32 0, i32 0
  %760 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str212.c, i8* %759, i64 4)
  ...
  %768 = getelementptr [10 x i8], [10 x i8]* @.str215, i32 0, i32 0
  %769 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str215.c, i8* %768, i64 9)
  %770 = ptrtoint %nyx_string* %769 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %752, i64 %770, i64 2)
  %771 = getelementptr [5 x i8], [5 x i8]* @.str216, i32 0, i32 0
  %772 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str216.c, i8* %771, i64 4)
  %773 = ptrtoint %nyx_string* %772 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %752, i64 %773, i64 2)
  %774 = getelementptr [7 x i8], [7 x i8]* @.str217, i32 0, i32 0
  %775 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str217.c, i8* %774, i64 6)
  ...
  %780 = getelementptr [57 x i8], [57 x i8]* @.str219, i32 0, i32 0
  %781 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str219.c, i8* %780, i64 56)
  %782 = ptrtoint %nyx_string* %781 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %752, i64 %782, i64 2)
  %783 = getelementptr [89 x i8], [89 x i8]* @.str220, i32 0, i32 0
  %784 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str220.c, i8* %783, i64 88)
  ...
  %792 = getelementptr [19 x i8], [19 x i8]* @.str222, i32 0, i32 0
  %793 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str222.c, i8* %792, i64 18)
  ...
  %813 = getelementptr [7 x i8], [7 x i8]* @.str229, i32 0, i32 0
  %814 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str229.c, i8* %813, i64 6)
  ...
  %822 = getelementptr [14 x i8], [14 x i8]* @.str232, i32 0, i32 0
  %823 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str232.c, i8* %822, i64 13)
  %824 = ptrtoint %nyx_string* %823 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %791, i64 %824, i64 2)
  %825 = getelementptr [14 x i8], [14 x i8]* @.str233, i32 0, i32 0
  %826 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str233.c, i8* %825, i64 13)
  ...
  %852 = getelementptr [1 x i8], [1 x i8]* @.str241, i32 0, i32 0
  %853 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str241.c, i8* %852, i64 0)
  ...
  %861 = getelementptr [47 x i8], [47 x i8]* @.str244, i32 0, i32 0
  %862 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str244.c, i8* %861, i64 46)
  %863 = ptrtoint %nyx_string* %862 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %830, i64 %863, i64 2)
  %864 = getelementptr [57 x i8], [57 x i8]* @.str245, i32 0, i32 0
  %865 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str245.c, i8* %864, i64 56)
  ...
  %900 = getelementptr [128 x i8], [128 x i8]* @.str256, i32 0, i32 0
  %901 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str256.c, i8* %900, i64 127)
  %902 = ptrtoint %nyx_string* %901 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %869, i64 %902, i64 2)
  %903 = getelementptr [132 x i8], [132 x i8]* @.str257, i32 0, i32 0
  %904 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str257.c, i8* %903, i64 131)
  ...
  %930 = getelementptr [4 x i8], [4 x i8]* @.str265, i32 0, i32 0
  %931 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str265.c, i8* %930, i64 3)
  ...
  %939 = getelementptr [91 x i8], [91 x i8]* @.str268, i32 0, i32 0
  %940 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str268.c, i8* %939, i64 90)
  %941 = ptrtoint %nyx_string* %940 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %908, i64 %941, i64 2)
  %942 = getelementptr [97 x i8], [97 x i8]* @.str269, i32 0, i32 0
  %943 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str269.c, i8* %942, i64 96)
  ...
  %948 = getelementptr [33 x i8], [33 x i8]* @.str270, i32 0, i32 0
  %949 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str270.c, i8* %948, i64 32)
  ...
  %969 = getelementptr [17 x i8], [17 x i8]* @.str277, i32 0, i32 0
  %970 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str277.c, i8* %969, i64 16)
  ...
  %978 = getelementptr [49 x i8], [49 x i8]* @.str280, i32 0, i32 0
  %979 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str280.c, i8* %978, i64 48)
  %980 = ptrtoint %nyx_string* %979 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %947, i64 %980, i64 2)
  %981 = getelementptr [58 x i8], [58 x i8]* @.str281, i32 0, i32 0
  %982 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str281.c, i8* %981, i64 57)
  ...
  %999 = getelementptr [7 x i8], [7 x i8]* @.str286, i32 0, i32 0
  %1000 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str286.c, i8* %999, i64 6)
  ...
  %1008 = getelementptr [14 x i8], [14 x i8]* @.str289, i32 0, i32 0
  %1009 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str289.c, i8* %1008, i64 13)
  ...
  %1017 = getelementptr [28 x i8], [28 x i8]* @.str292, i32 0, i32 0
  %1018 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str292.c, i8* %1017, i64 27)
  %1019 = ptrtoint %nyx_string* %1018 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %986, i64 %1019, i64 2)
  %1020 = getelementptr [35 x i8], [35 x i8]* @.str293, i32 0, i32 0
  %1021 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str293.c, i8* %1020, i64 34)
  ...
  %1038 = getelementptr [7 x i8], [7 x i8]* @.str298, i32 0, i32 0
  %1039 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str298.c, i8* %1038, i64 6)
  ...
  %1047 = getelementptr [14 x i8], [14 x i8]* @.str301, i32 0, i32 0
  %1048 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str301.c, i8* %1047, i64 13)
  ...
  %1056 = getelementptr [37 x i8], [37 x i8]* @.str304, i32 0, i32 0
  %1057 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str304.c, i8* %1056, i64 36)
  %1058 = ptrtoint %nyx_string* %1057 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1025, i64 %1058, i64 2)
  %1059 = getelementptr [48 x i8], [48 x i8]* @.str305, i32 0, i32 0
  %1060 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str305.c, i8* %1059, i64 47)
  ...
  %1077 = getelementptr [7 x i8], [7 x i8]* @.str310, i32 0, i32 0
  %1078 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str310.c, i8* %1077, i64 6)
  ...
  %1089 = getelementptr [50 x i8], [50 x i8]* @.str314, i32 0, i32 0
  %1090 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str314.c, i8* %1089, i64 49)
  %1091 = ptrtoint %nyx_string* %1090 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1064, i64 %1091, i64 2)
  %1092 = getelementptr [60 x i8], [60 x i8]* @.str315, i32 0, i32 0
  %1093 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str315.c, i8* %1092, i64 59)
  %1094 = ptrtoint %nyx_string* %1093 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1064, i64 %1094, i64 2)
  %1095 = getelementptr [95 x i8], [95 x i8]* @.str316, i32 0, i32 0
  %1096 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str316.c, i8* %1095, i64 94)
  ...
  %1125 = getelementptr [18 x i8], [18 x i8]* @.str325, i32 0, i32 0
  %1126 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str325.c, i8* %1125, i64 17)
  ...
  %1134 = getelementptr [73 x i8], [73 x i8]* @.str328, i32 0, i32 0
  %1135 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str328.c, i8* %1134, i64 72)
  %1136 = ptrtoint %nyx_string* %1135 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1103, i64 %1136, i64 2)
  %1137 = getelementptr [90 x i8], [90 x i8]* @.str329, i32 0, i32 0
  %1138 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str329.c, i8* %1137, i64 89)
  ...
  %1143 = getelementptr [18 x i8], [18 x i8]* @.str330, i32 0, i32 0
  %1144 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str330.c, i8* %1143, i64 17)
  ...
  %1152 = getelementptr [8 x i8], [8 x i8]* @.str333, i32 0, i32 0
  %1153 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str333.c, i8* %1152, i64 7)
  %1154 = ptrtoint %nyx_string* %1153 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1142, i64 %1154, i64 2)
  %1155 = getelementptr [8 x i8], [8 x i8]* @.str334, i32 0, i32 0
  %1156 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str334.c, i8* %1155, i64 7)
  ...
  %1170 = getelementptr [34 x i8], [34 x i8]* @.str339, i32 0, i32 0
  %1171 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str339.c, i8* %1170, i64 33)
  %1172 = ptrtoint %nyx_string* %1171 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1142, i64 %1172, i64 2)
  %1173 = getelementptr [63 x i8], [63 x i8]* @.str340, i32 0, i32 0
  %1174 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str340.c, i8* %1173, i64 62)
  %1175 = ptrtoint %nyx_string* %1174 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1142, i64 %1175, i64 2)
  %1176 = getelementptr [69 x i8], [69 x i8]* @.str341, i32 0, i32 0
  %1177 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str341.c, i8* %1176, i64 68)
  ...
  %1182 = getelementptr [27 x i8], [27 x i8]* @.str342, i32 0, i32 0
  %1183 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str342.c, i8* %1182, i64 26)
  ...
  %1191 = getelementptr [8 x i8], [8 x i8]* @.str345, i32 0, i32 0
  %1192 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str345.c, i8* %1191, i64 7)
  %1193 = ptrtoint %nyx_string* %1192 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1181, i64 %1193, i64 2)
  %1194 = getelementptr [8 x i8], [8 x i8]* @.str346, i32 0, i32 0
  %1195 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str346.c, i8* %1194, i64 7)
  ...
  %1206 = getelementptr [28 x i8], [28 x i8]* @.str350, i32 0, i32 0
  %1207 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str350.c, i8* %1206, i64 27)
  ...
  %1212 = getelementptr [81 x i8], [81 x i8]* @.str352, i32 0, i32 0
  %1213 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str352.c, i8* %1212, i64 80)
  %1214 = ptrtoint %nyx_string* %1213 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1181, i64 %1214, i64 2)
  %1215 = getelementptr [120 x i8], [120 x i8]* @.str353, i32 0, i32 0
  %1216 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str353.c, i8* %1215, i64 119)
  ...
  %1230 = getelementptr [8 x i8], [8 x i8]* @.str357, i32 0, i32 0
  %1231 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str357.c, i8* %1230, i64 7)
  %1232 = ptrtoint %nyx_string* %1231 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1220, i64 %1232, i64 2)
  %1233 = getelementptr [8 x i8], [8 x i8]* @.str358, i32 0, i32 0
  %1234 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str358.c, i8* %1233, i64 7)
  ...
  %1242 = getelementptr [9 x i8], [9 x i8]* @.str361, i32 0, i32 0
  %1243 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str361.c, i8* %1242, i64 8)
  %1244 = ptrtoint %nyx_string* %1243 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1220, i64 %1244, i64 2)
  %1245 = getelementptr [54 x i8], [54 x i8]* @.str362, i32 0, i32 0
  %1246 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str362.c, i8* %1245, i64 53)
  %1247 = ptrtoint %nyx_string* %1246 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1220, i64 %1247, i64 2)
  %1248 = getelementptr [43 x i8], [43 x i8]* @.str363, i32 0, i32 0
  %1249 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str363.c, i8* %1248, i64 42)
  %1250 = ptrtoint %nyx_string* %1249 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1220, i64 %1250, i64 2)
  %1251 = getelementptr [92 x i8], [92 x i8]* @.str364, i32 0, i32 0
  %1252 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str364.c, i8* %1251, i64 91)
  ...
  %1260 = getelementptr [27 x i8], [27 x i8]* @.str366, i32 0, i32 0
  %1261 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str366.c, i8* %1260, i64 26)
  ...
  %1269 = getelementptr [8 x i8], [8 x i8]* @.str369, i32 0, i32 0
  %1270 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str369.c, i8* %1269, i64 7)
  %1271 = ptrtoint %nyx_string* %1270 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1259, i64 %1271, i64 2)
  %1272 = getelementptr [8 x i8], [8 x i8]* @.str370, i32 0, i32 0
  %1273 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str370.c, i8* %1272, i64 7)
  ...
  %1281 = getelementptr [10 x i8], [10 x i8]* @.str373, i32 0, i32 0
  %1282 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str373.c, i8* %1281, i64 9)
  ...
  %1290 = getelementptr [62 x i8], [62 x i8]* @.str376, i32 0, i32 0
  %1291 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str376.c, i8* %1290, i64 61)
  ...
  %1323 = getelementptr [96 x i8], [96 x i8]* @.str386, i32 0, i32 0
  %1324 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str386.c, i8* %1323, i64 95)
  %1325 = ptrtoint %nyx_string* %1324 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1298, i64 %1325, i64 2)
  %1326 = getelementptr [97 x i8], [97 x i8]* @.str387, i32 0, i32 0
  %1327 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str387.c, i8* %1326, i64 96)
  %1328 = ptrtoint %nyx_string* %1327 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1298, i64 %1328, i64 2)
  %1329 = getelementptr [138 x i8], [138 x i8]* @.str388, i32 0, i32 0
  %1330 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str388.c, i8* %1329, i64 137)
  %1331 = ptrtoint %nyx_string* %1330 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1298, i64 %1331, i64 2)
  %1332 = getelementptr [152 x i8], [152 x i8]* @.str389, i32 0, i32 0
  %1333 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str389.c, i8* %1332, i64 151)
  ...
  %1338 = getelementptr [26 x i8], [26 x i8]* @.str390, i32 0, i32 0
  %1339 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str390.c, i8* %1338, i64 25)
  ...
  %1359 = getelementptr [11 x i8], [11 x i8]* @.str397, i32 0, i32 0
  %1360 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str397.c, i8* %1359, i64 10)
  ...
  %1365 = getelementptr [40 x i8], [40 x i8]* @.str399, i32 0, i32 0
  %1366 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str399.c, i8* %1365, i64 39)
  %1367 = ptrtoint %nyx_string* %1366 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1337, i64 %1367, i64 2)
  %1368 = getelementptr [76 x i8], [76 x i8]* @.str400, i32 0, i32 0
  %1369 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str400.c, i8* %1368, i64 75)
  %1370 = ptrtoint %nyx_string* %1369 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1337, i64 %1370, i64 2)
  %1371 = getelementptr [90 x i8], [90 x i8]* @.str401, i32 0, i32 0
  %1372 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str401.c, i8* %1371, i64 89)
  ...
  %1377 = getelementptr [28 x i8], [28 x i8]* @.str402, i32 0, i32 0
  %1378 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str402.c, i8* %1377, i64 27)
  ...
  %1404 = getelementptr [39 x i8], [39 x i8]* @.str411, i32 0, i32 0
  %1405 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str411.c, i8* %1404, i64 38)
  %1406 = ptrtoint %nyx_string* %1405 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1376, i64 %1406, i64 2)
  %1407 = getelementptr [78 x i8], [78 x i8]* @.str412, i32 0, i32 0
  %1408 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str412.c, i8* %1407, i64 77)
  %1409 = ptrtoint %nyx_string* %1408 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1376, i64 %1409, i64 2)
  %1410 = getelementptr [85 x i8], [85 x i8]* @.str413, i32 0, i32 0
  %1411 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str413.c, i8* %1410, i64 84)
  ...
  %1416 = getelementptr [29 x i8], [29 x i8]* @.str414, i32 0, i32 0
  %1417 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str414.c, i8* %1416, i64 28)
  ...
  %1446 = getelementptr [98 x i8], [98 x i8]* @.str424, i32 0, i32 0
  %1447 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str424.c, i8* %1446, i64 97)
  %1448 = ptrtoint %nyx_string* %1447 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1415, i64 %1448, i64 2)
  %1449 = getelementptr [106 x i8], [106 x i8]* @.str425, i32 0, i32 0
  %1450 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str425.c, i8* %1449, i64 105)
  ...
  %1476 = getelementptr [6 x i8], [6 x i8]* @.str433, i32 0, i32 0
  %1477 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str433.c, i8* %1476, i64 5)
  ...
  %1485 = getelementptr [68 x i8], [68 x i8]* @.str436, i32 0, i32 0
  %1486 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str436.c, i8* %1485, i64 67)
  %1487 = ptrtoint %nyx_string* %1486 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1454, i64 %1487, i64 2)
  %1488 = getelementptr [75 x i8], [75 x i8]* @.str437, i32 0, i32 0
  %1489 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str437.c, i8* %1488, i64 74)
  ...
  %1521 = getelementptr [39 x i8], [39 x i8]* @.str447, i32 0, i32 0
  %1522 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str447.c, i8* %1521, i64 38)
  %1523 = ptrtoint %nyx_string* %1522 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1493, i64 %1523, i64 2)
  %1524 = getelementptr [36 x i8], [36 x i8]* @.str448, i32 0, i32 0
  %1525 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str448.c, i8* %1524, i64 35)
  %1526 = ptrtoint %nyx_string* %1525 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1493, i64 %1526, i64 2)
  %1527 = getelementptr [45 x i8], [45 x i8]* @.str449, i32 0, i32 0
  %1528 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str449.c, i8* %1527, i64 44)
  ...
  %1533 = getelementptr [15 x i8], [15 x i8]* @.str450, i32 0, i32 0
  %1534 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str450.c, i8* %1533, i64 14)
  ...
  %1554 = getelementptr [10 x i8], [10 x i8]* @.str457, i32 0, i32 0
  %1555 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str457.c, i8* %1554, i64 9)
  %1556 = ptrtoint %nyx_string* %1555 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1532, i64 %1556, i64 2)
  %1557 = getelementptr [23 x i8], [23 x i8]* @.str458, i32 0, i32 0
  %1558 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str458.c, i8* %1557, i64 22)
  ...
  %1563 = getelementptr [138 x i8], [138 x i8]* @.str460, i32 0, i32 0
  %1564 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str460.c, i8* %1563, i64 137)
  %1565 = ptrtoint %nyx_string* %1564 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1532, i64 %1565, i64 2)
  %1566 = getelementptr [149 x i8], [149 x i8]* @.str461, i32 0, i32 0
  %1567 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str461.c, i8* %1566, i64 148)
  ...
  %1572 = getelementptr [24 x i8], [24 x i8]* @.str462, i32 0, i32 0
  %1573 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str462.c, i8* %1572, i64 23)
  ...
  %1593 = getelementptr [1 x i8], [1 x i8]* @.str469, i32 0, i32 0
  %1594 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str469.c, i8* %1593, i64 0)
  %1595 = ptrtoint %nyx_string* %1594 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1571, i64 %1595, i64 2)
  %1596 = getelementptr [36 x i8], [36 x i8]* @.str470, i32 0, i32 0
  %1597 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str470.c, i8* %1596, i64 35)
  %1598 = ptrtoint %nyx_string* %1597 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1571, i64 %1598, i64 2)
  %1599 = getelementptr [76 x i8], [76 x i8]* @.str471, i32 0, i32 0
  %1600 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str471.c, i8* %1599, i64 75)
  %1601 = ptrtoint %nyx_string* %1600 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1571, i64 %1601, i64 2)
  %1602 = getelementptr [46 x i8], [46 x i8]* @.str472, i32 0, i32 0
  %1603 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str472.c, i8* %1602, i64 45)
  %1604 = ptrtoint %nyx_string* %1603 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1571, i64 %1604, i64 2)
  %1605 = getelementptr [53 x i8], [53 x i8]* @.str473, i32 0, i32 0
  %1606 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str473.c, i8* %1605, i64 52)
  ...
  %1611 = getelementptr [26 x i8], [26 x i8]* @.str474, i32 0, i32 0
  %1612 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str474.c, i8* %1611, i64 25)
  ...
  %1638 = getelementptr [50 x i8], [50 x i8]* @.str483, i32 0, i32 0
  %1639 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str483.c, i8* %1638, i64 49)
  %1640 = ptrtoint %nyx_string* %1639 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1610, i64 %1640, i64 2)
  %1641 = getelementptr [132 x i8], [132 x i8]* @.str484, i32 0, i32 0
  %1642 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str484.c, i8* %1641, i64 131)
  %1643 = ptrtoint %nyx_string* %1642 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1610, i64 %1643, i64 2)
  %1644 = getelementptr [145 x i8], [145 x i8]* @.str485, i32 0, i32 0
  %1645 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str485.c, i8* %1644, i64 144)
...
{ i64, i8* }* %row.param, %nyx_string* %name.param) {
  ...
  %1649 = sub i64 0, 1
  %1650 = alloca i64
  store i64 %1649, i64* %1650
  %1651 = load %nyx_string*, %nyx_string** %name.ptr
  %1652 = getelementptr [3 x i8], [3 x i8]* @.str486, i32 0, i32 0
  %1653 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str486.c, i8* %1652, i64 2)
  %1654 = call i1 @nyx_string_equals(%nyx_string* %1651, %nyx_string* %1653)
  br i1 %1654, label %then24, label %else25
then24:
...
else25:
  br label %merge26
merge26:
  %1655 = load %nyx_string*, %nyx_string** %name.ptr
  %1656 = getelementptr [5 x i8], [5 x i8]* @.str487, i32 0, i32 0
  %1657 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str487.c, i8* %1656, i64 4)
  %1658 = call i1 @nyx_string_equals(%nyx_string* %1655, %nyx_string* %1657)
  br i1 %1658, label %then27, label %else28
then27:
  store i64 1, i64* %1650
  br label %merge29
else28:
  br label %merge29
merge29:
  %1659 = load %nyx_string*, %nyx_string** %name.ptr
  %1660 = getelementptr [9 x i8], [9 x i8]* @.str488, i32 0, i32 0
  %1661 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str488.c, i8* %1660, i64 8)
  %1662 = call i1 @nyx_string_equals(%nyx_string* %1659, %nyx_string* %1661)
  br i1 %1662, label %then30, label %else31
then30:
  store i64 2, i64* %1650
  br label %merge32
else31:
  br label %merge32
merge32:
  %1663 = load %nyx_string*, %nyx_string** %name.ptr
  %1664 = getelementptr [6 x i8], [6 x i8]* @.str489, i32 0, i32 0
  %1665 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str489.c, i8* %1664, i64 5)
  %1666 = call i1 @nyx_string_equals(%nyx_string* %1663, %nyx_string* %1665)
  br i1 %1666, label %then33, label %else34
then33:
...
else34:
  br label %merge35
merge35:
  %1667 = load %nyx_string*, %nyx_string** %name.ptr
  %1668 = getelementptr [9 x i8], [9 x i8]* @.str490, i32 0, i32 0
  %1669 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str490.c, i8* %1668, i64 8)
  %1670 = call i1 @nyx_string_equals(%nyx_string* %1667, %nyx_string* %1669)
  br i1 %1670, label %then36, label %else37
then36:
...
else37:
  br label %merge38
merge38:
  %1671 = load %nyx_string*, %nyx_string** %name.ptr
  %1672 = getelementptr [8 x i8], [8 x i8]* @.str491, i32 0, i32 0
  %1673 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str491.c, i8* %1672, i64 7)
  %1674 = call i1 @nyx_string_equals(%nyx_string* %1671, %nyx_string* %1673)
  br i1 %1674, label %then39, label %else40
then39:
  store i64 5, i64* %1650
  br label %merge41
else40:
  br label %merge41
merge41:
  %1675 = load %nyx_string*, %nyx_string** %name.ptr
  %1676 = getelementptr [9 x i8], [9 x i8]* @.str492, i32 0, i32 0
  %1677 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str492.c, i8* %1676, i64 8)
  %1678 = call i1 @nyx_string_equals(%nyx_string* %1675, %nyx_string* %1677)
  br i1 %1678, label %then42, label %else43
then42:
  store i64 6, i64* %1650
  br label %merge44
else43:
  br label %merge44
merge44:
  %1679 = load %nyx_string*, %nyx_string** %name.ptr
  %1680 = getelementptr [7 x i8], [7 x i8]* @.str493, i32 0, i32 0
  %1681 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str493.c, i8* %1680, i64 6)
  %1682 = call i1 @nyx_string_equals(%nyx_string* %1679, %nyx_string* %1681)
  br i1 %1682, label %then45, label %else46
then45:
  store i64 7, i64* %1650
  br label %merge47
else46:
  br label %merge47
merge47:
  %1683 = load %nyx_string*, %nyx_string** %name.ptr
  %1684 = getelementptr [5 x i8], [5 x i8]* @.str494, i32 0, i32 0
  %1685 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str494.c, i8* %1684, i64 4)
  %1686 = call i1 @nyx_string_equals(%nyx_string* %1683, %nyx_string* %1685)
  br i1 %1686, label %then48, label %else49
then48:
  store i64 8, i64* %1650
  br label %merge50
else49:
  br label %merge50
merge50:
  %1687 = load %nyx_string*, %nyx_string** %name.ptr
  %1688 = getelementptr [5 x i8], [5 x i8]* @.str495, i32 0, i32 0
  %1689 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str495.c, i8* %1688, i64 4)
  %1690 = call i1 @nyx_string_equals(%nyx_string* %1687, %nyx_string* %1689)
  br i1 %1690, label %then51, label %else52
then51:
  store i64 9, i64* %1650
  br label %merge53
else52:
  br label %merge53
merge53:
  %1691 = load %nyx_string*, %nyx_string** %name.ptr
  %1692 = getelementptr [9 x i8], [9 x i8]* @.str496, i32 0, i32 0
  %1693 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str496.c, i8* %1692, i64 8)
  %1694 = call i1 @nyx_string_equals(%nyx_string* %1691, %nyx_string* %1693)
  br i1 %1694, label %then54, label %else55
then54:
  store i64 10, i64* %1650
  br label %merge56
else55:
  br label %merge56
merge56:
  %1695 = load %nyx_string*, %nyx_string** %name.ptr
  %1696 = getelementptr [9 x i8], [9 x i8]* @.str497, i32 0, i32 0
  %1697 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str497.c, i8* %1696, i64 8)
  %1698 = call i1 @nyx_string_equals(%nyx_string* %1695, %nyx_string* %1697)
  br i1 %1698, label %then57, label %else58
then57:
  store i64 11, i64* %1650
  br label %merge59
else58:
  br label %merge59
merge59:
  %1699 = load i64, i64* %1650
  %1700 = icmp slt i64 %1699, 0
  br i1 %1700, label %then60, label %else61
then60:
  %1701 = getelementptr [1 x i8], [1 x i8]* @.str498, i32 0, i32 0
  %1702 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str498.c, i8* %1701, i64 0)
  ret %nyx_string* %1702
else61:
  br label %merge62
merge62:
  %1703 = load { i64, i8* }*, { i64, i8* }** %row.ptr
  %1704 = load i64, i64* %1650
  %1705 = call i64 @nyx_array_get_checked({ i64, i8* }* %1703, i64 %1704, i64 2)
  %1706 = inttoptr i64 %1705 to %nyx_string*
