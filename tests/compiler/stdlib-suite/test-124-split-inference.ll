source_filename = "/home/admin/nyx/lang/tests/compiler/stdlib-suite/test-124-split-inference.nx"
target triple = "x86_64-pc-linux-gnu"

@.str0 = private unnamed_addr constant [17 x i8] c"alpha,beta,gamma\00"
@.str0.c = internal global %nyx_string* null
@.str1 = private unnamed_addr constant [2 x i8] c",\00"
@.str1.c = internal global %nyx_string* null
@.str2 = private unnamed_addr constant [13 x i8] c"uno dos tres\00"
...
; Generated from: /home/admin/nyx/lang/tests/compiler/stdlib-suite/test-124-split-inference.nx
...
i32 %argc, i8** %argv) {
  ...
  %1 = getelementptr [17 x i8], [17 x i8]* @.str0, i32 0, i32 0
  ...
  %7 = call { i64, i8* }* @nyx_string_split(%nyx_string* %4, %nyx_string* %6)
  %8 = alloca { i64, i8* }*
  store { i64, i8* }* %7, { i64, i8* }** %8
  %9 = load { i64, i8* }*, { i64, i8* }** %8
  %10 = call i64 @nyx_array_get_checked({ i64, i8* }* %9, i64 0, i64 2)
  %11 = inttoptr i64 %10 to %nyx_string*
  %12 = alloca %nyx_string*
  store %nyx_string* %11, %nyx_string** %12
  %13 = load { i64, i8* }*, { i64, i8* }** %8
  %14 = call i64 @nyx_array_get_checked({ i64, i8* }* %13, i64 1, i64 2)
  %15 = inttoptr i64 %14 to %nyx_string*
  %16 = alloca %nyx_string*
  store %nyx_string* %15, %nyx_string** %16
  %17 = load { i64, i8* }*, { i64, i8* }** %8
  %18 = call i64 @nyx_array_get_checked({ i64, i8* }* %17, i64 2, i64 2)
  %19 = inttoptr i64 %18 to %nyx_string*
  %20 = alloca %nyx_string*
  store %nyx_string* %19, %nyx_string** %20
  %21 = load %nyx_string*, %nyx_string** %12
  %22 = call i8* @nyx_string_to_cstr(%nyx_string* %21)
  call void @nyx_print_string(i8* %22)
  %23 = load %nyx_string*, %nyx_string** %16
  ...
  %27 = getelementptr [13 x i8], [13 x i8]* @.str2, i32 0, i32 0
  ...
  %31 = call { i64, i8* }* @nyx_string_split(%nyx_string* %28, %nyx_string* %30)
  %32 = alloca { i64, i8* }*
...
while_body1:
  ...
  %39 = load { i64, i8* }*, { i64, i8* }** %32
  %40 = load i64, i64* %33
  %41 = call i64 @nyx_array_get_checked({ i64, i8* }* %39, i64 %40, i64 2)
  %42 = inttoptr i64 %41 to %nyx_string*
