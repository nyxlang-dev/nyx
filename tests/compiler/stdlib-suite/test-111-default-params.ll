source_filename = "/home/admin/nyx/lang/tests/compiler/stdlib-suite/test-111-default-params.nx"
...
@.str5 = private unnamed_addr constant [10 x i8] c"localhost\00"
@.str5.c = internal global %nyx_string* null
@.str6 = private unnamed_addr constant [12 x i8] c"example.com\00"
@.str6.c = internal global %nyx_string* null
@.str7 = private unnamed_addr constant [9 x i8] c"10.0.0.1\00"
@.str7.c = internal global %nyx_string* null
@.str8 = private unnamed_addr constant [32 x i8] c"All default param tests passed!\00"
@.str8.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/stdlib-suite/test-111-default-params.nx
...
%nyx_string* %name.param) {
  ...
  %3 = load %nyx_string*, %nyx_string** %name.ptr
...
define internal %nyx_string* @config(
%nyx_string* %host.param, i64 %port.param) {
  %host.ptr = alloca %nyx_string*
  store %nyx_string* %host.param, %nyx_string** %host.ptr
  %port.ptr = alloca i64
  store i64 %port.param, i64* %port.ptr
  %23 = load %nyx_string*, %nyx_string** %host.ptr
  %24 = getelementptr [2 x i8], [2 x i8]* @.str2, i32 0, i32 0
...
i32 %argc, i8** %argv) {
  ...
  %30 = getelementptr [6 x i8], [6 x i8]* @.str3, i32 0, i32 0
  %31 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str3.c, i8* %30)
  %32 = call %nyx_string* @greet(%nyx_string* %31)
  ...
  %36 = getelementptr [4 x i8], [4 x i8]* @.str4, i32 0, i32 0
  %37 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str4.c, i8* %36)
  %38 = call %nyx_string* @greet(%nyx_string* %37)
  ...
  %42 = call i64 @add(i64 5, i64 10)
  %43 = alloca i64
  store i64 %42, i64* %43
  %44 = load i64, i64* %43
  call void @nyx_print_int(i64 %44)
  %45 = call i64 @add(i64 5, i64 20)
  %46 = alloca i64
  store i64 %45, i64* %46
  %47 = load i64, i64* %46
  call void @nyx_print_int(i64 %47)
  %48 = call i64 @power(i64 3, i64 2)
  %49 = alloca i64
  store i64 %48, i64* %49
  %50 = load i64, i64* %49
  call void @nyx_print_int(i64 %50)
  %51 = call i64 @power(i64 2, i64 8)
  %52 = alloca i64
  store i64 %51, i64* %52
  %53 = load i64, i64* %52
  call void @nyx_print_int(i64 %53)
  %54 = getelementptr [10 x i8], [10 x i8]* @.str5, i32 0, i32 0
  %55 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str5.c, i8* %54)
  %56 = call %nyx_string* @config(%nyx_string* %55, i64 8080)
  ...
  %60 = getelementptr [12 x i8], [12 x i8]* @.str6, i32 0, i32 0
  %61 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str6.c, i8* %60)
  %62 = call %nyx_string* @config(%nyx_string* %61, i64 8080)
  ...
  %66 = getelementptr [9 x i8], [9 x i8]* @.str7, i32 0, i32 0
  %67 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str7.c, i8* %66)
  %68 = call %nyx_string* @config(%nyx_string* %67, i64 3000)
  ...
  %72 = getelementptr [32 x i8], [32 x i8]* @.str8, i32 0, i32 0
  %73 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str8.c, i8* %72)
