source_filename = "/home/admin/nyx/lang/tests/compiler/ecosystem/test-184-map-size-has.nx"
...
@.str3 = private unnamed_addr constant [2 x i8] c"2\00"
@.str3.c = internal global %nyx_string* null
@.str4 = private unnamed_addr constant [2 x i8] c"c\00"
@.str4.c = internal global %nyx_string* null
@.str5 = private unnamed_addr constant [2 x i8] c"3\00"
...
; Generated from: /home/admin/nyx/lang/tests/compiler/ecosystem/test-184-map-size-has.nx
...
i32 %argc, i8** %argv) {
  ...
  %13 = getelementptr [2 x i8], [2 x i8]* @.str3, i32 0, i32 0
  ...
  %17 = load i8*, i8** %2
  %18 = getelementptr [2 x i8], [2 x i8]* @.str4, i32 0, i32 0
  ...
  %22 = call i8* @nyx_string_to_cstr(%nyx_string* %19)
  %23 = call i8* @nyx_string_to_cstr(%nyx_string* %21)
  call void @nyx_map_insert_str(i8* %17, i8* %22, i8* %23)
  %24 = load i8*, i8** %2
  ...
  %30 = call i1 @nyx_map_contains_str(i8* %26, i8* %29)
  call void @nyx_print_bool(i1 %30)
  %31 = load i8*, i8** %2
  %32 = getelementptr [2 x i8], [2 x i8]* @.str7, i32 0, i32 0
  %33 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str7.c, i8* %32)
  %34 = call i8* @nyx_string_to_cstr(%nyx_string* %33)
  %35 = call i1 @nyx_map_contains_str(i8* %31, i8* %34)
  call void @nyx_print_bool(i1 %35)
  ret i64 0
}
