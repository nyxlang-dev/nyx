source_filename = "/home/admin/nyx/lang/tests/compiler/ecosystem/test-193-map-remove-clear.nx"
...
@.str4 = private unnamed_addr constant [2 x i8] c"z\00"
...
; Generated from: /home/admin/nyx/lang/tests/compiler/ecosystem/test-193-map-remove-clear.nx
...
i32 %argc, i8** %argv) {
  ...
  call void @nyx_map_insert_int(i8* %3, i8* %6, i64 10)
  %7 = load i8*, i8** %2
  %8 = getelementptr [2 x i8], [2 x i8]* @.str1, i32 0, i32 0
  %9 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str1.c, i8* %8)
  %10 = call i8* @nyx_string_to_cstr(%nyx_string* %9)
  call void @nyx_map_insert_int(i8* %7, i8* %10, i64 20)
  %11 = load i8*, i8** %2
  ...
  call void @nyx_map_insert_int(i8* %11, i8* %14, i64 30)
  %15 = load i8*, i8** %2
  ...
  %19 = call i64 @nyx_map_remove_str(i8* %15, i8* %18)
  %20 = alloca i64
  store i64 %19, i64* %20
  %21 = load i64, i64* %20
  ...
  %37 = load i8*, i8** %2
  %38 = getelementptr [2 x i8], [2 x i8]* @.str5, i32 0, i32 0
  %39 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str5.c, i8* %38)
  %40 = call i8* @nyx_string_to_cstr(%nyx_string* %39)
  %41 = call i1 @nyx_map_contains_str(i8* %37, i8* %40)
  call void @nyx_print_bool(i1 %41)
  %42 = load i8*, i8** %2
  ...
  call void @nyx_print_bool(i1 %46)
  %47 = load i8*, i8** %2
  %48 = getelementptr [2 x i8], [2 x i8]* @.str7, i32 0, i32 0
  %49 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str7.c, i8* %48)
  %50 = call i8* @nyx_string_to_cstr(%nyx_string* %49)
  %51 = call i1 @nyx_map_contains_str(i8* %47, i8* %50)
  call void @nyx_print_bool(i1 %51)
  %52 = load i8*, i8** %2
  call void @nyx_map_clear(i8* %52)
  %53 = load i8*, i8** %2
  %54 = call i64 @nyx_map_length(i8* %53)
  %55 = call %nyx_string* @nyx_string_from_int(i64 %54)
  %56 = call i8* @nyx_string_to_cstr(%nyx_string* %55)
  call void @nyx_print_string(i8* %56)
  %57 = getelementptr [5 x i8], [5 x i8]* @.str8, i32 0, i32 0
