source_filename = "/home/admin/nyx/lang/tests/compiler/ecosystem/test-195-array-element-method.nx"
...
; Generated from: /home/admin/nyx/lang/tests/compiler/ecosystem/test-195-array-element-method.nx
...
i32 %argc, i8** %argv) {
  ...
  call void @nyx_array_push_tagged({ i64, i8* }* %1, i64 %7, i64 2)
  %8 = getelementptr [8 x i8], [8 x i8]* @.str2, i32 0, i32 0
  %9 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str2.c, i8* %8)
  %10 = ptrtoint %nyx_string* %9 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %1, i64 %10, i64 2)
  %11 = alloca { i64, i8* }*
  store { i64, i8* }* %1, { i64, i8* }** %11
  %12 = load { i64, i8* }*, { i64, i8* }** %11
  %13 = call i64 @nyx_array_get_checked({ i64, i8* }* %12, i64 0, i64 2)
  %14 = inttoptr i64 %13 to %nyx_string*
  %15 = call i64 @nyx_string_byte_length(%nyx_string* %14)
  call void @nyx_print_int(i64 %15)
  %16 = alloca i64
  store i64 1, i64* %16
  %17 = load { i64, i8* }*, { i64, i8* }** %11
  %18 = load i64, i64* %16
  %19 = call i64 @nyx_array_get_checked({ i64, i8* }* %17, i64 %18, i64 2)
  ...
  %23 = call i64 @nyx_array_get_checked({ i64, i8* }* %22, i64 2, i64 2)
  %24 = inttoptr i64 %23 to %nyx_string*
  %25 = call %nyx_string* @nyx_string_substring(%nyx_string* %24, i64 0, i64 3)
  %26 = call i8* @nyx_string_to_cstr(%nyx_string* %25)
  call void @nyx_print_string(i8* %26)
  %27 = load { i64, i8* }*, { i64, i8* }** %11
  %28 = call i64 @nyx_array_get_checked({ i64, i8* }* %27, i64 0, i64 2)
  %29 = inttoptr i64 %28 to %nyx_string*
  %30 = call i64 @nyx_string_byte_length(%nyx_string* %29)
  %31 = load { i64, i8* }*, { i64, i8* }** %11
  %32 = call i64 @nyx_array_get_checked({ i64, i8* }* %31, i64 1, i64 2)
  %33 = inttoptr i64 %32 to %nyx_string*
  ...
  %38 = load { i64, i8* }*, { i64, i8* }** %11
  %39 = call i64 @nyx_array_get_checked({ i64, i8* }* %38, i64 2, i64 2)
  %40 = inttoptr i64 %39 to %nyx_string*
  %41 = alloca %nyx_string*
  store %nyx_string* %40, %nyx_string** %41
  %42 = load %nyx_string*, %nyx_string** %41
  %43 = call i64 @nyx_string_byte_length(%nyx_string* %42)
