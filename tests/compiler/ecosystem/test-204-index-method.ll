source_filename = "/home/admin/nyx/lang/tests/compiler/ecosystem/test-204-index-method.nx"
...
@.str3 = private unnamed_addr constant [3 x i8] c"he\00"
...
; Generated from: /home/admin/nyx/lang/tests/compiler/ecosystem/test-204-index-method.nx
...
i32 %argc, i8** %argv) {
  ...
  %13 = call i64 @nyx_array_get_checked({ i64, i8* }* %12, i64 1, i64 2)
  ...
  %21 = call i64 @nyx_array_get_checked({ i64, i8* }* %20, i64 0, i64 2)
  %22 = inttoptr i64 %21 to %nyx_string*
  %23 = getelementptr [3 x i8], [3 x i8]* @.str3, i32 0, i32 0
  %24 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str3.c, i8* %23)
  %25 = call i1 @nyx_string_starts_with(%nyx_string* %22, %nyx_string* %24)
  br i1 %25, label %then0, label %else1
then0:
  %26 = getelementptr [3 x i8], [3 x i8]* @.str4, i32 0, i32 0
