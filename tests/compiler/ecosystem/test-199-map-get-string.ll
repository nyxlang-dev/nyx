source_filename = "/home/admin/nyx/lang/tests/compiler/ecosystem/test-199-map-get-string.nx"
target triple = "x86_64-pc-linux-gnu"

%Config = type { i8* }

@.str0 = private unnamed_addr constant [9 x i8] c"greeting\00"
@.str0.c = internal global %nyx_string* null
@.str1 = private unnamed_addr constant [6 x i8] c"hello\00"
@.str1.c = internal global %nyx_string* null
@.str2 = private unnamed_addr constant [9 x i8] c"greeting\00"
...
@.str5 = private unnamed_addr constant [5 x i8] c"lang\00"
@.str5.c = internal global %nyx_string* null
@.str6 = private unnamed_addr constant [5 x i8] c"mode\00"
@.str6.c = internal global %nyx_string* null
@.str7 = private unnamed_addr constant [5 x i8] c"fast\00"
@.str7.c = internal global %nyx_string* null
@.str8 = private unnamed_addr constant [5 x i8] c"mode\00"
@.str8.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/ecosystem/test-199-map-get-string.nx
...
i32 %argc, i8** %argv) {
  ...
  store i8* %1, i8** %2
  %3 = load i8*, i8** %2
  %4 = getelementptr [9 x i8], [9 x i8]* @.str0, i32 0, i32 0
  %5 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str0.c, i8* %4)
  %6 = getelementptr [6 x i8], [6 x i8]* @.str1, i32 0, i32 0
  ...
  %19 = load i8*, i8** @g_map
  %20 = getelementptr [5 x i8], [5 x i8]* @.str3, i32 0, i32 0
  %21 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str3.c, i8* %20)
  %22 = getelementptr [4 x i8], [4 x i8]* @.str4, i32 0, i32 0
  %23 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str4.c, i8* %22)
  %24 = call i8* @nyx_string_to_cstr(%nyx_string* %21)
  %25 = call i8* @nyx_string_to_cstr(%nyx_string* %23)
  call void @nyx_map_insert_str(i8* %19, i8* %24, i8* %25)
  %26 = load i8*, i8** @g_map
  %27 = getelementptr [5 x i8], [5 x i8]* @.str5, i32 0, i32 0
  ...
  %35 = getelementptr %Config, %Config* null, i32 1
  %36 = ptrtoint %Config* %35 to i64
  %37 = call i8* @GC_malloc(i64 %36)
  %38 = bitcast i8* %37 to %Config*
  %39 = call i8* @nyx_map_new(i32 0)
  %40 = getelementptr %Config, %Config* %38, i32 0, i32 0
  store i8* %39, i8** %40
  %41 = load %Config, %Config* %38
  %42 = alloca %Config
  store %Config %41, %Config* %42
  %43 = getelementptr %Config, %Config* %42, i32 0, i32 0
  %44 = load i8*, i8** %43
  %45 = getelementptr [5 x i8], [5 x i8]* @.str6, i32 0, i32 0
  %46 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str6.c, i8* %45)
  %47 = getelementptr [5 x i8], [5 x i8]* @.str7, i32 0, i32 0
  ...
  call void @nyx_map_insert_str(i8* %44, i8* %49, i8* %50)
  %51 = getelementptr %Config, %Config* %42, i32 0, i32 0
  %52 = load i8*, i8** %51
  %53 = getelementptr [5 x i8], [5 x i8]* @.str8, i32 0, i32 0
  %54 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str8.c, i8* %53)
  %55 = call i8* @nyx_string_to_cstr(%nyx_string* %54)
  %56 = call i8* @nyx_map_get_str(i8* %52, i8* %55)
...
entry:
  %61 = call i8* @nyx_map_new(i32 0)
  store i8* %61, i8** @g_map
  ret void
}
