source_filename = "/home/admin/nyx/lang/tests/compiler/ecosystem/test-180-length-property.nx"
...
; Generated from: /home/admin/nyx/lang/tests/compiler/ecosystem/test-180-length-property.nx
...
i32 %argc, i8** %argv) {
  ...
  %4 = call i64 @nyx_array_length({ i64, i8* }* %3)
  call void @nyx_print_int(i64 %4)
  %5 = getelementptr [6 x i8], [6 x i8]* @.str0, i32 0, i32 0
  ...
  %13 = call i64 @nyx_array_length({ i64, i8* }* %12)
  call void @nyx_print_int(i64 %13)
  %14 = getelementptr [1 x i8], [1 x i8]* @.str1, i32 0, i32 0
