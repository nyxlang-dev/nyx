source_filename = "/home/admin/nyx/lang/tests/compiler/language/test-297-loop-body-alloca-stack.nx"
...
@.str2 = private unnamed_addr constant [41 x i8] c"A9 loop-body alloca no desborda el stack\00"
@.str2.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/language/test-297-loop-body-alloca-stack.nx
...
while_body1:
  ...
  call void @nyx_array_push_tagged({ i64, i8* }* %7, i64 0, i64 1)
  %8 = load i64, i64* %3
  %9 = add i64 %8, 1
  store i64 %9, i64* %3
  br label %while_cond0
...
while_cond3:
  %13 = load i64, i64* %10
  %14 = icmp slt i64 %13, 1200000
  br i1 %14, label %while_body4, label %while_end5
while_body4:
  ...
  %19 = call %nyx_string* @nyx_string_from_char(i8 %18)
  %20 = alloca %nyx_string*
  store %nyx_string* %19, %nyx_string** %20
  %21 = load { i64, i8* }*, { i64, i8* }** %2
  %22 = load i64, i64* %10
  %23 = srem i64 %22, 256
  %24 = load %nyx_string*, %nyx_string** %20
  %25 = call i8 @nyx_string_char_at(%nyx_string* %24, i64 0)
  %26 = zext i8 %25 to i64
  call void @nyx_array_set_tagged({ i64, i8* }* %21, i64 %23, i64 %26, i64 1)
  %27 = load i64, i64* %11
  %28 = load %nyx_string*, %nyx_string** %20
  %29 = call i8 @nyx_string_char_at(%nyx_string* %28, i64 0)
...
for_cond7:
  %42 = load i64, i64* %40
  %43 = icmp slt i64 %42, 600000
  br i1 %43, label %for_body8, label %for_end9
for_body8:
  ...
  %48 = call %nyx_string* @nyx_string_from_char(i8 %47)
  %49 = alloca %nyx_string*
  store %nyx_string* %48, %nyx_string** %49
  %50 = load i64, i64* %39
  %51 = load %nyx_string*, %nyx_string** %49
  %52 = call i8 @nyx_string_char_at(%nyx_string* %51, i64 0)
...
for_end9:
  %57 = load i64, i64* %39
  %58 = icmp eq i64 %57, 65699976
  %59 = getelementptr [17 x i8], [17 x i8]* @.str1, i32 0, i32 0
  %60 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str1.c, i8* %59)
  %61 = call i8* @nyx_string_to_cstr(%nyx_string* %60)
  br i1 %58, label %assert_pass_10, label %assert_fail_10
assert_fail_10:
  call void @nyx_assert_fail(i8* %61)
  store i64 1, i64* @__nyx_test_failed
  br label %assert_pass_10
assert_pass_10:
  %62 = getelementptr [41 x i8], [41 x i8]* @.str2, i32 0, i32 0
