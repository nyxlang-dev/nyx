source_filename = "/home/admin/nyx/lang/tests/compiler/language/test-295-chr-nul-safe.nx"
...
@.str9 = private unnamed_addr constant [19 x i8] c"chr(0) NUL-safe OK\00"
@.str9.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/language/test-295-chr-nul-safe.nx
...
i32 %argc, i8** %argv) {
  ...
  %1 = trunc i64 65 to i8
  %2 = call %nyx_string* @nyx_string_from_char(i8 %1)
  %3 = trunc i64 0 to i8
  %4 = call %nyx_string* @nyx_string_from_char(i8 %3)
  %5 = call %nyx_string* @nyx_string_concat(%nyx_string* %2, %nyx_string* %4)
  %6 = trunc i64 66 to i8
  %7 = call %nyx_string* @nyx_string_from_char(i8 %6)
...
assert_pass_0:
  ...
  %17 = call i8 @nyx_string_char_at(%nyx_string* %16, i64 0)
  %18 = zext i8 %17 to i64
  %19 = icmp eq i64 %18, 65
  %20 = getelementptr [17 x i8], [17 x i8]* @.str1, i32 0, i32 0
  %21 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str1.c, i8* %20)
  %22 = call i8* @nyx_string_to_cstr(%nyx_string* %21)
  br i1 %19, label %assert_pass_1, label %assert_fail_1
assert_fail_1:
  call void @nyx_assert_fail(i8* %22)
  store i64 1, i64* @__nyx_test_failed
  br label %assert_pass_1
assert_pass_1:
  %23 = load %nyx_string*, %nyx_string** %9
  %24 = call i8 @nyx_string_char_at(%nyx_string* %23, i64 1)
  %25 = zext i8 %24 to i64
  %26 = icmp eq i64 %25, 0
  %27 = getelementptr [17 x i8], [17 x i8]* @.str2, i32 0, i32 0
  %28 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str2.c, i8* %27)
  %29 = call i8* @nyx_string_to_cstr(%nyx_string* %28)
  br i1 %26, label %assert_pass_2, label %assert_fail_2
assert_fail_2:
  call void @nyx_assert_fail(i8* %29)
  store i64 1, i64* @__nyx_test_failed
  br label %assert_pass_2
assert_pass_2:
  %30 = load %nyx_string*, %nyx_string** %9
  %31 = call i8 @nyx_string_char_at(%nyx_string* %30, i64 2)
...
assert_pass_3:
  %37 = load %nyx_string*, %nyx_string** %9
  %38 = trunc i64 0 to i8
  %39 = call %nyx_string* @nyx_string_from_char(i8 %38)
  %40 = call i64 @nyx_string_index_of(%nyx_string* %37, %nyx_string* %39)
  %41 = icmp eq i64 %40, 1
  %42 = getelementptr [17 x i8], [17 x i8]* @.str4, i32 0, i32 0
  %43 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str4.c, i8* %42)
  %44 = call i8* @nyx_string_to_cstr(%nyx_string* %43)
  br i1 %41, label %assert_pass_4, label %assert_fail_4
assert_fail_4:
...
assert_pass_4:
  ...
  call void @nyx_array_push_tagged({ i64, i8* }* %45, i64 65, i64 1)
  call void @nyx_array_push_tagged({ i64, i8* }* %45, i64 0, i64 1)
  call void @nyx_array_push_tagged({ i64, i8* }* %45, i64 66, i64 1)
  %46 = alloca { i64, i8* }*
  store { i64, i8* }* %45, { i64, i8* }** %46
  %47 = load { i64, i8* }*, { i64, i8* }** %46
  %48 = call %nyx_string* @nyx_string_from_bytes({ i64, i8* }* %47, i64 0, i64 3)
  ...
  %53 = getelementptr [17 x i8], [17 x i8]* @.str5, i32 0, i32 0
  %54 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str5.c, i8* %53)
...
assert_pass_5:
  %56 = load %nyx_string*, %nyx_string** %9
  %57 = call i64 @nyx_string_byte_length(%nyx_string* %56)
  %58 = load %nyx_string*, %nyx_string** %49
  %59 = call i64 @nyx_string_byte_length(%nyx_string* %58)
  %60 = icmp eq i64 %57, %59
  %61 = getelementptr [17 x i8], [17 x i8]* @.str6, i32 0, i32 0
  %62 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str6.c, i8* %61)
...
assert_pass_6:
  ...
  %65 = call %nyx_string* @nyx_string_from_char(i8 %64)
  ...
  %69 = icmp eq i64 %68, 1
  %70 = getelementptr [17 x i8], [17 x i8]* @.str7, i32 0, i32 0
  %71 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str7.c, i8* %70)
  %72 = call i8* @nyx_string_to_cstr(%nyx_string* %71)
  br i1 %69, label %assert_pass_7, label %assert_fail_7
assert_fail_7:
  call void @nyx_assert_fail(i8* %72)
  store i64 1, i64* @__nyx_test_failed
  br label %assert_pass_7
assert_pass_7:
  %73 = load %nyx_string*, %nyx_string** %66
  %74 = call i8 @nyx_string_char_at(%nyx_string* %73, i64 0)
  ...
  br i1 %76, label %assert_pass_8, label %assert_fail_8
assert_fail_8:
  call void @nyx_assert_fail(i8* %79)
  store i64 1, i64* @__nyx_test_failed
  br label %assert_pass_8
assert_pass_8:
  %80 = getelementptr [19 x i8], [19 x i8]* @.str9, i32 0, i32 0
