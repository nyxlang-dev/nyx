source_filename = "/home/admin/nyx/lang/tests/compiler/language/test-282-map-scan.nx"
target triple = "x86_64-pc-linux-gnu"

@.str0 = private unnamed_addr constant [2 x i8] c"k\00"
@.str0.c = internal global %nyx_string* null
@.str1 = private unnamed_addr constant [3 x i8] c"k7\00"
...
@.str7 = private unnamed_addr constant [12 x i8] c"map scan OK\00"
@.str7.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/language/test-282-map-scan.nx
...
while_cond0:
  %8 = load i64, i64* %3
  %9 = icmp slt i64 %8, 40
  br i1 %9, label %while_body1, label %while_end2
while_body1:
  call void @llvm.stackrestore(i8* %7)
  %10 = load i8*, i8** %2
  %11 = load %nyx_string*, %nyx_string** %6
  %12 = load i64, i64* %3
  ...
  call void @nyx_map_insert_int(i8* %10, i8* %16, i64 %15)
  %17 = load i64, i64* %3
  %18 = add i64 %17, 1
  store i64 %18, i64* %3
  br label %while_cond0
while_end2:
  ...
  %23 = alloca i1
  store i1 0, i1* %23
  %24 = getelementptr [3 x i8], [3 x i8]* @.str1, i32 0, i32 0
...
while_body4:
  ...
  %30 = load i8*, i8** %2
  %31 = load i64, i64* %21
  %32 = call { i64, i8* }* @nyx_map_scan_page(i8* %30, i64 %31)
  %33 = alloca { i64, i8* }*
  store { i64, i8* }* %32, { i64, i8* }** %33
  %34 = load { i64, i8* }*, { i64, i8* }** %33
  %35 = call i64 @nyx_array_get({ i64, i8* }* %34, i64 0)
  store i64 %35, i64* %21
  %36 = alloca i64
  store i64 1, i64* %36
...
while_body7:
  ...
  %43 = load i64, i64* %36
  %44 = call i64 @nyx_array_get_checked({ i64, i8* }* %42, i64 %43, i64 2)
  ...
  %49 = call i1 @nyx_string_equals(%nyx_string* %47, %nyx_string* %48)
...
while_end5:
  ...
  br i1 %61, label %assert_pass_18, label %assert_fail_18
assert_fail_18:
...
assert_pass_18:
  ...
  %67 = getelementptr [17 x i8], [17 x i8]* @.str3, i32 0, i32 0
  %68 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str3.c, i8* %67)
  %69 = call i8* @nyx_string_to_cstr(%nyx_string* %68)
  br i1 %66, label %assert_pass_19, label %assert_fail_19
assert_fail_19:
...
assert_pass_19:
  %70 = load i1, i1* %20
  %71 = getelementptr [17 x i8], [17 x i8]* @.str4, i32 0, i32 0
  %72 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str4.c, i8* %71)
  %73 = call i8* @nyx_string_to_cstr(%nyx_string* %72)
  br i1 %70, label %assert_pass_20, label %assert_fail_20
assert_fail_20:
  call void @nyx_assert_fail(i8* %73)
  store i64 1, i64* @__nyx_test_failed
  br label %assert_pass_20
assert_pass_20:
  %74 = call i8* @nyx_map_new(i32 0)
  %75 = alloca i8*
  store i8* %74, i8** %75
  %76 = load i8*, i8** %75
  %77 = call { i64, i8* }* @nyx_map_scan_page(i8* %76, i64 0)
  %78 = alloca { i64, i8* }*
  store { i64, i8* }* %77, { i64, i8* }** %78
  %79 = load { i64, i8* }*, { i64, i8* }** %78
  %80 = call i64 @nyx_array_get({ i64, i8* }* %79, i64 0)
  %81 = icmp eq i64 %80, 0
  %82 = getelementptr [17 x i8], [17 x i8]* @.str5, i32 0, i32 0
  %83 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str5.c, i8* %82)
  %84 = call i8* @nyx_string_to_cstr(%nyx_string* %83)
  br i1 %81, label %assert_pass_21, label %assert_fail_21
assert_fail_21:
  call void @nyx_assert_fail(i8* %84)
  store i64 1, i64* @__nyx_test_failed
  br label %assert_pass_21
assert_pass_21:
  %85 = load { i64, i8* }*, { i64, i8* }** %78
  %86 = call i64 @nyx_array_length({ i64, i8* }* %85)
  %87 = icmp eq i64 %86, 1
  %88 = getelementptr [17 x i8], [17 x i8]* @.str6, i32 0, i32 0
  %89 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str6.c, i8* %88)
  %90 = call i8* @nyx_string_to_cstr(%nyx_string* %89)
  br i1 %87, label %assert_pass_22, label %assert_fail_22
assert_fail_22:
  call void @nyx_assert_fail(i8* %90)
  store i64 1, i64* @__nyx_test_failed
  br label %assert_pass_22
assert_pass_22:
  %91 = getelementptr [12 x i8], [12 x i8]* @.str7, i32 0, i32 0
  %92 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str7.c, i8* %91)
