source_filename = "/home/admin/nyx/lang/tests/compiler/language/test-310-array-contains.nx"
...
@.str4 = private unnamed_addr constant [21 x i8] c"contains bindeado ok\00"
...
@.str7 = private unnamed_addr constant [23 x i8] c"contains encadenado ok\00"
...
@.str12 = private unnamed_addr constant [27 x i8] c"contains vacio y bordes ok\00"
@.str12.c = internal global %nyx_string* null
@.str13 = private unnamed_addr constant [27 x i8] c"test-310-array-contains ok\00"
@.str13.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/language/test-310-array-contains.nx
...
define internal i64 @test_bindeado(
) {
  %4 = call { i64, i8* }* @nyx_array_new_ptr()
  call void @nyx_array_push_tagged({ i64, i8* }* %4, i64 10, i64 1)
  call void @nyx_array_push_tagged({ i64, i8* }* %4, i64 20, i64 1)
  call void @nyx_array_push_tagged({ i64, i8* }* %4, i64 30, i64 1)
  %5 = alloca { i64, i8* }*
  store { i64, i8* }* %4, { i64, i8* }** %5
  %6 = load { i64, i8* }*, { i64, i8* }** %5
  %7 = call i64 @nyx_array_contains({ i64, i8* }* %6, i64 20)
  %8 = trunc i64 %7 to i1
...
assert_pass_0:
  %12 = load { i64, i8* }*, { i64, i8* }** %5
  %13 = call i64 @nyx_array_contains({ i64, i8* }* %12, i64 10)
  %14 = trunc i64 %13 to i1
  %15 = getelementptr [17 x i8], [17 x i8]* @.str1, i32 0, i32 0
...
assert_pass_1:
  ...
  %19 = call i64 @nyx_array_contains({ i64, i8* }* %18, i64 30)
...
assert_pass_2:
  %24 = load { i64, i8* }*, { i64, i8* }** %5
  %25 = call i64 @nyx_array_contains({ i64, i8* }* %24, i64 99)
  %26 = trunc i64 %25 to i1
  %27 = xor i1 %26, true
  %28 = getelementptr [17 x i8], [17 x i8]* @.str3, i32 0, i32 0
  %29 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str3.c, i8* %28)
...
assert_pass_3:
  %31 = getelementptr [21 x i8], [21 x i8]* @.str4, i32 0, i32 0
  %32 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str4.c, i8* %31)
...
define internal i64 @test_encadenado(
  ...
  %34 = call { i64, i8* }* @nums()
  %35 = call i64 @nyx_array_contains({ i64, i8* }* %34, i64 20)
  %36 = trunc i64 %35 to i1
  %37 = getelementptr [17 x i8], [17 x i8]* @.str5, i32 0, i32 0
  %38 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str5.c, i8* %37)
  %39 = call i8* @nyx_string_to_cstr(%nyx_string* %38)
  br i1 %36, label %assert_pass_4, label %assert_fail_4
assert_fail_4:
...
assert_pass_4:
  %40 = call { i64, i8* }* @nums()
  %41 = call i64 @nyx_array_contains({ i64, i8* }* %40, i64 99)
...
assert_pass_5:
  %47 = getelementptr [23 x i8], [23 x i8]* @.str7, i32 0, i32 0
...
assert_pass_6:
  ...
  call void @nyx_array_push_tagged({ i64, i8* }* %59, i64 7, i64 1)
  %60 = alloca { i64, i8* }*
  store { i64, i8* }* %59, { i64, i8* }** %60
  %61 = load { i64, i8* }*, { i64, i8* }** %60
  %62 = call i64 @nyx_array_contains({ i64, i8* }* %61, i64 7)
  %63 = trunc i64 %62 to i1
  %64 = getelementptr [17 x i8], [17 x i8]* @.str9, i32 0, i32 0
  %65 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str9.c, i8* %64)
  %66 = call i8* @nyx_string_to_cstr(%nyx_string* %65)
  br i1 %63, label %assert_pass_7, label %assert_fail_7
assert_fail_7:
  call void @nyx_assert_fail(i8* %66)
  store i64 1, i64* @__nyx_test_failed
  br label %assert_pass_7
assert_pass_7:
  %67 = load { i64, i8* }*, { i64, i8* }** %60
  %68 = call i64 @nyx_array_contains({ i64, i8* }* %67, i64 0)
  %69 = trunc i64 %68 to i1
  %70 = xor i1 %69, true
  %71 = getelementptr [17 x i8], [17 x i8]* @.str10, i32 0, i32 0
...
assert_pass_8:
  ...
  call void @nyx_array_push_tagged({ i64, i8* }* %74, i64 0, i64 1)
  call void @nyx_array_push_tagged({ i64, i8* }* %74, i64 5, i64 1)
  %75 = alloca { i64, i8* }*
  store { i64, i8* }* %74, { i64, i8* }** %75
  %76 = load { i64, i8* }*, { i64, i8* }** %75
  %77 = call i64 @nyx_array_contains({ i64, i8* }* %76, i64 0)
  %78 = trunc i64 %77 to i1
  %79 = getelementptr [17 x i8], [17 x i8]* @.str11, i32 0, i32 0
  %80 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str11.c, i8* %79)
...
assert_pass_9:
  %82 = getelementptr [27 x i8], [27 x i8]* @.str12, i32 0, i32 0
  %83 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str12.c, i8* %82)
...
i32 %argc, i8** %argv) {
  ...
  %85 = call i64 @test_bindeado()
  %86 = call i64 @test_encadenado()
  %87 = call i64 @test_vacio_y_bordes()
  %88 = getelementptr [27 x i8], [27 x i8]* @.str13, i32 0, i32 0
