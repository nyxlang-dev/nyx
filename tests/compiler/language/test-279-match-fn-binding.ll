source_filename = "/home/admin/nyx/lang/tests/compiler/language/test-279-match-fn-binding.nx"
target triple = "x86_64-pc-linux-gnu"

@.str0 = private unnamed_addr constant [6 x i8] c"click\00"
...
@.str3 = private unnamed_addr constant [20 x i8] c"match fn binding OK\00"
@.str3.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/language/test-279-match-fn-binding.nx
...
i8* %f.param) {
  ...
  %6 = load i8*, i8** %5
  %7 = icmp ne i8* %6, null
  br i1 %7, label %cl_env0, label %cl_noenv1
cl_env0:
  %8 = bitcast i8* %4 to i64 (i8*)*
  %9 = call i64 %8(i8* %6)
  br label %cl_merge2
cl_noenv1:
  ...
  br label %cl_merge2
cl_merge2:
  %12 = phi i64 [%9, %cl_env0], [%11, %cl_noenv1]
  ret i64 %12
}

define internal i64 @make_seven(
) {
  ret i64 7
}
...
i32 %argc, i8** %argv) {
  ...
  %33 = getelementptr { i64, i8* }, { i64, i8* }* %32, i32 0, i32 0
  %34 = load i64, i64* %33
  %35 = alloca i64
  store i64 0, i64* %35
  switch i64 %34, label %match_default3 [ i64 0, label %match_arm5 i64 1, label %match_arm6 ]
match_arm5:
  %36 = getelementptr { i64, i8* }, { i64, i8* }* %32, i32 0, i32 1
  %37 = load i8*, i8** %36
...
nested_ok12:
  ...
  br label %match_end4
match_arm6:
  %43 = getelementptr { i64, i8* }, { i64, i8* }* %32, i32 0, i32 1
  %44 = load i8*, i8** %43
  ...
  %50 = getelementptr i64, i64* %45, i64 1
  %51 = load i64, i64* %50
...
match_end4:
  ...
  %58 = load i64, i64* %57
  %59 = icmp eq i64 %58, 7
  %60 = getelementptr [17 x i8], [17 x i8]* @.str1, i32 0, i32 0
  %61 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str1.c, i8* %60)
  %62 = call i8* @nyx_string_to_cstr(%nyx_string* %61)
  br i1 %59, label %assert_pass_15, label %assert_fail_15
assert_fail_15:
...
assert_pass_15:
  ...
  %67 = alloca i64
  store i64 0, i64* %67
  switch i64 %66, label %match_arm19 [ i64 1, label %match_arm18 ]
match_arm18:
  %68 = getelementptr { i64, i8* }, { i64, i8* }* %64, i32 0, i32 1
  %69 = load i8*, i8** %68
  ...
  %78 = alloca i8*
  store i8* %77, i8** %78
  br label %nested_ok25
nested_fail24:
  br label %match_arm19
nested_ok25:
  %79 = load i8*, i8** %78
  %80 = call i64 @call_it(i8* %79)
  %81 = icmp eq i64 %80, 7
  %82 = getelementptr [17 x i8], [17 x i8]* @.str2, i32 0, i32 0
  %83 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str2.c, i8* %82)
  %84 = call i8* @nyx_string_to_cstr(%nyx_string* %83)
  br i1 %81, label %assert_pass_26, label %assert_fail_26
assert_fail_26:
...
match_end17:
  %85 = load i64, i64* %67
  %86 = getelementptr [20 x i8], [20 x i8]* @.str3, i32 0, i32 0
