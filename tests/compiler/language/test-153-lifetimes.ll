source_filename = "/home/admin/nyx/lang/tests/compiler/language/test-153-lifetimes.nx"
...
@.str3 = private unnamed_addr constant [5 x i8] c"rust\00"
@.str3.c = internal global %nyx_string* null
@.str4 = private unnamed_addr constant [3 x i8] c"go\00"
@.str4.c = internal global %nyx_string* null
@.str5 = private unnamed_addr constant [6 x i8] c"first\00"
@.str5.c = internal global %nyx_string* null
@.str6 = private unnamed_addr constant [7 x i8] c"second\00"
@.str6.c = internal global %nyx_string* null
@.str7 = private unnamed_addr constant [13 x i8] c"lifetimes ok\00"
@.str7.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/language/test-153-lifetimes.nx
...
define internal %nyx_string* @longest(
%nyx_string* %x.param, %nyx_string* %y.param) {
  %x.ptr = alloca %nyx_string*
  store %nyx_string* %x.param, %nyx_string** %x.ptr
  %y.ptr = alloca %nyx_string*
  store %nyx_string* %y.param, %nyx_string** %y.ptr
  %1 = load %nyx_string*, %nyx_string** %x.ptr
  %2 = call i64 @nyx_string_byte_length(%nyx_string* %1)
  %3 = load %nyx_string*, %nyx_string** %y.ptr
  %4 = call i64 @nyx_string_byte_length(%nyx_string* %3)
  %5 = icmp sgt i64 %2, %4
  br i1 %5, label %then0, label %else1
then0:
  %6 = load %nyx_string*, %nyx_string** %x.ptr
  ret %nyx_string* %6
else1:
  br label %merge2
merge2:
  %7 = load %nyx_string*, %nyx_string** %y.ptr
  ret %nyx_string* %7
}

define internal %nyx_string* @pick_longer(
%nyx_string* %x.param, %nyx_string* %y.param) {
  %x.ptr = alloca %nyx_string*
  store %nyx_string* %x.param, %nyx_string** %x.ptr
  %y.ptr = alloca %nyx_string*
  store %nyx_string* %y.param, %nyx_string** %y.ptr
  %8 = load %nyx_string*, %nyx_string** %x.ptr
  %9 = call i64 @nyx_string_byte_length(%nyx_string* %8)
  %10 = load %nyx_string*, %nyx_string** %y.ptr
  %11 = call i64 @nyx_string_byte_length(%nyx_string* %10)
  %12 = icmp sge i64 %9, %11
  br i1 %12, label %then3, label %else4
then3:
  %13 = load %nyx_string*, %nyx_string** %x.ptr
  ret %nyx_string* %13
else4:
  br label %merge5
merge5:
  %14 = load %nyx_string*, %nyx_string** %y.ptr
  ret %nyx_string* %14
}

define internal %nyx_string* @get_first(
{ i64, i8* }* %items.param) {
  %items.ptr = alloca { i64, i8* }*
  store { i64, i8* }* %items.param, { i64, i8* }** %items.ptr
  %15 = load { i64, i8* }*, { i64, i8* }** %items.ptr
...
i32 %argc, i8** %argv) {
  ...
  %37 = getelementptr [5 x i8], [5 x i8]* @.str3, i32 0, i32 0
  ...
  %41 = call %nyx_string* @pick_longer(%nyx_string* %38, %nyx_string* %40)
  ...
  call void @nyx_array_retag_unknown({ i64, i8* }* %45, i64 2)
  %46 = alloca { i64, i8* }*
  store { i64, i8* }* %45, { i64, i8* }** %46
  %47 = load { i64, i8* }*, { i64, i8* }** %46
  %48 = getelementptr [6 x i8], [6 x i8]* @.str5, i32 0, i32 0
  %49 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str5.c, i8* %48)
  %50 = ptrtoint %nyx_string* %49 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %47, i64 %50, i64 2)
  %51 = load { i64, i8* }*, { i64, i8* }** %46
  %52 = getelementptr [7 x i8], [7 x i8]* @.str6, i32 0, i32 0
  ...
  %55 = load { i64, i8* }*, { i64, i8* }** %46
  %56 = call %nyx_string* @get_first({ i64, i8* }* %55)
  ...
  %60 = getelementptr [13 x i8], [13 x i8]* @.str7, i32 0, i32 0
