source_filename = "/home/admin/nyx/lang/tests/compiler/language/test-228-map-get-int-concat.nx"
target triple = "x86_64-pc-linux-gnu"

@.str0 = private unnamed_addr constant [2 x i8] c"n\00"
@.str0.c = internal global %nyx_string* null
@.str1 = private unnamed_addr constant [5 x i8] c"otro\00"
@.str1.c = internal global %nyx_string* null
@.str2 = private unnamed_addr constant [3 x i8] c"n=\00"
@.str2.c = internal global %nyx_string* null
@.str3 = private unnamed_addr constant [2 x i8] c"n\00"
@.str3.c = internal global %nyx_string* null
@.str4 = private unnamed_addr constant [4 x i8] c"n=5\00"
...
@.str8 = private unnamed_addr constant [2 x i8] c"n\00"
@.str8.c = internal global %nyx_string* null
@.str9 = private unnamed_addr constant [5 x i8] c"otro\00"
@.str9.c = internal global %nyx_string* null
@.str10 = private unnamed_addr constant [17 x i8] c"assertion failed\00"
@.str10.c = internal global %nyx_string* null
@.str11 = private unnamed_addr constant [12 x i8] c"test-228 OK\00"
@.str11.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/language/test-228-map-get-int-concat.nx
...
i32 %argc, i8** %argv) {
  ...
  call void @nyx_map_insert_int(i8* %3, i8* %6, i64 5)
  %7 = load i8*, i8** %2
  ...
  %25 = getelementptr [17 x i8], [17 x i8]* @.str5, i32 0, i32 0
...
assert_pass_0:
  ...
  %32 = call i64 @nyx_map_get_int(i8* %28, i8* %31)
  %33 = alloca i64
  store i64 %32, i64* %33
  %34 = load i64, i64* %33
  %35 = icmp eq i64 %34, 42
  %36 = getelementptr [17 x i8], [17 x i8]* @.str7, i32 0, i32 0
  %37 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str7.c, i8* %36)
  %38 = call i8* @nyx_string_to_cstr(%nyx_string* %37)
  br i1 %35, label %assert_pass_1, label %assert_fail_1
assert_fail_1:
...
assert_pass_1:
  ...
  %48 = call i64 @nyx_map_get_int(i8* %44, i8* %47)
  %49 = add i64 %43, %48
  %50 = icmp eq i64 %49, 47
  %51 = getelementptr [17 x i8], [17 x i8]* @.str10, i32 0, i32 0
...
assert_pass_2:
  %54 = getelementptr [12 x i8], [12 x i8]* @.str11, i32 0, i32 0
