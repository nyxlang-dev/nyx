source_filename = "/home/admin/nyx/lang/tests/compiler/language/test-226-int-to-string.nx"
...
@.str2 = private unnamed_addr constant [3 x i8] c"55\00"
@.str2.c = internal global %nyx_string* null
@.str3 = private unnamed_addr constant [17 x i8] c"assertion failed\00"
@.str3.c = internal global %nyx_string* null
@.str4 = private unnamed_addr constant [3 x i8] c"42\00"
@.str4.c = internal global %nyx_string* null
@.str5 = private unnamed_addr constant [17 x i8] c"assertion failed\00"
@.str5.c = internal global %nyx_string* null
@.str6 = private unnamed_addr constant [11 x i8] c"respuesta=\00"
@.str6.c = internal global %nyx_string* null
@.str7 = private unnamed_addr constant [13 x i8] c"respuesta=42\00"
...
@.str10 = private unnamed_addr constant [4 x i8] c"2.5\00"
@.str10.c = internal global %nyx_string* null
@.str11 = private unnamed_addr constant [17 x i8] c"assertion failed\00"
@.str11.c = internal global %nyx_string* null
@.str12 = private unnamed_addr constant [12 x i8] c"test-226 OK\00"
@.str12.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/language/test-226-int-to-string.nx
...
i32 %argc, i8** %argv) {
  ...
  store i64 42, i64* %11
  %12 = load i64, i64* %11
  %13 = call %nyx_string* @nyx_string_from_int(i64 %12)
  %14 = alloca %nyx_string*
  store %nyx_string* %13, %nyx_string** %14
  %15 = load %nyx_string*, %nyx_string** %14
  %16 = getelementptr [3 x i8], [3 x i8]* @.str0, i32 0, i32 0
  %17 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str0.c, i8* %16)
  %18 = call i1 @nyx_string_equals(%nyx_string* %15, %nyx_string* %17)
...
assert_pass_4:
  ...
  %34 = getelementptr [3 x i8], [3 x i8]* @.str4, i32 0, i32 0
  ...
  br i1 %36, label %assert_pass_5, label %assert_fail_5
assert_fail_5:
  call void @nyx_assert_fail(i8* %39)
  store i64 1, i64* @__nyx_test_failed
  br label %assert_pass_5
assert_pass_5:
  %40 = getelementptr [11 x i8], [11 x i8]* @.str6, i32 0, i32 0
...
assert_pass_6:
  %53 = alloca double
  store double 2.5, double* %53
  %54 = load double, double* %53
  %55 = call %nyx_string* @nyx_string_from_float(double %54)
...
assert_pass_7:
  ...
  %64 = getelementptr [4 x i8], [4 x i8]* @.str10, i32 0, i32 0
  %65 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str10.c, i8* %64)
  %66 = call i1 @nyx_string_starts_with(%nyx_string* %63, %nyx_string* %65)
  %67 = getelementptr [17 x i8], [17 x i8]* @.str11, i32 0, i32 0
  %68 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str11.c, i8* %67)
  %69 = call i8* @nyx_string_to_cstr(%nyx_string* %68)
  br i1 %66, label %assert_pass_8, label %assert_fail_8
assert_fail_8:
  call void @nyx_assert_fail(i8* %69)
  store i64 1, i64* @__nyx_test_failed
  br label %assert_pass_8
assert_pass_8:
  %70 = getelementptr [12 x i8], [12 x i8]* @.str12, i32 0, i32 0
  %71 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str12.c, i8* %70)
