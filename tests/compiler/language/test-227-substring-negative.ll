source_filename = "/home/admin/nyx/lang/tests/compiler/language/test-227-substring-negative.nx"
target triple = "x86_64-pc-linux-gnu"

@.str0 = private unnamed_addr constant [11 x i8] c"hola mundo\00"
@.str0.c = internal global %nyx_string* null
@.str1 = private unnamed_addr constant [2 x i8] c"z\00"
@.str1.c = internal global %nyx_string* null
@.str2 = private unnamed_addr constant [17 x i8] c"assertion failed\00"
@.str2.c = internal global %nyx_string* null
@.str3 = private unnamed_addr constant [4 x i8] c"hol\00"
...
@.str9 = private unnamed_addr constant [5 x i8] c"hola\00"
@.str9.c = internal global %nyx_string* null
@.str10 = private unnamed_addr constant [17 x i8] c"assertion failed\00"
@.str10.c = internal global %nyx_string* null
@.str11 = private unnamed_addr constant [6 x i8] c"mundo\00"
@.str11.c = internal global %nyx_string* null
@.str12 = private unnamed_addr constant [17 x i8] c"assertion failed\00"
@.str12.c = internal global %nyx_string* null
@.str13 = private unnamed_addr constant [12 x i8] c"test-227 OK\00"
@.str13.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/language/test-227-substring-negative.nx
...
assert_pass_0:
  %15 = load %nyx_string*, %nyx_string** %3
  %16 = load i64, i64* %8
  %17 = call %nyx_string* @nyx_string_substring(%nyx_string* %15, i64 %16, i64 3)
  ...
  %23 = getelementptr [17 x i8], [17 x i8]* @.str4, i32 0, i32 0
...
assert_pass_1:
  ...
  %27 = sub i64 0, 1
  %28 = call %nyx_string* @nyx_string_substring(%nyx_string* %26, i64 0, i64 %27)
  %29 = getelementptr [1 x i8], [1 x i8]* @.str5, i32 0, i32 0
  %30 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str5.c, i8* %29)
  %31 = call i1 @nyx_string_equals(%nyx_string* %28, %nyx_string* %30)
  %32 = getelementptr [17 x i8], [17 x i8]* @.str6, i32 0, i32 0
...
assert_pass_2:
  ...
  %36 = sub i64 0, 5
  %37 = sub i64 0, 2
  %38 = call %nyx_string* @nyx_string_substring(%nyx_string* %35, i64 %36, i64 %37)
  %39 = getelementptr [1 x i8], [1 x i8]* @.str7, i32 0, i32 0
  %40 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str7.c, i8* %39)
  %41 = call i1 @nyx_string_equals(%nyx_string* %38, %nyx_string* %40)
  %42 = getelementptr [17 x i8], [17 x i8]* @.str8, i32 0, i32 0
...
assert_pass_3:
  %45 = load %nyx_string*, %nyx_string** %3
  %46 = call %nyx_string* @nyx_string_substring(%nyx_string* %45, i64 0, i64 4)
  %47 = getelementptr [5 x i8], [5 x i8]* @.str9, i32 0, i32 0
  %48 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str9.c, i8* %47)
  %49 = call i1 @nyx_string_equals(%nyx_string* %46, %nyx_string* %48)
  %50 = getelementptr [17 x i8], [17 x i8]* @.str10, i32 0, i32 0
...
assert_pass_4:
  ...
  %54 = call %nyx_string* @nyx_string_substring(%nyx_string* %53, i64 5, i64 10)
  %55 = getelementptr [6 x i8], [6 x i8]* @.str11, i32 0, i32 0
  ...
  br i1 %57, label %assert_pass_5, label %assert_fail_5
assert_fail_5:
  call void @nyx_assert_fail(i8* %60)
  store i64 1, i64* @__nyx_test_failed
  br label %assert_pass_5
assert_pass_5:
  %61 = getelementptr [12 x i8], [12 x i8]* @.str13, i32 0, i32 0
