source_filename = "/home/admin/nyx/lang/tests/compiler/language/test-152-gats.nx"
target triple = "x86_64-pc-linux-gnu"

@.str0 = private unnamed_addr constant [8 x i8] c"gats ok\00"
@.str0.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/language/test-152-gats.nx
...
i32 %argc, i8** %argv) {
  ...
  call void @nyx_array_push_tagged({ i64, i8* }* %20, i64 1, i64 1)
  %21 = load { i64, i8* }*, { i64, i8* }** %19
  call void @nyx_array_push_tagged({ i64, i8* }* %21, i64 2, i64 1)
  ...
  call void @nyx_array_push_tagged({ i64, i8* }* %24, i64 5, i64 1)
  %25 = load { i64, i8* }*, { i64, i8* }** %19
  %26 = call i64 @sum_array({ i64, i8* }* %25)
  %27 = alloca i64
  store i64 %26, i64* %27
  %28 = load i64, i64* %27
  call void @nyx_print_int(i64 %28)
  %29 = load { i64, i8* }*, { i64, i8* }** %19
  %30 = call i64 @nyx_array_length({ i64, i8* }* %29)
  call void @nyx_print_int(i64 %30)
  %31 = getelementptr [8 x i8], [8 x i8]* @.str0, i32 0, i32 0
