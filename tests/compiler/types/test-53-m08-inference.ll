source_filename = "/home/admin/nyx/lang/tests/compiler/types/test-53-m08-inference.nx"
...
; Generated from: /home/admin/nyx/lang/tests/compiler/types/test-53-m08-inference.nx
...
i32 %argc, i8** %argv) {
  ...
  store i64 1, i64* %10
  %11 = getelementptr %Point, %Point* %9, i32 0, i32 1
  store i64 2, i64* %11
  %12 = load %Point, %Point* %9
  %13 = alloca %Point
  store %Point %12, %Point* %13
  ...
  br label %for_cond0
for_cond0:
  %21 = load i64, i64* %for_idx3
  %22 = icmp slt i64 %21, %19
  br i1 %22, label %for_body1, label %for_end2
for_body1:
  call void @llvm.stackrestore(i8* %20)
  %23 = call i64 @nyx_array_get({ i64, i8* }* %18, i64 %21)
  %24 = alloca i64
  store i64 %23, i64* %24
  %25 = load i64, i64* %17
  %26 = load i64, i64* %24
  %27 = add i64 %25, %26
  store i64 %27, i64* %17
  %28 = load i64, i64* %for_idx3
  %29 = add i64 %28, 1
  store i64 %29, i64* %for_idx3
  br label %for_cond0
for_end2:
  %30 = load i64, i64* %5
  ...
  %39 = getelementptr [3 x i8], [3 x i8]* @.str0, i32 0, i32 0
  %40 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str0.c, i8* %39)
