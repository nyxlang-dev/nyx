source_filename = "/home/admin/nyx/lang/tests/compiler/types/test-42-map-polymorphic.nx"
target triple = "x86_64-pc-linux-gnu"

@.str0 = private unnamed_addr constant [6 x i8] c"alice\00"
@.str0.c = internal global %nyx_string* null
@.str1 = private unnamed_addr constant [12 x i8] c"Alice Smith\00"
@.str1.c = internal global %nyx_string* null
@.str2 = private unnamed_addr constant [4 x i8] c"bob\00"
@.str2.c = internal global %nyx_string* null
@.str3 = private unnamed_addr constant [10 x i8] c"Bob Jones\00"
@.str3.c = internal global %nyx_string* null
@.str4 = private unnamed_addr constant [6 x i8] c"alice\00"
@.str4.c = internal global %nyx_string* null
@.str5 = private unnamed_addr constant [4 x i8] c"bob\00"
@.str5.c = internal global %nyx_string* null
@.str6 = private unnamed_addr constant [6 x i8] c"alice\00"
@.str6.c = internal global %nyx_string* null
@.str7 = private unnamed_addr constant [4 x i8] c"bob\00"
@.str7.c = internal global %nyx_string* null
@.str8 = private unnamed_addr constant [6 x i8] c"alice\00"
@.str8.c = internal global %nyx_string* null
@.str9 = private unnamed_addr constant [4 x i8] c"bob\00"
@.str9.c = internal global %nyx_string* null
@.str10 = private unnamed_addr constant [6 x i8] c"alice\00"
@.str10.c = internal global %nyx_string* null
@.str11 = private unnamed_addr constant [10 x i8] c"has alice\00"
...
; Generated from: /home/admin/nyx/lang/tests/compiler/types/test-42-map-polymorphic.nx
...
i32 %argc, i8** %argv) {
  ...
  %6 = getelementptr [12 x i8], [12 x i8]* @.str1, i32 0, i32 0
  ...
  %10 = load i8*, i8** %2
  %11 = getelementptr [4 x i8], [4 x i8]* @.str2, i32 0, i32 0
  %12 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str2.c, i8* %11)
  %13 = getelementptr [10 x i8], [10 x i8]* @.str3, i32 0, i32 0
  ...
  %17 = load i8*, i8** %2
  %18 = getelementptr [6 x i8], [6 x i8]* @.str4, i32 0, i32 0
  ...
  %30 = call i8* @nyx_map_get_str(i8* %26, i8* %29)
  ...
  %35 = call i8* @nyx_map_new(i32 0)
  %36 = alloca i8*
  store i8* %35, i8** %36
  %37 = load i8*, i8** %36
  %38 = getelementptr [6 x i8], [6 x i8]* @.str6, i32 0, i32 0
  %39 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str6.c, i8* %38)
  %40 = call i8* @nyx_string_to_cstr(%nyx_string* %39)
  call void @nyx_map_insert_int(i8* %37, i8* %40, i64 30)
  %41 = load i8*, i8** %36
  %42 = getelementptr [4 x i8], [4 x i8]* @.str7, i32 0, i32 0
  %43 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str7.c, i8* %42)
  %44 = call i8* @nyx_string_to_cstr(%nyx_string* %43)
  call void @nyx_map_insert_int(i8* %41, i8* %44, i64 25)
  %45 = load i8*, i8** %36
  %46 = getelementptr [6 x i8], [6 x i8]* @.str8, i32 0, i32 0
  %47 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str8.c, i8* %46)
  %48 = call i8* @nyx_string_to_cstr(%nyx_string* %47)
  %49 = call i64 @nyx_map_get_int(i8* %45, i8* %48)
  %50 = alloca i64
  store i64 %49, i64* %50
  %51 = load i64, i64* %50
  ...
  %63 = load i8*, i8** %2
  %64 = getelementptr [6 x i8], [6 x i8]* @.str10, i32 0, i32 0
  %65 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str10.c, i8* %64)
  %66 = call i8* @nyx_string_to_cstr(%nyx_string* %65)
  %67 = call i1 @nyx_map_contains_str(i8* %63, i8* %66)
  br i1 %67, label %then0, label %else1
then0:
  %68 = getelementptr [10 x i8], [10 x i8]* @.str11, i32 0, i32 0
...
else1:
  br label %merge2
merge2:
  %71 = getelementptr [3 x i8], [3 x i8]* @.str12, i32 0, i32 0
  %72 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str12.c, i8* %71)
