source_filename = "/home/admin/nyx/lang/tests/compiler/types/test-27-string-interpolation.nx"
target triple = "x86_64-pc-linux-gnu"

@.str0 = private unnamed_addr constant [6 x i8] c"World\00"
@.str0.c = internal global %nyx_string* null
@.str1 = private unnamed_addr constant [7 x i8] c"Hello \00"
@.str1.c = internal global %nyx_string* null
@.str2 = private unnamed_addr constant [2 x i8] c"!\00"
@.str2.c = internal global %nyx_string* null
@.str3 = private unnamed_addr constant [6 x i8] c"Age: \00"
@.str3.c = internal global %nyx_string* null
@.str4 = private unnamed_addr constant [7 x i8] c"Pi is \00"
@.str4.c = internal global %nyx_string* null
@.str5 = private unnamed_addr constant [7 x i8] c"Flag: \00"
@.str5.c = internal global %nyx_string* null
@.str6 = private unnamed_addr constant [1 x i8] c"\00"
@.str6.c = internal global %nyx_string* null
@.str7 = private unnamed_addr constant [4 x i8] c" + \00"
@.str7.c = internal global %nyx_string* null
@.str8 = private unnamed_addr constant [4 x i8] c" = \00"
@.str8.c = internal global %nyx_string* null
@.str9 = private unnamed_addr constant [9 x i8] c"Double: \00"
@.str9.c = internal global %nyx_string* null
@.str10 = private unnamed_addr constant [1 x i8] c"\00"
@.str10.c = internal global %nyx_string* null
@.str11 = private unnamed_addr constant [1 x i8] c"\00"
@.str11.c = internal global %nyx_string* null
@.str12 = private unnamed_addr constant [13 x i8] c"plain string\00"
@.str12.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/types/test-27-string-interpolation.nx
...
i32 %argc, i8** %argv) {
  ...
  %4 = getelementptr [7 x i8], [7 x i8]* @.str1, i32 0, i32 0
  %5 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str1.c, i8* %4)
  %6 = load %nyx_string*, %nyx_string** %3
  %7 = call %nyx_string* @nyx_string_concat(%nyx_string* %5, %nyx_string* %6)
  ...
  %19 = alloca double
  store double 3.14, double* %19
  %20 = getelementptr [7 x i8], [7 x i8]* @.str4, i32 0, i32 0
  %21 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str4.c, i8* %20)
  %22 = load double, double* %19
  %23 = call %nyx_string* @nyx_string_from_float(double %22)
  ...
  %26 = alloca i1
  store i1 1, i1* %26
  %27 = getelementptr [7 x i8], [7 x i8]* @.str5, i32 0, i32 0
  %28 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str5.c, i8* %27)
  %29 = load i1, i1* %26
  %30 = zext i1 %29 to i64
  %31 = call %nyx_string* @nyx_string_from_bool(i64 %30)
  ...
  %35 = alloca i64
  store i64 20, i64* %35
  %36 = getelementptr [1 x i8], [1 x i8]* @.str6, i32 0, i32 0
  ...
  %44 = load i64, i64* %35
  %45 = call %nyx_string* @nyx_string_from_int(i64 %44)
  %46 = call %nyx_string* @nyx_string_concat(%nyx_string* %43, %nyx_string* %45)
  %47 = getelementptr [4 x i8], [4 x i8]* @.str8, i32 0, i32 0
  %48 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str8.c, i8* %47)
  %49 = call %nyx_string* @nyx_string_concat(%nyx_string* %46, %nyx_string* %48)
  %50 = load i64, i64* %34
  %51 = load i64, i64* %35
  %52 = add i64 %50, %51
  %53 = call %nyx_string* @nyx_string_from_int(i64 %52)
  %54 = call %nyx_string* @nyx_string_concat(%nyx_string* %49, %nyx_string* %53)
  %55 = call i8* @nyx_string_to_cstr(%nyx_string* %54)
  call void @nyx_print_string(i8* %55)
  %56 = getelementptr [9 x i8], [9 x i8]* @.str9, i32 0, i32 0
  %57 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str9.c, i8* %56)
  %58 = load i64, i64* %34
  %59 = mul i64 %58, 2
  ...
  %63 = getelementptr [1 x i8], [1 x i8]* @.str10, i32 0, i32 0
  %64 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str10.c, i8* %63)
  %65 = load %nyx_string*, %nyx_string** %3
  ...
  %68 = getelementptr [1 x i8], [1 x i8]* @.str11, i32 0, i32 0
  ...
  %77 = getelementptr [13 x i8], [13 x i8]* @.str12, i32 0, i32 0
