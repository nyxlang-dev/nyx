source_filename = "/home/admin/nyx/lang/tests/compiler/types/test-56-m08-return-inference-nonint.nx"
target triple = "x86_64-pc-linux-gnu"

@.str0 = private unnamed_addr constant [5 x i8] c"hola\00"
@.str0.c = internal global %nyx_string* null
@.str1 = private unnamed_addr constant [5 x i8] c"even\00"
@.str1.c = internal global %nyx_string* null
@.str2 = private unnamed_addr constant [4 x i8] c"odd\00"
...
; Generated from: /home/admin/nyx/lang/tests/compiler/types/test-56-m08-return-inference-nonint.nx
...
define internal { i64, i8* }* @make_arr(
) {
  %7 = call { i64, i8* }* @nyx_array_new_ptr()
  call void @nyx_array_push_tagged({ i64, i8* }* %7, i64 10, i64 1)
  call void @nyx_array_push_tagged({ i64, i8* }* %7, i64 20, i64 1)
  call void @nyx_array_push_tagged({ i64, i8* }* %7, i64 30, i64 1)
  ret { i64, i8* }* %7
}
...
i32 %argc, i8** %argv) {
  ...
  %8 = call %nyx_string* @greet()
  %9 = alloca %nyx_string*
  store %nyx_string* %8, %nyx_string** %9
  %10 = call i64 @is_even(i64 4)
  %11 = trunc i64 %10 to i1
  %12 = alloca i1
  store i1 %11, i1* %12
  %13 = call { i64, i8* }* @make_arr()
  %14 = alloca { i64, i8* }*
...
merge2:
  ...
  %36 = getelementptr [3 x i8], [3 x i8]* @.str3, i32 0, i32 0
