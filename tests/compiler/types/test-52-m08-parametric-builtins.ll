source_filename = "/home/admin/nyx/lang/tests/compiler/types/test-52-m08-parametric-builtins.nx"
...
@.str2 = private unnamed_addr constant [5 x i8] c"tres\00"
...
; Generated from: /home/admin/nyx/lang/tests/compiler/types/test-52-m08-parametric-builtins.nx
...
i32 %argc, i8** %argv) {
  ...
  call void @nyx_array_push_tagged({ i64, i8* }* %3, i64 4, i64 1)
  %4 = load { i64, i8* }*, { i64, i8* }** %2
  %5 = call { i64, i8* }* @nyx_array_slice({ i64, i8* }* %4, i64 1, i64 3)
  %6 = alloca { i64, i8* }*
  store { i64, i8* }* %5, { i64, i8* }** %6
  %7 = call { i64, i8* }* @nyx_array_new_ptr()
  %8 = getelementptr [4 x i8], [4 x i8]* @.str0, i32 0, i32 0
  ...
  call void @nyx_array_push_tagged({ i64, i8* }* %7, i64 %13, i64 2)
  ...
  call void @nyx_array_push_tagged({ i64, i8* }* %7, i64 %16, i64 2)
  call void @nyx_array_retag_unknown({ i64, i8* }* %7, i64 2)
  %17 = alloca { i64, i8* }*
  store { i64, i8* }* %7, { i64, i8* }** %17
