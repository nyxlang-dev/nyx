source_filename = "/home/admin/nyx/lang/tests/compiler/types/test-28-enum-string-params.nx"
target triple = "x86_64-pc-linux-gnu"

@.str0 = private unnamed_addr constant [17 x i8] c"division by zero\00"
@.str0.c = internal global %nyx_string* null
@.str1 = private unnamed_addr constant [5 x i8] c"Ok: \00"
...
@.str5 = private unnamed_addr constant [10 x i8] c"not found\00"
@.str5.c = internal global %nyx_string* null
@.str6 = private unnamed_addr constant [10 x i8] c"got value\00"
@.str6.c = internal global %nyx_string* null
@.str7 = private unnamed_addr constant [12 x i8] c"got error: \00"
@.str7.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/types/test-28-enum-string-params.nx
...
i32 %argc, i8** %argv) {
  ...
  %23 = call i8* @divide(i64 10, i64 2)
  %24 = alloca i8*
  store i8* %23, i8** %24
  %25 = load i8*, i8** %24
  ...
  %29 = alloca i64
  store i64 0, i64* %29
  switch i64 %28, label %match_default3 [ i64 0, label %match_arm5 i64 1, label %match_arm6 ]
match_arm5:
...
nested_fail11:
  br label %match_default3
nested_ok12:
  %36 = getelementptr [5 x i8], [5 x i8]* @.str1, i32 0, i32 0
  %37 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str1.c, i8* %36)
  %38 = load i64, i64* %35
  %39 = call %nyx_string* @nyx_string_from_int(i64 %38)
  ...
  br label %match_end4
match_arm6:
  %42 = getelementptr { i64, i8* }, { i64, i8* }* %26, i32 0, i32 1
  %43 = load i8*, i8** %42
...
nested_fail13:
  br label %match_default3
nested_ok14:
  %49 = getelementptr [8 x i8], [8 x i8]* @.str2, i32 0, i32 0
...
match_end4:
  %54 = load i64, i64* %29
  %55 = call i8* @divide(i64 10, i64 0)
  %56 = alloca i8*
  store i8* %55, i8** %56
  %57 = load i8*, i8** %56
  %58 = bitcast i8* %57 to { i64, i8* }*
  %59 = getelementptr { i64, i8* }, { i64, i8* }* %58, i32 0, i32 0
  %60 = load i64, i64* %59
  %61 = alloca i64
  store i64 0, i64* %61
  switch i64 %60, label %match_default15 [ i64 0, label %match_arm17 i64 1, label %match_arm18 ]
match_arm17:
  %62 = getelementptr { i64, i8* }, { i64, i8* }* %58, i32 0, i32 1
  %63 = load i8*, i8** %62
  ...
  %67 = alloca i64
  store i64 %66, i64* %67
  br label %nested_ok24
nested_fail23:
  br label %match_default15
nested_ok24:
  %68 = getelementptr [5 x i8], [5 x i8]* @.str3, i32 0, i32 0
  %69 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str3.c, i8* %68)
  %70 = load i64, i64* %67
...
match_arm18:
  %74 = getelementptr { i64, i8* }, { i64, i8* }* %58, i32 0, i32 1
  %75 = load i8*, i8** %74
  %76 = bitcast i8* %75 to i64*
  %77 = getelementptr i64, i64* %76, i64 0
  %78 = load i64, i64* %77
  %79 = inttoptr i64 %78 to %nyx_string*
  %80 = alloca %nyx_string*
  store %nyx_string* %79, %nyx_string** %80
  br label %nested_ok26
nested_fail25:
  br label %match_default15
nested_ok26:
  %81 = getelementptr [8 x i8], [8 x i8]* @.str4, i32 0, i32 0
  %82 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str4.c, i8* %81)
  %83 = load %nyx_string*, %nyx_string** %80
...
match_end16:
  ...
  %91 = call i8* @GC_malloc(i64 8)
  %92 = bitcast i8* %91 to i64*
  %93 = getelementptr [10 x i8], [10 x i8]* @.str5, i32 0, i32 0
  %94 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str5.c, i8* %93)
  %95 = ptrtoint %nyx_string* %94 to i64
  %96 = getelementptr i64, i64* %92, i64 0
  store i64 %95, i64* %96
  store i8* %91, i8** %90
  %97 = alloca i8*
  store i8* %87, i8** %97
  %98 = load i8*, i8** %97
  %99 = bitcast i8* %98 to { i64, i8* }*
  %100 = getelementptr { i64, i8* }, { i64, i8* }* %99, i32 0, i32 0
  %101 = load i64, i64* %100
  %102 = alloca i64
  store i64 0, i64* %102
  switch i64 %101, label %match_default27 [ i64 0, label %match_arm29 i64 1, label %match_arm30 ]
match_arm29:
  %103 = getelementptr { i64, i8* }, { i64, i8* }* %99, i32 0, i32 1
  %104 = load i8*, i8** %103
  ...
  br label %nested_ok36
nested_fail35:
  br label %match_default27
nested_ok36:
  %109 = getelementptr [10 x i8], [10 x i8]* @.str6, i32 0, i32 0
  %110 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str6.c, i8* %109)
  %111 = call i8* @nyx_string_to_cstr(%nyx_string* %110)
  call void @nyx_print_string(i8* %111)
  br label %match_end28
match_arm30:
  %112 = getelementptr { i64, i8* }, { i64, i8* }* %99, i32 0, i32 1
  %113 = load i8*, i8** %112
  ...
  br label %nested_ok38
nested_fail37:
  br label %match_default27
nested_ok38:
  %119 = getelementptr [12 x i8], [12 x i8]* @.str7, i32 0, i32 0
  %120 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str7.c, i8* %119)
  %121 = load %nyx_string*, %nyx_string** %118
  %122 = call %nyx_string* @nyx_string_concat(%nyx_string* %120, %nyx_string* %121)
