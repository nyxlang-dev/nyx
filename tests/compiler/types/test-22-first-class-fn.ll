source_filename = "/home/admin/nyx/lang/tests/compiler/types/test-22-first-class-fn.nx"
target triple = "x86_64-pc-linux-gnu"

@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/types/test-22-first-class-fn.nx
...
i8* %f.param, i64 %x.param) {
  ...
  br i1 %13, label %cl_env0, label %cl_noenv1
cl_env0:
  %14 = bitcast i8* %10 to i64 (i8*, i64)*
  %15 = call i64 %14(i8* %12, i64 %6)
  br label %cl_merge2
cl_noenv1:
  %16 = bitcast i8* %10 to i64 (i64)*
  %17 = call i64 %16(i64 %6)
  br label %cl_merge2
cl_merge2:
  %18 = phi i64 [%15, %cl_env0], [%17, %cl_noenv1]
  ret i64 %18
}

define internal i64 @apply_twice(
i8* %f.param, i64 %x.param) {
  %f.ptr = alloca i8*
  store i8* %f.param, i8** %f.ptr
  %x.ptr = alloca i64
...
cl_merge5:
  ...
  %34 = getelementptr { i8*, i8* }, { i8*, i8* }* %33, i32 0, i32 0
  %35 = load i8*, i8** %34
  %36 = getelementptr { i8*, i8* }, { i8*, i8* }* %33, i32 0, i32 1
  %37 = load i8*, i8** %36
  %38 = icmp ne i8* %37, null
  br i1 %38, label %cl_env6, label %cl_noenv7
cl_env6:
  %39 = bitcast i8* %35 to i64 (i8*, i64)*
  %40 = call i64 %39(i8* %37, i64 %31)
  br label %cl_merge8
cl_noenv7:
  %41 = bitcast i8* %35 to i64 (i64)*
  %42 = call i64 %41(i64 %31)
  br label %cl_merge8
cl_merge8:
  %43 = phi i64 [%40, %cl_env6], [%42, %cl_noenv7]
  ret i64 %43
}
