source_filename = "/home/admin/nyx/lang/tests/compiler/types/test-21-enums.nx"
target triple = "x86_64-pc-linux-gnu"

@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/types/test-21-enums.nx
...
i8* %c.param) {
  ...
  %5 = alloca i64
  store i64 0, i64* %5
  switch i64 %4, label %match_arm4 [ i64 0, label %match_arm2 i64 1, label %match_arm3 ]
match_arm2:
  store i64 1, i64* %5
  br label %match_end1
match_arm3:
...
i8* %s.param) {
  ...
  %11 = alloca i64
  store i64 0, i64* %11
  switch i64 %10, label %match_default11 [ i64 0, label %match_arm13 i64 1, label %match_arm14 ]
match_arm13:
...
match_arm14:
  %21 = getelementptr { i64, i8* }, { i64, i8* }* %8, i32 0, i32 1
  %22 = load i8*, i8** %21
  ...
  %26 = alloca i64
  store i64 %25, i64* %26
  %27 = getelementptr i64, i64* %23, i64 1
  %28 = load i64, i64* %27
  %29 = alloca i64
  store i64 %28, i64* %29
...
i32 %argc, i8** %argv) {
  ...
  store i8* %39, i8** %43
  %44 = load i8*, i8** %38
  %45 = call i64 @describe_color(i8* %44)
  call void @nyx_print_int(i64 %45)
  %46 = load i8*, i8** %43
  %47 = call i64 @describe_color(i8* %46)
  ...
  store i64 3, i64* %62
  %63 = getelementptr i64, i64* %61, i64 1
  store i64 4, i64* %63
  store i8* %60, i8** %59
  %64 = alloca i8*
  store i8* %56, i8** %64
  %65 = load i8*, i8** %55
  %66 = call i64 @area(i8* %65)
  call void @nyx_print_int(i64 %66)
  %67 = load i8*, i8** %64
  %68 = call i64 @area(i8* %67)
