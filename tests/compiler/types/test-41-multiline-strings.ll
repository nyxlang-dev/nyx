source_filename = "/home/admin/nyx/lang/tests/compiler/types/test-41-multiline-strings.nx"
target triple = "x86_64-pc-linux-gnu"

@.str0 = private unnamed_addr constant [12 x i8] c"hello\0aworld\00"
@.str0.c = internal global %nyx_string* null
@.str1 = private unnamed_addr constant [13 x i8] c"hello\5cnworld\00"
...
; Generated from: /home/admin/nyx/lang/tests/compiler/types/test-41-multiline-strings.nx
...
i32 %argc, i8** %argv) {
  ...
  store i64 42, i64* %1
  %2 = load i64, i64* %1
  %3 = call %nyx_string* @nyx_string_from_int(i64 %2)
  %4 = call i8* @nyx_string_to_cstr(%nyx_string* %3)
  call void @nyx_print_string(i8* %4)
  %5 = alloca i64
  store i64 10, i64* %5
  %6 = load i64, i64* %5
  %7 = call %nyx_string* @nyx_string_from_int(i64 %6)
  ...
  %16 = getelementptr [12 x i8], [12 x i8]* @.str0, i32 0, i32 0
  ...
  %21 = getelementptr [13 x i8], [13 x i8]* @.str1, i32 0, i32 0
  ...
  %36 = getelementptr [3 x i8], [3 x i8]* @.str4, i32 0, i32 0
