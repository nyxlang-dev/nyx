source_filename = "/home/admin/nyx/lang/tests/compiler/types/test-46-m08-annotations.nx"
target triple = "x86_64-pc-linux-gnu"

@.str0 = private unnamed_addr constant [5 x i8] c"hola\00"
@.str0.c = internal global %nyx_string* null
@.str1 = private unnamed_addr constant [1 x i8] c"x"
@.str2 = private unnamed_addr constant [4 x i8] c"uno\00"
@.str2.c = internal global %nyx_string* null
@.str3 = private unnamed_addr constant [4 x i8] c"dos\00"
@.str3.c = internal global %nyx_string* null
@.str4 = private unnamed_addr constant [6 x i8] c"libre\00"
...
; Generated from: /home/admin/nyx/lang/tests/compiler/types/test-46-m08-annotations.nx
...
i32 %argc, i8** %argv) {
  ...
  %3 = getelementptr [5 x i8], [5 x i8]* @.str0, i32 0, i32 0
  %4 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str0.c, i8* %3)
  %5 = alloca %nyx_string*
  store %nyx_string* %4, %nyx_string** %5
  %6 = alloca i1
  store i1 1, i1* %6
  %7 = getelementptr [1 x i8], [1 x i8]* @.str1, i32 0, i32 0
  %8 = load i8, i8* %7
  %9 = zext i8 %8 to i64
  ...
  %21 = getelementptr [4 x i8], [4 x i8]* @.str2, i32 0, i32 0
  %22 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str2.c, i8* %21)
  %23 = ptrtoint %nyx_string* %22 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %20, i64 %23, i64 2)
  %24 = getelementptr [4 x i8], [4 x i8]* @.str3, i32 0, i32 0
  %25 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str3.c, i8* %24)
  %26 = ptrtoint %nyx_string* %25 to i64
  call void @nyx_array_push_tagged({ i64, i8* }* %20, i64 %26, i64 2)
  call void @nyx_array_retag_unknown({ i64, i8* }* %20, i64 2)
  %27 = alloca { i64, i8* }*
  store { i64, i8* }* %20, { i64, i8* }** %27
  %28 = getelementptr [6 x i8], [6 x i8]* @.str4, i32 0, i32 0
...
merge2:
  %43 = load i8, i8* %11
  %44 = call %nyx_string* @nyx_string_from_char(i8 %43)
  ...
  %56 = load { i64, i8* }*, { i64, i8* }** %27
  %57 = call i64 @nyx_array_get({ i64, i8* }* %56, i64 0)
  %58 = call i64 @nyx_array_get_tag({ i64, i8* }* %56, i64 0)
  %59 = call %nyx_string* @nyx_string_from_tagged(i64 %57, i64 %58, i64 2)
  %60 = call i8* @nyx_string_to_cstr(%nyx_string* %59)
  call void @nyx_print_string(i8* %60)
  %61 = load %nyx_string*, %nyx_string** %30
  %62 = call i8* @nyx_string_to_cstr(%nyx_string* %61)
  call void @nyx_print_string(i8* %62)
  %63 = getelementptr [3 x i8], [3 x i8]* @.str6, i32 0, i32 0
