source_filename = "/home/admin/nyx/lang/tests/compiler/types/test-233-generic-array-bare.nx"
...
@.str3 = private unnamed_addr constant [2 x i8] c"x\00"
...
@.str6 = private unnamed_addr constant [15 x i8] c"s10 variant ok\00"
@.str6.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/types/test-233-generic-array-bare.nx
...
i32 %argc, i8** %argv) {
  ...
  %4 = call i64 @first_int({ i64, i8* }* %3, i64 0)
  %5 = alloca i64
  store i64 %4, i64* %5
  %6 = load i64, i64* %5
  %7 = icmp eq i64 %6, 10
...
assert_pass_0:
  ...
  call void @nyx_array_push_tagged({ i64, i8* }* %11, i64 %14, i64 2)
  ...
  call void @nyx_array_push_tagged({ i64, i8* }* %11, i64 %17, i64 2)
  %18 = alloca { i64, i8* }*
  store { i64, i8* }* %11, { i64, i8* }** %18
  %19 = load { i64, i8* }*, { i64, i8* }** %18
  %20 = getelementptr [2 x i8], [2 x i8]* @.str3, i32 0, i32 0
  %21 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str3.c, i8* %20)
  %22 = call %nyx_string* @first_String({ i64, i8* }* %19, %nyx_string* %21)
  %23 = alloca %nyx_string*
  store %nyx_string* %22, %nyx_string** %23
  %24 = load %nyx_string*, %nyx_string** %23
  %25 = getelementptr [4 x i8], [4 x i8]* @.str4, i32 0, i32 0
  %26 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str4.c, i8* %25)
  %27 = call i1 @nyx_string_equals(%nyx_string* %24, %nyx_string* %26)
  %28 = getelementptr [17 x i8], [17 x i8]* @.str5, i32 0, i32 0
...
assert_pass_1:
  %31 = getelementptr [15 x i8], [15 x i8]* @.str6, i32 0, i32 0
...
define internal i64 @first_int(
{ i64, i8* }* %a.param, i64 %fb.param) {
  %a.ptr = alloca { i64, i8* }*
  store { i64, i8* }* %a.param, { i64, i8* }** %a.ptr
  %fb.ptr = alloca i64
  store i64 %fb.param, i64* %fb.ptr
  %34 = load { i64, i8* }*, { i64, i8* }** %a.ptr
  %35 = call i64 @nyx_array_get({ i64, i8* }* %34, i64 0)
  ret i64 %35
}

define internal %nyx_string* @first_String(
{ i64, i8* }* %a.param, %nyx_string* %fb.param) {
  %a.ptr = alloca { i64, i8* }*
  store { i64, i8* }* %a.param, { i64, i8* }** %a.ptr
  %fb.ptr = alloca %nyx_string*
  store %nyx_string* %fb.param, %nyx_string** %fb.ptr
  %36 = load { i64, i8* }*, { i64, i8* }** %a.ptr
