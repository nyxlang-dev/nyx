source_filename = "/home/admin/nyx/lang/tests/compiler/types/test-43-type-aliases.nx"
...
@.str2 = private unnamed_addr constant [13 x i8] c"flag is true\00"
...
; Generated from: /home/admin/nyx/lang/tests/compiler/types/test-43-type-aliases.nx
...
%nyx_string* %name.param) {
  ...
  %4 = getelementptr [8 x i8], [8 x i8]* @.str0, i32 0, i32 0
...
then0:
  %23 = getelementptr [13 x i8], [13 x i8]* @.str2, i32 0, i32 0
...
else1:
  br label %merge2
merge2:
  %26 = getelementptr [3 x i8], [3 x i8]* @.str3, i32 0, i32 0
