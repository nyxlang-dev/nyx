source_filename = "/home/admin/nyx/lang/tests/compiler/errors/test-warn-bare-array-concat.nx"
target triple = "x86_64-pc-linux-gnu"

@.str0 = private unnamed_addr constant [5 x i8] c"hola\00"
@.str0.c = internal global %nyx_string* null
@.str1 = private unnamed_addr constant [4 x i8] c"v: \00"
@.str1.c = internal global %nyx_string* null
@.str2 = private unnamed_addr constant [2 x i8] c"a\00"
@.str2.c = internal global %nyx_string* null
@.str3 = private unnamed_addr constant [4 x i8] c"w: \00"
@.str3.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/errors/test-warn-bare-array-concat.nx
...
i32 %argc, i8** %argv) {
  ...
  %10 = call %nyx_string* @nyx_string_from_tagged(i64 %8, i64 %9, i64 0)
  ...
  call void @nyx_array_retag_unknown({ i64, i8* }* %17, i64 2)
  %21 = alloca { i64, i8* }*
  store { i64, i8* }* %17, { i64, i8* }** %21
  %22 = load { i64, i8* }*, { i64, i8* }** %21
  %23 = call i64 @nyx_array_get({ i64, i8* }* %22, i64 0)
  %24 = call i64 @nyx_array_get_tag({ i64, i8* }* %22, i64 0)
  %25 = call %nyx_string* @nyx_string_from_tagged(i64 %23, i64 %24, i64 2)
  %26 = getelementptr [4 x i8], [4 x i8]* @.str3, i32 0, i32 0
  %27 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str3.c, i8* %26)
  %28 = call %nyx_string* @nyx_string_concat(%nyx_string* %27, %nyx_string* %25)
