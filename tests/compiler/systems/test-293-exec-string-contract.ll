source_filename = "/home/admin/nyx/lang/tests/compiler/systems/test-293-exec-string-contract.nx"
target triple = "x86_64-pc-linux-gnu"

@.str0 = private unnamed_addr constant [10 x i8] c"echo hola\00"
...
@.str5 = private unnamed_addr constant [6 x i8] c"false\00"
@.str5.c = internal global %nyx_string* null
@.str6 = private unnamed_addr constant [17 x i8] c"assertion failed\00"
@.str6.c = internal global %nyx_string* null
@.str7 = private unnamed_addr constant [38 x i8] c"ls /nyx_test293_no_existe 2>/dev/null\00"
...
; Generated from: /home/admin/nyx/lang/tests/compiler/systems/test-293-exec-string-contract.nx
...
i32 %argc, i8** %argv) {
  ...
  %4 = call %nyx_string* @nyx_exec(i8* %3)
...
assert_pass_0:
  ...
  %14 = call i64 @nyx_exec_code(i8* %13)
  %15 = icmp eq i64 %14, 0
...
assert_pass_1:
  %19 = getelementptr [6 x i8], [6 x i8]* @.str5, i32 0, i32 0
  %20 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str5.c, i8* %19)
  %21 = call i8* @nyx_string_to_cstr(%nyx_string* %20)
  %22 = call i64 @nyx_exec_code(i8* %21)
  %23 = icmp eq i64 %22, 1
  %24 = getelementptr [17 x i8], [17 x i8]* @.str6, i32 0, i32 0
