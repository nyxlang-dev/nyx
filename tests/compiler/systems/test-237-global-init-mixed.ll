source_filename = "/home/admin/nyx/lang/tests/compiler/systems/test-237-global-init-mixed.nx"
...
@.str2 = private unnamed_addr constant [2 x i8] c"k\00"
@.str2.c = internal global %nyx_string* null
@.str3 = private unnamed_addr constant [17 x i8] c"assertion failed\00"
@.str3.c = internal global %nyx_string* null
@.str4 = private unnamed_addr constant [21 x i8] c"global-init-mixed OK\00"
@.str4.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/systems/test-237-global-init-mixed.nx
...
@g_general = global i64 0
@g_map = global i8* null


define internal i64 @make_n(
) {
  ret i64 42
}
...
i32 %argc, i8** %argv) {
  ...
  call void @nyx_map_insert_int(i8* %1, i8* %4, i64 7)
  %5 = load i64, i64* @g_general
  %6 = icmp eq i64 %5, 42
  %7 = getelementptr [17 x i8], [17 x i8]* @.str1, i32 0, i32 0
  %8 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str1.c, i8* %7)
  %9 = call i8* @nyx_string_to_cstr(%nyx_string* %8)
  br i1 %6, label %assert_pass_0, label %assert_fail_0
assert_fail_0:
  call void @nyx_assert_fail(i8* %9)
  store i64 1, i64* @__nyx_test_failed
  br label %assert_pass_0
assert_pass_0:
  %10 = load i8*, i8** @g_map
  %11 = getelementptr [2 x i8], [2 x i8]* @.str2, i32 0, i32 0
  %12 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str2.c, i8* %11)
  %13 = call i8* @nyx_string_to_cstr(%nyx_string* %12)
  %14 = call i64 @nyx_map_get_int(i8* %10, i8* %13)
  %15 = icmp eq i64 %14, 7
  %16 = getelementptr [17 x i8], [17 x i8]* @.str3, i32 0, i32 0
...
assert_pass_1:
  %19 = getelementptr [21 x i8], [21 x i8]* @.str4, i32 0, i32 0
...
entry:
  %22 = call i64 @make_n()
  store i64 %22, i64* @g_general
  %23 = call i8* @nyx_map_new(i32 0)
  store i8* %23, i8** @g_map
  ret void
}
