source_filename = "tests/compiler/systems/test-432-module-fn-homonyms-caller.nx"
...
@.str14 = private unnamed_addr constant [17 x i8] c"assert @ line 24\00"
@.str14.c = internal global %nyx_string* null
@.str15 = private unnamed_addr constant [17 x i8] c"assert @ line 31\00"
@.str15.c = internal global %nyx_string* null
@.str16 = private unnamed_addr constant [17 x i8] c"assert @ line 34\00"
@.str16.c = internal global %nyx_string* null
@.str17 = private unnamed_addr constant [17 x i8] c"assert @ line 35\00"
@.str17.c = internal global %nyx_string* null
@.str18 = private unnamed_addr constant [29 x i8] c"module-fn-homonyms-caller OK\00"
@.str18.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: tests/compiler/systems/test-432-module-fn-homonyms-caller.nx
...
define i64 @tests_support_aux_homo_caller_a__calcular(
i64 %x.param) {
  %x.ptr = alloca i64
  store i64 %x.param, i64* %x.ptr
  %676 = load i64, i64* %x.ptr
  %677 = add i64 %676, 1
  ret i64 %677
}

define i64 @tests_support_aux_homo_caller_a__desde_a(
) {
  %678 = call i64 @tests_support_aux_homo_caller_a__calcular(i64 10)
  ret i64 %678
}

define i64 @tests_support_aux_homo_caller_b__calcular(
i64 %x.param, i64 %y.param) {
  %x.ptr = alloca i64
  store i64 %x.param, i64* %x.ptr
  %y.ptr = alloca i64
  store i64 %y.param, i64* %y.ptr
  %679 = load i64, i64* %x.ptr
  %680 = load i64, i64* %y.ptr
  %681 = mul i64 %679, %680
  ret i64 %681
}

define i64 @tests_support_aux_homo_caller_b__desde_b(
) {
  %682 = call i64 @tests_support_aux_homo_caller_b__calcular(i64 3, i64 4)
  ret i64 %682
}
...
i32 %argc, i8** %argv) {
  ...
  %683 = call i64 @tests_support_aux_homo_caller_a__desde_a()
  %684 = alloca i64
  store i64 %683, i64* %684
  %685 = load i64, i64* %684
  call void @nyx_print_int(i64 %685)
  %686 = load i64, i64* %684
  %687 = getelementptr [17 x i8], [17 x i8]* @.str14, i32 0, i32 0
  %688 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str14.c, i8* %687, i64 16)
  %689 = call i8* @nyx_string_to_cstr(%nyx_string* %688)
  call void @nyx_assert_eq_int(i64 11, i64 %686, i8* %689)
  %690 = icmp eq i64 %686, 11
  %691 = call i64 @tests_support_aux_homo_caller_b__desde_b()
  %692 = alloca i64
  store i64 %691, i64* %692
  %693 = load i64, i64* %692
  call void @nyx_print_int(i64 %693)
  %694 = load i64, i64* %692
  %695 = getelementptr [17 x i8], [17 x i8]* @.str15, i32 0, i32 0
  %696 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str15.c, i8* %695, i64 16)
  %697 = call i8* @nyx_string_to_cstr(%nyx_string* %696)
  call void @nyx_assert_eq_int(i64 12, i64 %694, i8* %697)
  %698 = icmp eq i64 %694, 12
  %699 = call i64 @tests_support_aux_homo_caller_a__calcular(i64 10)
  %700 = icmp eq i64 %699, 11
  %701 = getelementptr [17 x i8], [17 x i8]* @.str16, i32 0, i32 0
  %702 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str16.c, i8* %701, i64 16)
  %703 = call i8* @nyx_string_to_cstr(%nyx_string* %702)
  br i1 %700, label %assert_pass_199, label %assert_fail_199
assert_fail_199:
  call void @nyx_assert_fail(i8* %703)
  store i64 1, i64* @__nyx_test_failed
  br label %assert_pass_199
assert_pass_199:
  %704 = call i64 @tests_support_aux_homo_caller_b__calcular(i64 3, i64 4)
  %705 = icmp eq i64 %704, 12
  %706 = getelementptr [17 x i8], [17 x i8]* @.str17, i32 0, i32 0
  %707 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str17.c, i8* %706, i64 16)
  %708 = call i8* @nyx_string_to_cstr(%nyx_string* %707)
  br i1 %705, label %assert_pass_200, label %assert_fail_200
assert_fail_200:
  call void @nyx_assert_fail(i8* %708)
  store i64 1, i64* @__nyx_test_failed
  br label %assert_pass_200
assert_pass_200:
  %709 = getelementptr [29 x i8], [29 x i8]* @.str18, i32 0, i32 0
  %710 = call %nyx_string* @nyx_intern_ptr(%nyx_string** @.str18.c, i8* %709, i64 28)
  %711 = call i8* @nyx_string_to_cstr(%nyx_string* %710)
  call void @nyx_print_string(i8* %711)
  ret i64 0
}
...
entry:
  %712 = sub i64 0, 9223372036854775808
  store i64 %712, i64* @INT_MIN
  ret void
}
