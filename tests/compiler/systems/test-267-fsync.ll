source_filename = "/home/admin/nyx/lang/tests/compiler/systems/test-267-fsync.nx"
target triple = "x86_64-pc-linux-gnu"

@.str0 = private unnamed_addr constant [28 x i8] c"/tmp/nyx_test_267_fsync.tmp\00"
...
@.str7 = private unnamed_addr constant [20 x i8] c"fsync/fdatasync: OK\00"
@.str7.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/systems/test-267-fsync.nx
...
assert_pass_1:
  %20 = load i64, i64* %6
  %21 = call i64 @nyx_fdatasync(i64 %20)
  %22 = alloca i64
  store i64 %21, i64* %22
  %23 = load i64, i64* %22
  %24 = icmp eq i64 %23, 0
...
assert_pass_2:
  %28 = load i64, i64* %6
  %29 = call i64 @nyx_close_fd(i64 %28)
  %30 = icmp eq i64 %29, 0
  %31 = getelementptr [17 x i8], [17 x i8]* @.str4, i32 0, i32 0
...
assert_pass_3:
  ...
  br i1 %37, label %assert_pass_4, label %assert_fail_4
assert_fail_4:
...
assert_pass_4:
  %41 = sub i64 0, 1
  %42 = call i64 @nyx_fdatasync(i64 %41)
  %43 = sub i64 0, 1
  %44 = icmp eq i64 %42, %43
  %45 = getelementptr [17 x i8], [17 x i8]* @.str6, i32 0, i32 0
  %46 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str6.c, i8* %45)
  %47 = call i8* @nyx_string_to_cstr(%nyx_string* %46)
  br i1 %44, label %assert_pass_5, label %assert_fail_5
assert_fail_5:
...
assert_pass_5:
  ...
  %50 = call i64 @nyx_remove(i8* %49)
  %51 = getelementptr [20 x i8], [20 x i8]* @.str7, i32 0, i32 0
