source_filename = "/home/admin/nyx/lang/tests/compiler/systems/test-238-global-map-vtype-crossfn.nx"
target triple = "x86_64-pc-linux-gnu"

@.str0 = private unnamed_addr constant [5 x i8] c"root\00"
@.str0.c = internal global %nyx_string* null
@.str1 = private unnamed_addr constant [2 x i8] c"7\00"
@.str1.c = internal global %nyx_string* null
@.str2 = private unnamed_addr constant [5 x i8] c"root\00"
@.str2.c = internal global %nyx_string* null
@.str3 = private unnamed_addr constant [2 x i8] c"n\00"
@.str3.c = internal global %nyx_string* null
@.str4 = private unnamed_addr constant [2 x i8] c"n\00"
...
@.str7 = private unnamed_addr constant [20 x i8] c"global-map-vtype OK\00"
@.str7.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/systems/test-238-global-map-vtype-crossfn.nx
...
@g_str = global i8* null
@g_int = global i8* null


define internal i64 @seed_str(
) {
  %1 = load i8*, i8** @g_str
  %2 = getelementptr [5 x i8], [5 x i8]* @.str0, i32 0, i32 0
  %3 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str0.c, i8* %2)
  %4 = getelementptr [2 x i8], [2 x i8]* @.str1, i32 0, i32 0
  %5 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str1.c, i8* %4)
  %6 = call i8* @nyx_string_to_cstr(%nyx_string* %3)
  %7 = call i8* @nyx_string_to_cstr(%nyx_string* %5)
  call void @nyx_map_insert_str(i8* %1, i8* %6, i8* %7)
  ret i64 0
}

define internal i64 @read_str(
) {
  %8 = load i8*, i8** @g_str
  %9 = getelementptr [5 x i8], [5 x i8]* @.str2, i32 0, i32 0
  %10 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str2.c, i8* %9)
  %11 = call i8* @nyx_string_to_cstr(%nyx_string* %10)
  %12 = call i8* @nyx_map_get_str(i8* %8, i8* %11)
  %13 = call %nyx_string* @nyx_string_from_cstr(i8* %12)
  %14 = call i64 @nyx_string_to_int(%nyx_string* %13)
  ret i64 %14
}

define internal i64 @seed_int(
) {
  %15 = load i8*, i8** @g_int
  ...
  call void @nyx_map_insert_int(i8* %15, i8* %18, i64 42)
  ret i64 0
}

define internal i64 @read_int(
) {
  %19 = load i8*, i8** @g_int
  %20 = getelementptr [2 x i8], [2 x i8]* @.str4, i32 0, i32 0
  %21 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str4.c, i8* %20)
  %22 = call i8* @nyx_string_to_cstr(%nyx_string* %21)
  %23 = call i64 @nyx_map_get_int(i8* %19, i8* %22)
  ret i64 %23
}
...
i32 %argc, i8** %argv) {
  ...
  %24 = call i64 @seed_str()
  %25 = call i64 @read_str()
  %26 = icmp eq i64 %25, 7
...
assert_pass_0:
  %30 = call i64 @seed_int()
  %31 = call i64 @read_int()
  %32 = icmp eq i64 %31, 42
...
assert_pass_1:
  %36 = getelementptr [20 x i8], [20 x i8]* @.str7, i32 0, i32 0
...
entry:
  ...
  store i8* %39, i8** @g_str
  %40 = call i8* @nyx_map_new(i32 0)
  store i8* %40, i8** @g_int
  ret void
}
