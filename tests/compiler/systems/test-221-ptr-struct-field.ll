source_filename = "/home/admin/nyx/lang/tests/compiler/systems/test-221-ptr-struct-field.nx"
target triple = "x86_64-pc-linux-gnu"

%Arena = type { i64, i64, i64 }
...
@.str6 = private unnamed_addr constant [20 x i8] c"ptr-struct-field OK\00"
@.str6.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/systems/test-221-ptr-struct-field.nx
...
define internal i64 @arena_bump(
%Arena* %p.param, i64 %n.param) {
  %p.ptr = alloca %Arena*
  store %Arena* %p.param, %Arena** %p.ptr
  %n.ptr = alloca i64
  store i64 %n.param, i64* %n.ptr
  %1 = load %Arena*, %Arena** %p.ptr
  %2 = getelementptr %Arena, %Arena* %1, i32 0, i32 1
  %3 = load i64, i64* %2
  %4 = alloca i64
  store i64 %3, i64* %4
  %5 = load %Arena*, %Arena** %p.ptr
  %6 = load %Arena*, %Arena** %p.ptr
  %7 = getelementptr %Arena, %Arena* %6, i32 0, i32 1
  %8 = load i64, i64* %7
  %9 = load i64, i64* %n.ptr
  %10 = add i64 %8, %9
  %11 = getelementptr %Arena, %Arena* %5, i32 0, i32 1
  store i64 %10, i64* %11
  %12 = load i64, i64* %4
  ret i64 %12
}
...
i32 %argc, i8** %argv) {
  ...
  %13 = getelementptr %Arena, %Arena* null, i32 1
  %14 = ptrtoint %Arena* %13 to i64
  %15 = call i8* @GC_malloc(i64 %14)
  %16 = bitcast i8* %15 to %Arena*
  %17 = getelementptr %Arena, %Arena* %16, i32 0, i32 0
  store i64 1000, i64* %17
  %18 = getelementptr %Arena, %Arena* %16, i32 0, i32 1
  store i64 0, i64* %18
  %19 = getelementptr %Arena, %Arena* %16, i32 0, i32 2
  store i64 128, i64* %19
  %20 = load %Arena, %Arena* %16
  %21 = alloca %Arena
  store %Arena %20, %Arena* %21
  %22 = call i64 @arena_bump(%Arena* %21, i64 8)
  %23 = alloca i64
  store i64 %22, i64* %23
  %24 = load i64, i64* %23
  %25 = icmp eq i64 %24, 0
  %26 = getelementptr [17 x i8], [17 x i8]* @.str0, i32 0, i32 0
...
assert_pass_0:
  %29 = getelementptr %Arena, %Arena* %21, i32 0, i32 1
  %30 = load i64, i64* %29
  %31 = icmp eq i64 %30, 8
...
assert_pass_1:
  %35 = call i64 @arena_bump(%Arena* %21, i64 4)
  %36 = alloca i64
  store i64 %35, i64* %36
  %37 = load i64, i64* %36
  %38 = icmp eq i64 %37, 8
...
assert_pass_2:
  %42 = getelementptr %Arena, %Arena* %21, i32 0, i32 1
  %43 = load i64, i64* %42
  %44 = icmp eq i64 %43, 12
  %45 = getelementptr [17 x i8], [17 x i8]* @.str3, i32 0, i32 0
  %46 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str3.c, i8* %45)
  %47 = call i8* @nyx_string_to_cstr(%nyx_string* %46)
  br i1 %44, label %assert_pass_3, label %assert_fail_3
assert_fail_3:
  call void @nyx_assert_fail(i8* %47)
  store i64 1, i64* @__nyx_test_failed
  br label %assert_pass_3
assert_pass_3:
  %48 = getelementptr %Arena, %Arena* %21, i32 0, i32 0
  %49 = load i64, i64* %48
  %50 = icmp eq i64 %49, 1000
  %51 = getelementptr [17 x i8], [17 x i8]* @.str4, i32 0, i32 0
...
assert_pass_4:
  %54 = getelementptr %Arena, %Arena* %21, i32 0, i32 2
  %55 = load i64, i64* %54
  %56 = icmp eq i64 %55, 128
  %57 = getelementptr [17 x i8], [17 x i8]* @.str5, i32 0, i32 0
  %58 = call %nyx_string* @nyx_intern_cstr(%nyx_string** @.str5.c, i8* %57)
  %59 = call i8* @nyx_string_to_cstr(%nyx_string* %58)
  br i1 %56, label %assert_pass_5, label %assert_fail_5
assert_fail_5:
  call void @nyx_assert_fail(i8* %59)
  store i64 1, i64* @__nyx_test_failed
  br label %assert_pass_5
assert_pass_5:
  %60 = getelementptr [20 x i8], [20 x i8]* @.str6, i32 0, i32 0
