source_filename = "/home/admin/nyx/lang/tests/compiler/iterators-traits/test-89-tcp-basic.nx"
target triple = "x86_64-pc-linux-gnu"

@.str0 = private unnamed_addr constant [10 x i8] c"localhost\00"
@.str0.c = internal global %nyx_string* null
@.str1 = private unnamed_addr constant [10 x i8] c"127.0.0.1\00"
@.str1.c = internal global %nyx_string* null
@.str2 = private unnamed_addr constant [17 x i8] c"assertion failed\00"
@.str2.c = internal global %nyx_string* null
@.str3 = private unnamed_addr constant [10 x i8] c"127.0.0.1\00"
@.str3.c = internal global %nyx_string* null
@.str4 = private unnamed_addr constant [17 x i8] c"assertion failed\00"
@.str4.c = internal global %nyx_string* null
@.str5 = private unnamed_addr constant [5 x i8] c"done\00"
@.str5.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/iterators-traits/test-89-tcp-basic.nx
...
i32 %argc, i8** %argv) {
  ...
  %4 = call %nyx_string* @nyx_resolve(i8* %3)
  %5 = alloca %nyx_string*
  ...
  %8 = load %nyx_string*, %nyx_string** %5
  %9 = getelementptr [10 x i8], [10 x i8]* @.str1, i32 0, i32 0
...
assert_pass_0:
  ...
  store i1 %21, i1* %22
  %23 = load i1, i1* %22
  call void @nyx_print_bool(i1 %23)
  %24 = load i1, i1* %22
...
assert_pass_1:
  %28 = load i64, i64* %19
  call void @nyx_tcp_close(i64 %28)
  %29 = getelementptr [5 x i8], [5 x i8]* @.str5, i32 0, i32 0
