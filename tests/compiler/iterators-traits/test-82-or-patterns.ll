source_filename = "/home/admin/nyx/lang/tests/compiler/iterators-traits/test-82-or-patterns.nx"
target triple = "x86_64-pc-linux-gnu"

@.str0 = private unnamed_addr constant [10 x i8] c"not green\00"
@.str0.c = internal global %nyx_string* null
@.str1 = private unnamed_addr constant [6 x i8] c"green\00"
@.str1.c = internal global %nyx_string* null
@.str2 = private unnamed_addr constant [15 x i8] c"or patterns OK\00"
@.str2.c = internal global %nyx_string* null
@__nyx_test_failed = external global i64
@__nyx_test_mode = external global i64
; Nyx Compiler Bootstrap v3.0
; Generated from: /home/admin/nyx/lang/tests/compiler/iterators-traits/test-82-or-patterns.nx
...
i8* %c.param) {
  ...
  %5 = alloca i64
  store i64 0, i64* %5
  switch i64 %4, label %match_default0 [ i64 0, label %match_arm2 i64 2, label %match_arm2 i64 1, label %match_arm3 ]
match_arm2:
  %6 = getelementptr [10 x i8], [10 x i8]* @.str0, i32 0, i32 0
...
i32 %argc, i8** %argv) {
  ...
  %15 = bitcast i8* %14 to { i64, i8* }*
  %16 = getelementptr { i64, i8* }, { i64, i8* }* %15, i32 0, i32 0
  store i64 0, i64* %16
  %17 = getelementptr { i64, i8* }, { i64, i8* }* %15, i32 0, i32 1
  store i8* null, i8** %17
  %18 = call %nyx_string* @describe(i8* %14)
  ...
  store i64 2, i64* %22
  %23 = getelementptr { i64, i8* }, { i64, i8* }* %21, i32 0, i32 1
  store i8* null, i8** %23
  %24 = call %nyx_string* @describe(i8* %20)
  ...
  store i64 1, i64* %28
  %29 = getelementptr { i64, i8* }, { i64, i8* }* %27, i32 0, i32 1
  store i8* null, i8** %29
  %30 = call %nyx_string* @describe(i8* %26)
  %31 = call i8* @nyx_string_to_cstr(%nyx_string* %30)
  call void @nyx_print_string(i8* %31)
  %32 = getelementptr [15 x i8], [15 x i8]* @.str2, i32 0, i32 0
