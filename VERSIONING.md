...
v0.12.0 ← AHORA. Reverse Proxy (round-robin, health checks). ✅

v0.13.0 — Async/await real (no syntactic sugar) + I/O non-blocking.
v0.14.0 — Package manager con registry público.
v0.15.0 — Borrow checker real (no solo anotaciones).
