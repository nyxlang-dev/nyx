...
// (débil, como Redis): key presente todo el scan aparece >= 1 vez.
int64_t nyx_map_scan(nyx_map_t* map, int64_t cursor, void* out);
...
// Builtin map_scan: una página como Array [next_cursor, keys...].
