# Nyx Language Specification v0.13.0

> Current version: v0.13.0 (pre-release). 292 compiler tests (215 regression + 30 advanced + 36 M-08 error + 11 M-08 happy-types + 3 stdlib; test-56 counted in both M-08 runners), self-hosting with verified fixed point. Semantic type checker active end-to-end (M-08 sessions 1 – 23a).
